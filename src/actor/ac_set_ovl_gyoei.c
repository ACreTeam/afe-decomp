...
#ifndef BUGFIXES
#define aSOG_GYO_NUM (aGYO_TYPE_PUFFER_FISH) // @BUG - this should be aGYO_TYPE_NUM
#else
#define aSOG_GYO_NUM (aGYO_TYPE_NUM)
#endif
...
#define FISH_LIST(list) { ARRAY_COUNT(list), list }

static aSOG_term_info_c r_m1_t0[] = {
...
static aSOG_term_info_c s_m1_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(DAB, SEA, 12),
    FISH_SPAWN(OCTOPUS, SEA, 7),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c r_m1_t1[] = {
...
static aSOG_term_info_c r_m1_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m1_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 12),
    FISH_SPAWN(DAB, SEA, 12),
    FISH_SPAWN(OCTOPUS, SEA, 4),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};
...
static aSOG_term_info_c r_m2_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m2_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(DAB, SEA, 12),
...
static aSOG_term_info_c r_m2_t1[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 3),
...
static aSOG_term_info_c r_m2_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m2_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 12),
    FISH_SPAWN(DAB, SEA, 12),
...
static aSOG_term_info_c r_m3_t0[] = {
...
static aSOG_term_info_c s_m3_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(DAB, SEA, 12),
    FISH_SPAWN(OCTOPUS, SEA, 7),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
...
static aSOG_term_info_c r_m3_t1[] = {
...
static aSOG_term_info_c s_m3_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(DAB, SEA, 10),
    FISH_SPAWN(OCTOPUS, SEA, 7),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c r_m3_t2[] = {
...
static aSOG_term_info_c s_m3_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    ...
    FISH_SPAWN(OCTOPUS, SEA, 4),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
    FISH_SPAWN(CRUCIAN_CARP, POOL, 0), // @BUG - e+ devs left an empty entry here, defaults to crucian carp, lake, 0 weight
};
...
static aSOG_term_info_c r_m4_t0[] = {
...
static aSOG_term_info_c s_m4_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(DAB, SEA, 10),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 2),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c p_m4_t0[] = {
    FISH_SPAWN(KILLIFISH, POND, 3),
    FISH_SPAWN(CRAWFISH, POND, 20),
};

static aSOG_term_info_c r_m4_t1[] = {
...
static aSOG_term_info_c s_m4_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(DAB, SEA, 8),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 4),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c r_m4_t2[] = {
...
static aSOG_term_info_c s_m4_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 1),
...
static aSOG_term_info_c r_m5_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 11),
    FISH_SPAWN(BROOK_TROUT, POOL, 10),
    FISH_SPAWN(CARP, RIVER, 14),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m5_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 3),
    FISH_SPAWN(SQUID, SEA, 6),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 6),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c p_m5_t0[] = {
    FISH_SPAWN(KILLIFISH, POND, 3),
    FISH_SPAWN(CRAWFISH, POND, 20),
    FISH_SPAWN(FROG, POND, 15),
};

static aSOG_term_info_c r_m5_t1[] = {
...
static aSOG_term_info_c s_m5_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 3),
    FISH_SPAWN(SQUID, SEA, 6),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 8),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c r_m5_t2[] = {
...
static aSOG_term_info_c s_m5_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 3),
...
static aSOG_term_info_c r_m6_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 14),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c r_m6_t1[] = {
...
static aSOG_term_info_c s_m6_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 4),
    FISH_SPAWN(SQUID, SEA, 8),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 10),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c r_m6_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
...
static aSOG_term_info_c s_m6_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 4),
...
static aSOG_term_info_c r_m7_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 5),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m7_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 5),
    FISH_SPAWN(SQUID, SEA, 6),
    FISH_SPAWN(OCTOPUS, SEA, 7),
    FISH_SPAWN(SEAHORSE, SEA, 10),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
...
static aSOG_term_info_c p_m7_t0[] = {
    FISH_SPAWN(KILLIFISH, POND, 3),
    FISH_SPAWN(CRAWFISH, POND, 20),
    FISH_SPAWN(FROG, POND, 15),
};

static aSOG_term_info_c r_m7_t1[] = {
...
static aSOG_term_info_c s_m7_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 5),
    FISH_SPAWN(SQUID, SEA, 6),
    FISH_SPAWN(OCTOPUS, SEA, 7),
    FISH_SPAWN(SEAHORSE, SEA, 12),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};

static aSOG_term_info_c r_m7_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m7_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 8),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 5),
    FISH_SPAWN(SQUID, SEA, 10),
    FISH_SPAWN(OCTOPUS, SEA, 4),
    FISH_SPAWN(SEAHORSE, SEA, 10),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 20),
};
...
static aSOG_term_info_c r_m8_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 5),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m8_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 4),
...
static aSOG_term_info_c s_m8_t0_2[] = {
    FISH_SPAWN(JELLYFISH, SEA, 60),
    FISH_SPAWN(SEA_BASS, SEA, 9),
    FISH_SPAWN(RED_SNAPPER, SEA, 4),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 2),
    FISH_SPAWN(SEAHORSE, SEA, 4),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 10),
};

static aSOG_term_info_c p_m8_t0[] = {
    FISH_SPAWN(KILLIFISH, POND, 3),
    FISH_SPAWN(CRAWFISH, POND, 20),
    FISH_SPAWN(FROG, POND, 15),
};

static aSOG_term_info_c r_m8_t1[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 8),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 15),
...
static aSOG_term_info_c s_m8_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 4),
...
static aSOG_term_info_c s_m8_t1_2[] = {
    FISH_SPAWN(JELLYFISH, SEA, 66),
    FISH_SPAWN(SEA_BASS, SEA, 9),
    FISH_SPAWN(RED_SNAPPER, SEA, 4),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 2),
...
static aSOG_term_info_c r_m8_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c r_m9_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 8),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 5),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c r_m9_t0_2[] = {
...
static aSOG_term_info_c s_m9_t0[] = {
    FISH_SPAWN(SALMON2, RIVER_MOUTH, 60), // river mouth salmon variant
    FISH_SPAWN(SEA_BASS, SEA, 9),
    FISH_SPAWN(RED_SNAPPER, SEA, 4),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 2),
...
static aSOG_term_info_c r_m9_t1[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 16),
    FISH_SPAWN(BROOK_TROUT, POOL, 15),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 20),
...
static aSOG_term_info_c r_m9_t1_2[] = {
...
static aSOG_term_info_c s_m9_t1[] = {
    FISH_SPAWN(SALMON2, RIVER_MOUTH, 66), // river mouth salmon variant
    FISH_SPAWN(SEA_BASS, SEA, 9),
    FISH_SPAWN(RED_SNAPPER, SEA, 4),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 1),
    FISH_SPAWN(FLOUNDER, SEA, 2),
...
static aSOG_term_info_c s_m9_t1_2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 2),
...
static aSOG_term_info_c r_m9_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 16),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c r_m9_t2_2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c r_m10_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 6),
    FISH_SPAWN(BROOK_TROUT, POOL, 10),
...
static aSOG_term_info_c s_m10_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 1),
...
static aSOG_term_info_c r_m10_t1[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 24),
    FISH_SPAWN(BROOK_TROUT, POOL, 15),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 20),
...
static aSOG_term_info_c s_m10_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 1),
...
static aSOG_term_info_c r_m10_t2[] = {
...
static aSOG_term_info_c s_m10_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 5),
    FISH_SPAWN(FLOUNDER, SEA, 1),
...
static aSOG_term_info_c r_m11_t0[] = {
...
static aSOG_term_info_c s_m11_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
...
static aSOG_term_info_c r_m11_t1[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 24),
    FISH_SPAWN(BROOK_TROUT, POOL, 15),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 20),
...
static aSOG_term_info_c s_m11_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 3),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
...
static aSOG_term_info_c r_m11_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 15),
    FISH_SPAWN(BROOK_TROUT, POOL, 10),
    FISH_SPAWN(CARP, RIVER, 15),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m11_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 3),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
...
static aSOG_term_info_c r_m12_t0[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c s_m12_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 6),
...
static aSOG_term_info_c r_m12_t1[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 3),
...
static aSOG_term_info_c s_m12_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 3),
    FISH_SPAWN(FLOUNDER, SEA, 1),
    FISH_SPAWN(SQUID, SEA, 6),
...
static aSOG_term_info_c r_m12_t2[] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5),
    FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),
...
static aSOG_term_info_c f_bs_t0[] = {
    FISH_SPAWN(SMALL_BASS, RIVER, 10),
    FISH_SPAWN(BASS, RIVER, 70),
    FISH_SPAWN(LARGE_BASS, RIVER, 20),
};

static aSOG_term_info_c f_bs_t1[] = {
    FISH_SPAWN(SMALL_BASS, RIVER, 50),
    FISH_SPAWN(BASS, RIVER, 40),
    FISH_SPAWN(LARGE_BASS, RIVER, 10),
};

static aSOG_term_info_c f_bs_t2[] = {
    FISH_SPAWN(SMALL_BASS, RIVER, 20),
    FISH_SPAWN(BASS, RIVER, 70),
    FISH_SPAWN(LARGE_BASS, RIVER, 10),
};

static aSOG_term_info_c f_il_t0[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 2),
    FISH_SPAWN(PUFFER_FISH, SEA, 11),
    FISH_SPAWN(FLOUNDER, SEA, 3),
    FISH_SPAWN(SQUID, SEA, 6),
    FISH_SPAWN(SWORDFISH, SEA, 1),
    FISH_SPAWN(DAB, SEA, 10),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 4),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 18),
};

static aSOG_term_info_c f_il_t1[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 2),
    FISH_SPAWN(PUFFER_FISH, SEA, 12),
    FISH_SPAWN(FLOUNDER, SEA, 3),
    FISH_SPAWN(SQUID, SEA, 6),
    FISH_SPAWN(SWORDFISH, SEA, 1),
    FISH_SPAWN(DAB, SEA, 7),
    FISH_SPAWN(OCTOPUS, SEA, 10),
    FISH_SPAWN(SEAHORSE, SEA, 8),
    FISH_SPAWN(HORSE_MACKEREL, SEA, 18),
};

static aSOG_term_info_c f_il_t2[] = {
    FISH_SPAWN(SEA_BASS, SEA, 15),
    FISH_SPAWN(RED_SNAPPER, SEA, 7),
    FISH_SPAWN(BARRED_KNIFEJAW, SEA, 2),
    FISH_SPAWN(PUFFER_FISH, SEA, 11),
...
// Aus version clarifies that 'river mouth' spawns can only spawn in the river & sea block.
            ...
            if ((block_type & (mRF_BLOCKKIND_RIVER | mRF_BLOCKKIND_MARINE)) !=
                (mRF_BLOCKKIND_RIVER | mRF_BLOCKKIND_MARINE)) {
#else
 ...
 **/
static int aSOG_gyoei_get_idx_sub(aSOG_gyoei_spawn_info_weight_f_c* spawn_info, int* set_table, u32 block_type,
                                  int info_count, f32 env_rate) {
    ...
    for (i = 0; i < info_count; i++) {
        if (*set_table_p == 0) {
            now_weight -=
                spawn_info_p->spawn_weight * env_rate; // subtract weight modified by environment rating factor
            if (now_weight < 0.0f) {
                break;
            }
...
static int aSOG_gyoei_get_idx(aSOG_gyoei_spawn_info_weight_f_c* spawn_info, int info_count, u32 block_type) {
    ...
    int set_table[aSOG_GYO_NUM];
    f32 env_rate;
    int field_rank;
    int i;
    int idx = aGYO_TYPE_INVALID;

    bzero(set_table, sizeof(set_table));
    ...
    for (i = 0; i < info_count; i++) {
        ...
        if (idx == aGYO_TYPE_INVALID || idx != aSOG_GYO_NUM) {
            break;
        }
    }
                ...
                for (ut_x = 0; ut_x < UT_X_NUM; ut_x++) {
                    if (ut_z >= 2 && ut_z < UT_Z_NUM - 2 && ut_x >= 2 && ut_x < UT_X_NUM - 2) {
                        ...
                        switch (set_data->type) {
                            ...
                            case aGYO_TYPE_PUFFER_FISH:
                            case aGYO_TYPE_DAB:
                            case aGYO_TYPE_SQUID:
                            case aGYO_TYPE_SWORDFISH:
                            case aGYO_TYPE_FLOUNDER:
                            case aGYO_TYPE_OCTOPUS:
                            case aGYO_TYPE_SEAHORSE:
                            case aGYO_TYPE_HORSE_MACKEREL: {
                                if (attribute == mCoBG_ATTRIBUTE_SEA && attribute != mCoBG_ATTRIBUTE_WAVE) {
                                    ...
                                    water_height = mCoBG_GetWaterHeight_File(wpos, __FILE__, 2277);
                            ...
                            case aGYO_TYPE_SALMON2: {
                                if (mCoBG_CheckWaterAttribute(attribute)) {
                                    if (attribute == mCoBG_ATTRIBUTE_SEA && attribute != mCoBG_ATTRIBUTE_WAVE) {
                                        ...
                                        mFI_BkandUtNum2CenterWpos(&wpos, block_xz[0], block_xz[1], ut_x, ut_z);
                                        bg_y = mCoBG_GetBgY_AngleS_FromWpos(NULL, wpos, 0.0f);
                                        water_height = mCoBG_GetWaterHeight_File(wpos, __FILE__, 2303);
                                        diff = water_height - bg_y;
                            ...
                            case aGYO_TYPE_WHALE: {
                                if (ut_z >= 5 && ut_z < UT_Z_NUM - 5 && ut_x >= 5 && ut_x < UT_X_NUM - 5 &&
                                    mCoBG_CheckWaterAttribute(attribute)) {
                                    valid_fg_num++;
                                    *fg_p++ = ut_x + ut_z * UT_X_NUM;
                                }
                                break;
 ...
 **/
static int aSOG_gyoei_decide_gyoei(aSOG_set_data_c* set_data, int* block_xz,
                                   aSOG_gyoei_spawn_info_weight_f_c* spawn_info, int info_count, u32 block_type) {
    int res = FALSE;
...
static int aSOG_gyoei_make(aSOG_set_data_c* set_data, int* block_xz, GAME* game) {
    ...
    if (set_data->should_spawn == TRUE && CLIP(gyo_clip)->make_gyoei_proc != NULL) {
        ...
        res = CLIP(gyo_clip)->make_gyoei_proc(&init_data);
        set_data->should_spawn = FALSE;

        if (res == TRUE && init_data.fish_type == aGYO_TYPE_COELACANTH) {
            aNPC_SPNPC_BIT_SET(Common_Get(spnpc_first_talk_flags), aNPC_SPNPC_BIT_SET_OVL_GYOEI_COELACANTH);
        }
    }
...
static int aSOG_gyoei_check_water_unit_in_block(SET_MANAGER* set_manager) {
    mCoBG_Collision_u* collision_data =
        mFI_GetBkNum2ColTop(set_manager->player_pos.next_bx, set_manager->player_pos.next_bz);
    if (collision_data != NULL) {
        int x, z;
...
static int aSOG_gyo_chk_live_gyoei(SET_MANAGER* set_manager, GAME_PLAY* play) {
    ...
    if (gyoei_clip->chk_live_gyoei_proc != NULL) {
        res = (*gyoei_clip->chk_live_gyoei_proc)(set_manager->player_pos.next_bx, set_manager->player_pos.next_bz,
                                                 (GAME*)play);
    }
...
/**
 * @brief Checks if a fish exists in the acre the player is moving into and if that acre has a valid spawn location for
 *fish.
 *
 * @param set_manager SET_MANAGER actor
 * @param play Pointer to GAME_PLAY structure
...
static int aSOG_gyoei_block_check(SET_MANAGER* set_manager, GAME_PLAY* play, u32 block_type) {
    ...
    if (aSOG_gyo_chk_live_gyoei(set_manager, play) == FALSE) {
        if ((block_type & mRF_BLOCKKIND_MARINE) != mRF_BLOCKKIND_MARINE &&
            (block_type & mRF_BLOCKKIND_RIVER) != mRF_BLOCKKIND_RIVER &&
            aSOG_gyoei_check_water_unit_in_block(set_manager) == FALSE) {
            res = TRUE;
        }
    } else {
        res = TRUE;
...
static int aSOG_gyoei_set_with_list(aSOG_set_data_c* set_data, SET_MANAGER* set_manager, GAME* game, u32 block_type) {
    ...
    if (set_manager->keep.gyoei_keep.possible_gyoei_num > 0) {
        ...
        if (aSOG_gyoei_decide_gyoei(set_data, &set_manager->player_pos.next_bx, copy_range, keep->possible_gyoei_num,
                                    block_type) == TRUE) {
...
static void aSOG_gyoei_chk_term_info(int* term0, int* term1, f32* term_rate) {
    ...
    /* if 0 or 1 terms have passed (current or next term), or saved term is first term of year, or current term is last
     * term of year */
...
static mActor_name_t aSOG_decide_fish(aSOG_term_list_c* term_list) {
    mActor_name_t fish_type = EMPTY_NO;

    if (term_list != NULL && term_list->count != 0 && term_list->term_info != NULL) {
        int idx = RANDOM(term_list->count);
        fish_type = ITM_FISH_START + term_list->term_info[idx].type;
    }
...
extern mActor_name_t aSOG_get_fish_now(void) {
    static aSOG_term_list_c** place_month[] = { (aSOG_term_list_c**)r_month, (aSOG_term_list_c**)s_month, (aSOG_term_list_c**)p_month };
    aSOG_term_list_c* cur_list[aSOG_AREA_NUM];
    mActor_name_t fish_type;
    int time_no;
    int count;
    int i;
    int term0, term1;
    ...
    count = 0;
    fish_type = EMPTY_NO;
    aSOG_gyoei_chk_term_info(&term0, &term1, &term_rate);
    time_no = aSOG_gyoei_get_time_no();

    for (i = 0; i < aSOG_AREA_NUM; i++) {
        cur_list[i] = place_month[i][(term0 & 1) + (term0 & ~1)];
    ...
    if (count > 0) {
        ...
        for (i = 0; i < aSOG_AREA_NUM; i++) {
            if (cur_list[i] != NULL) {
                if (rand <= 0) {
                    fish_type = aSOG_decide_fish(cur_list[i] + time_no);
                    break;
                }
                rand--;
            }
...
static int aSOG_gyoei_check_fishing_event(u32 block_kind) {
    static u32 chk_kind[3] = { mRF_BLOCKKIND_POOL, mRF_BLOCKKIND_BRIDGE, mRF_BLOCKKIND_WATERFALL };

    int res = FALSE;

    if (mEv_check_status(mEv_EVENT_FISHING_TOURNEY_1, mEv_STATUS_ACTIVE) ||
        mEv_check_status(mEv_EVENT_FISHING_TOURNEY_2, mEv_STATUS_ACTIVE)) {
        int i;
...
static void aSOG_add_kaseki_range_data(aSOG_gyoei_keep_c* keep, int time_no, int is_next_term) {
    static aSOG_gyoei_spawn_info_weight_f_c kaseki_data = FISH_SPAWN(COELACANTH, SEA, 10.0f);

    /* Only the current term, while raining, and not during 9am-3:59pm */
    if (is_next_term == FALSE && mEnv_NowWeather() == mEnv_WEATHER_RAIN && time_no != aSOG_TIME_2 && (Common_Get(spnpc_first_talk_flags) & (1 << aNPC_SPNPC_BIT_SET_OVL_GYOEI_COELACANTH)) == 0) {
        keep->spawn_weights[keep->possible_gyoei_num] = kaseki_data;
        keep->possible_gyoei_num++;
    }
}

typedef void (*aSOG_gyoei_make_range_proc)(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                           f32 term_rate);
 ...
 **/
static void aSOG_gyoei_make_river_range_data(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                             f32 term_rate) {
 ...
 * @param term_rate Term rate spawn weight modifier
 **/
static void aSOG_gyoei_make_fishing_event_range_data(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                                     f32 term_rate) {
 ...
 * @param term_rate Term rate spawn weight modifier
 **/
static void aSOG_gyoei_make_sea_range_data(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                           f32 term_rate) {
 ...
 * @param term_rate Term rate spawn weight modifier
 **/
static void aSOG_gyoei_make_offing_range_data(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                              f32 term_rate) {
 ...
 * @param term_rate Term rate spawn weight modifier
 **/
static void aSOG_gyoei_make_pool_range_data(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                            f32 term_rate) {
 ...
 * @param term_rate Term rate spawn weight modifier
 **/
static void aSOG_gyoei_make_island_range_data(aSOG_gyoei_keep_c* keep, int time_no, int term, int next_term,
                                              f32 term_rate) {
...
static void aSOG_gyoei_make_range_data(SET_MANAGER* set_manager, u32 block_type) {
    static aSOG_gyoei_make_range_proc make_range_data_proc[aSOG_RANGE_PROC_NUM] = {
        &aSOG_gyoei_make_river_range_data,         &aSOG_gyoei_make_sea_range_data,
        &aSOG_gyoei_make_offing_range_data,        &aSOG_gyoei_make_pool_range_data,
        &aSOG_gyoei_make_fishing_event_range_data, &aSOG_gyoei_make_island_range_data
    };
    ...
    /* get the current term (term0), the next term (term1), and the ratio of current-to-next term (term0_rate +
     * term1_rate = 1.0f) */
