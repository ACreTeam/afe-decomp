...
#include "assets/forestd/ef_turi_hamon01/ef_turi_hamon01_0.inc"
};

Vtx ef_turi_hamon01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_turi_hamon01/ef_turi_hamon01_00_v.inc"
};

Gfx ef_turi_hamon01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
