...
#include "assets/forestd/obj_toudai/obj_toudai_pole_pal.inc"
};

u16 obj_toudai_poleA_tex_pic_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_poleA_tex_pic_ci4_pal.inc"
};

u8 obj_toudai_poleE_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_poleE_tex_txt.inc"
};

u8 obj_toudai_pole_kage_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_pole_kage_txt.inc"
};

u8 obj_toudai_poleB_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_poleB_tex_txt.inc"
};

u8 obj_toudai_poleC_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_poleC_tex_txt.inc"
};

u8 obj_toudai_poleD_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_poleD_tex_txt.inc"
};

u8 obj_toudai_poleA_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_toudai/obj_toudai_poleA_tex_txt.inc"
};

Vtx obj_toudai_pole_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_toudai/obj_toudai_pole_v.inc"
};

Gfx obj_toudai_pole_kage_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_toudai_pole_evw_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_toudai_poleE_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_toudai_poleD1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
Gfx obj_toudai_poleC1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
Gfx obj_toudai_poleB_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
Gfx obj_toudai_poleD2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
Gfx obj_toudai_poleC2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
Gfx obj_toudai_poleD3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
Gfx obj_toudai_poleC3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_toudai_pole_pal),
...
u8 cKF_ckcb_r_obj_toudai_pole_tbl[] = {
0,
0,
0,
2,
...
s16 cKF_kn_obj_toudai_pole_tbl[] = {
2,
2,
2
};

s16 cKF_c_obj_toudai_pole_tbl[] = {
10000,
0,
16000,
-900,
...
s16 cKF_ds_obj_toudai_pole_tbl[] = {
1,
0,
1080,
100,
...
cKF_Animation_R_c cKF_ba_r_obj_toudai_pole = 
	{ cKF_ckcb_r_obj_toudai_pole_tbl, cKF_ds_obj_toudai_pole_tbl, cKF_kn_obj_toudai_pole_tbl, cKF_c_obj_toudai_pole_tbl, -1, 100 }
;
...
cKF_Skeleton_R_c cKF_bs_r_obj_toudai_pole = 
	{ ARRAY_COUNT(cKF_je_r_obj_toudai_pole_tbl), 10, cKF_je_r_obj_toudai_pole_tbl }
;
