...
#include "assets/forestd/pos_win_yajirushi/pos_win_yajirushi_tex.inc"
};

Vtx pos_yaji_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/pos_win_yajirushi/pos_yaji_v.inc"
};

Gfx pos_yaji_wakuT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
