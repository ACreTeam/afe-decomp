...
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/inv_mwin_nwaku_tex.inc"
};

u8 ctl_win_aw1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw1_tex.inc"
};

u8 ctl_win_aw2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw2_tex.inc"
};

u8 ctl_win_aw3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw3_tex.inc"
};

u8 ctl_win_aw4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw4_tex.inc"
};

u8 ctl_win_aw5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw5_tex.inc"
};

u8 ctl_win_kage1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_kage1_tex.inc"
};

u8 ctl_win_aw6_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw6_tex.inc"
};

static u8 ctl_win_tagu2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_tagu2_tex.inc"
};

static u8 ctl_win_waku1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_waku1_tex.inc"
};

static u8 ctl_win_waku2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_waku2_tex.inc"
};

u8 ctl_win_aw8_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw8_tex.inc"
};

u8 ctl_win_aw7_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_aw7_tex.inc"
};

u8 ctl_win_kage2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_kage2_tex.inc"
};

u8 ctl_win_kage3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_kage3_tex.inc"
};

u8 ctl_win_waku3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_waku3_tex.inc"
};

u8 ctl_win_waku4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_waku4_tex.inc"
};

u16 ctl_win_nuno1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno1_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno2_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno3_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno4_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno5_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno5_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno6_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno6_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno7_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno7_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_nuno8_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno8_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w8_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w8_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w1_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w2_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w3_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w4_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w5_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w5_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w6_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w6_tex_rgb_ci4_pal.inc"
};

u16 ctl_win_w7_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w7_tex_rgb_ci4_pal.inc"
};

u8 ctl_win_nuno1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno1_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno2_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno3_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno4_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno5_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno5_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno6_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno6_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno7_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno7_tex_rgb_ci4.inc"
};

u8 ctl_win_nuno8_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_nuno8_tex_rgb_ci4.inc"
};

u8 ctl_win_w8_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w8_tex_rgb_ci4.inc"
};

u8 ctl_win_w1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w1_tex_rgb_ci4.inc"
};

u8 ctl_win_w2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w2_tex_rgb_ci4.inc"
};

u8 ctl_win_w3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w3_tex_rgb_ci4.inc"
};

u8 ctl_win_w4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w4_tex_rgb_ci4.inc"
};

u8 ctl_win_w5_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w5_tex_rgb_ci4.inc"
};

u8 ctl_win_w6_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w6_tex_rgb_ci4.inc"
};

u8 ctl_win_w7_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win_w7_tex_rgb_ci4.inc"
};

Vtx ctl_win1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ctl_win_nuno8_tex_rgb_ci4/ctl_win1_v.inc"
};

Gfx ctl_win1_w13_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_ue1T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_ue2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_nameT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu1T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu3T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu4T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu6T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_tagu8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w1T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w3T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w4T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w6T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, ctl_win_w6_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, ctl_win_w6_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
...
Gfx ctl_win1_w7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, ctl_win_w3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, ctl_win_w3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
...
Gfx ctl_win1_w8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, ctl_win_w2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, ctl_win_w2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
...
Gfx ctl_win1_w9T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, ctl_win_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, ctl_win_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
...
Gfx ctl_win1_w10T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w11T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win1_w12T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, ctl_win_w4_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, ctl_win_w4_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
...
Gfx ctl_win1_kageT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_win_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx ctl_tag_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsSPLoadGeometryMode(G_SHADE | G_CULL_BACK | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx ctl_win_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win8_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win7_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win6_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win5_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win4_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win3_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win2_color_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ctl_win1_color_mode[] ATTRIBUTE_ALIGN(8) = {
