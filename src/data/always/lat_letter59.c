...
Vtx lat_letter59_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter59/lat_letter59_v.inc"
};

Gfx lat_letter59_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter59_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
