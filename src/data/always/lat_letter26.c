...
Vtx lat_letter26_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter26/lat_letter26_v.inc"
};

Gfx lat_letter26_win_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx lat_letter26_model[] ATTRIBUTE_ALIGN(8) = {
