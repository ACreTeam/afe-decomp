...
#include "assets/forestd/obj_shop_fossil/obj_item_fossil_pal.inc"
};

u8 obj_shop_fossil_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_fossil/obj_shop_fossil_tex.inc"
};

static Vtx obj_item_fossil_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_fossil/obj_item_fossil_v.inc"
};

Gfx obj_shop_fossil_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_shop_fossil_gfx_model[] ATTRIBUTE_ALIGN(8) = {
