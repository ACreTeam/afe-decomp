...
Vtx ef_x_tree5_cutR_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_x_tree5_cutR_light/ef_x_tree5_cutR_v.inc"
};

Gfx obj_x_tree5_cutR_light_model[] ATTRIBUTE_ALIGN(8) = {
gsSPDisplayList(ef_w_tree_light_modeset),
gsSPVertex(&ef_x_tree5_cutR_v[15], 12, 0),
...
Gfx ef_x_tree5_cutR_leaf_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_x_tree5_cutR_trunk_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_x_tree5_cutR = 
	{ ARRAY_COUNT(cKF_je_r_ef_x_tree5_cutR_tbl), 3, cKF_je_r_ef_x_tree5_cutR_tbl }
;
