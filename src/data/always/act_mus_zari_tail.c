...
#include "assets/forestd/act_mus_zari_tail/act_mus_zari_pal.inc"
};

u8 act_mus_zari_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_zari_tail/act_mus_zari_tex_txt.inc"
};

Vtx act_mus_zari_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_zari_tail/act_mus_zari_v.inc"
};

Gfx act_mus_zari_tail_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_zari_right_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, act_mus_zari_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, act_mus_zari_tex_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx act_mus_zari_left_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, act_mus_zari_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, act_mus_zari_tex_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx act_mus_zari_asi_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, act_mus_zari_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, act_mus_zari_tex_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx act_mus_zari_base_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, act_mus_zari_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, act_mus_zari_tex_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
cKF_Joint_R_c cKF_je_r_act_mus_zari_tbl[] = {
	{ NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 900, 50 } },
...
cKF_Skeleton_R_c cKF_bs_r_act_mus_zari = 
	{ ARRAY_COUNT(cKF_je_r_act_mus_zari_tbl), 5, cKF_je_r_act_mus_zari_tbl }
;
