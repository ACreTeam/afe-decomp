...
u8 act_bee_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_bee/act_bee_tex_txt.inc"
};

Vtx act_bee_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_bee/act_bee_v.inc"
};

Gfx act_bee_C_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_bee_B_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(4000, 4000, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 1, 0, TEXEL0, TEXEL1, 0, 0, 0, COMBINED, COMBINED, 0, PRIMITIVE, 0),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_CLD_SURF2),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 32, 32, act_bee_tex_txt),
...
Gfx act_bee_A_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(4000, 4000, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 1, 0, TEXEL0, TEXEL1, 0, 0, 0, COMBINED, COMBINED, 0, PRIMITIVE, 0),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_CLD_SURF2),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 32, 32, act_bee_tex_txt),
...
s16 cKF_kn_act_bee_tbl[] = {
2,
2
};

s16 cKF_c_act_bee_tbl[] = {
0,
0,
0,
0,
...
cKF_Joint_R_c cKF_je_r_act_bee_tbl[] = {
...
cKF_Skeleton_R_c cKF_bs_r_act_bee = 
	{ ARRAY_COUNT(cKF_je_r_act_bee_tbl), 3, cKF_je_r_act_bee_tbl }
;
