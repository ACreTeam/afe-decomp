...
#include "assets/forestd/obj_w_palm4_trunk/obj_w_palm_leaf_tex.inc"
};

static u8 obj_w_palm_trunk_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_palm4_trunk/obj_w_palm_trunk_tex.inc"
};

Vtx obj_w_palm4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_palm4_trunk/obj_w_palm4_v.inc"
};

Gfx obj_w_palm4_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_palm4_leafT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_palm4_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_w_palm4_trunkT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
