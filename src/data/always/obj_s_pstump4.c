...
#include "assets/forestd/obj_s_pstump4/obj_s_palm_stump_tex.inc"
};

Vtx obj_s_pstump4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_pstump4/obj_s_pstump4_v.inc"
};

Gfx obj_s_pstump4T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_pstump4T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
