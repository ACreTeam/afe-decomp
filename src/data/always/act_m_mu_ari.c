...
static Vtx act_m_ari_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_ari/act_m_ari_v.inc"
};

static u16 act_m_ari_pal[] = {
#include "assets/forestd/act_m_mu_ari/act_m_ari_pal.inc"
};

static u8 act_m_ari_tex[] = {
#include "assets/forestd/act_m_mu_ari/act_m_ari_tex.inc"
};

Gfx act_m_mu_ariT_model[] ATTRIBUTE_ALIGN(8) = {
