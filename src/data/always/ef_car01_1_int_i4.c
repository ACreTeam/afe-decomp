...
#include "assets/forestd/ef_car01_1_int_i4/ef_car01_1_int_i4.inc"
};

Vtx ef_car01_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_car01_1_int_i4/ef_car01_v.inc"
};

Gfx ef_car01_modelT[] ATTRIBUTE_ALIGN(8) = {
...
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_SHADING_SMOOTH | G_DECAL_EQUAL),
...
u8 ef_carhosi01_01[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_car01_1_int_i4/ef_carhosi01_01.inc"
};

Vtx ef_carhosi01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_car01_1_int_i4/ef_carhosi01_00_v.inc"
};

Gfx ef_carhosi01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
