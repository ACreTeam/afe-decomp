...
#include "assets/forestd/act_m_kirigirisu1/act_m_kirigirisu_pal.inc"
};

static u8 act_m_kirigirisu[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_kirigirisu1/act_m_kirigirisu.inc"
};

static Vtx act_m_kirigirisu_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_kirigirisu1/act_m_kirigirisu_v.inc"
};

Gfx act_m_kirigirisu1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_kirigirisu2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
