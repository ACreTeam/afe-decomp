...
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_nuno_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w5_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w5_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w1_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w2_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w3_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w4_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w6_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w6_tex_rgb_ci4_pal.inc"
};

static u16 inv_mushi_w7_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w7_tex_rgb_ci4_pal.inc"
};

static u8 inv_mwin_nwaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mwin_nwaku_tex.inc"
};

u8 inv_mwin_shirushi1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mwin_shirushi1_tex.inc"
};

static u8 inv_mwin_shirushi_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mwin_shirushi_tex.inc"
};

static u8 inv_mushi_aw1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_aw1_tex.inc"
};

static u8 inv_mushi_aw2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_aw2_tex.inc"
};

static u8 inv_mushi_aw3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_aw3_tex.inc"
};

static u8 inv_mushi_aw4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_aw4_tex.inc"
};

u8 inv_mushi_waku2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_waku2_tex.inc"
};

static u8 inv_mushi_aw7_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_aw7_tex.inc"
};

u8 inv_mushi_moji_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_moji_tex.inc"
};

u8 inv_mushi_aw5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_aw5_tex.inc"
};

u8 inv_mushi_nuno_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_nuno_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w5_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w5_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w1_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w2_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w3_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w4_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w6_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w6_tex_rgb_ci4.inc"
};

static u8 inv_mushi_w7_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_w7_tex_rgb_ci4.inc"
};

Vtx inv_mushi_pp_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/inv_mushi_nuno_tex_rgb_ci4/inv_mushi_pp_v.inc"
};

Gfx inv_mushi_w1T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPVertex(&inv_mushi_pp_v[8], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w2T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[12], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w3T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[16], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w4T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, inv_mushi_w3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[20], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, inv_mushi_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[24], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w6T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[28], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w7T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[32], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, inv_mushi_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[36], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w9T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, inv_mushi_w3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[40], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w10T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w4_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, inv_mushi_w4_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[44], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w11T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, inv_mushi_w3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[48], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w12T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, inv_mushi_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, inv_mushi_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[52], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w13T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[56], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_w14_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(inv_mushi_pp_v, 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx inv_mushi_waku2T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[83], 28, 0),
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&inv_mushi_pp_v[111], 23, 0),
...
Gfx inv_mushi_ue2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetPrimColor(0, 255, 255, 195, 195, 255),
...
gsSPVertex(&inv_mushi_pp_v[134], 13, 0),
...
Gfx inv_mushi_daimeiT_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx inv_mushi_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx inv_mushi_part_model[] ATTRIBUTE_ALIGN(8) = {
gsSPDisplayList(inv_mushi_waku2T_model),
gsSPDisplayList(inv_mushi_shirushiT_model),
gsSPEndDisplayList(),
};
