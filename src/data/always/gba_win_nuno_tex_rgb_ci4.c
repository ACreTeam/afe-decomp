...
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_nuno_tex_rgb_ci4_pal.inc"
};

u16 gba_win_w4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w4_tex_rgb_ci4_pal.inc"
};

u16 gba_win_w1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w1_tex_rgb_ci4_pal.inc"
};

u16 gba_win_w2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w2_tex_rgb_ci4_pal.inc"
};

u16 gba_win_w3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w3_tex_rgb_ci4_pal.inc"
};

static u8 sav_win_waku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/sav_win_waku_tex.inc"
};

u8 gba_win_aw1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_aw1_tex.inc"
};

u8 gba_win_aw2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_aw2_tex.inc"
};

u8 gba_win_aw3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_aw3_tex.inc"
};

u8 gba_win_aw4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_aw4_tex.inc"
};

static u8 inv_original_futa2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/inv_original_futa2_tex.inc"
};

u8 gba_win_nuno_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_nuno_tex_rgb_ci4.inc"
};

u8 gba_win_w4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w4_tex_rgb_ci4.inc"
};

u8 gba_win_w1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w1_tex_rgb_ci4.inc"
};

u8 gba_win_w2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w2_tex_rgb_ci4.inc"
};

u8 gba_win_w3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_w3_tex_rgb_ci4.inc"
};

Vtx gba_win_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/gba_win_nuno_tex_rgb_ci4/gba_win_v.inc"
};

Gfx gba_win_w_before_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx gba_win_w11_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx gba_win_waku_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx gba_win_mb_before_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
};

Gfx gba_win_mb1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[36], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[40], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[44], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb4_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[48], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb5_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[52], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb6_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[56], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb7_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[60], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_mb8_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&gba_win_v[64], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx gba_win_f_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx gba_win_w1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx gba_win_w2T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx gba_win_w3T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx gba_win_w4T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, gba_win_w2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_w5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, gba_win_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_w6T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, gba_win_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_w7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, gba_win_w2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_w8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 16, 32, gba_win_w3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_w9T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, gba_win_w2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_w10T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, gba_win_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, gba_win_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx gba_win_ueT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
