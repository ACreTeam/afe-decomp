...
#include "assets/forestd/obj_f_tree3_trunk/obj_f_tree_leaf_tex.inc"
};

Vtx obj_f_tree3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_f_tree3_trunk/obj_f_tree3_v.inc"
};

Gfx obj_f_tree3_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_f_gold_tree3_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_f_tree_leaf_tex),
...
Gfx obj_f_tree3_leafT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_f_tree3_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_f_gold_tree3_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_f_tree_young_tex),
...
Gfx obj_f_tree3_trunkT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
