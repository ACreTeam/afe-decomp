...
static int event_rumor_table[] = {
    ...
    mEv_EVENT_RUMOR_SPRING_SPORTS_FAIR,      mEv_EVENT_RUMOR_HARVEST_FESTIVAL, mEv_EVENT_77,
    mEv_EVENT_RUMOR_FISHING_TOURNEY_1,       mEv_EVENT_TALK_FISHING_TOURNEY_1, mEv_EVENT_RUMOR_MORNING_AEROBICS,
    mEv_EVENT_TALK_MORNING_AEROBICS,         mEv_EVENT_RUMOR_FIREWORKS_SHOW,   mEv_EVENT_77,
