...
u16 act_mu_ball_b_pal[] = {
#include "assets/forestd/act_mu_ball_b/act_mu_ball_b_pal.inc"
};

u8 act_mu_ball_b_1_tex[] = {
#include "assets/forestd/act_mu_ball_b/act_mu_ball_b_1_tex.inc"
};

Vtx act_mu_ball_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mu_ball_b/act_mu_ball_b_v.inc"
};

Gfx act_mu_ball_b_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetTextureLUT(G_TT_RGBA16),
gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, act_mu_ball_b_pal),
gsDPTileSync(),
...
gsDPPipeSync(),
gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, act_mu_ball_b_1_tex),
...
gsSPVertex(act_mu_ball_b_v, 26, 0),
