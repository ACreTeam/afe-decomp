...
#include "assets/forestd/tol_kamicup_1/tol_kamicup_pal.inc"
};

u8 tol_kamicup_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kamicup_1/tol_kamicup_tex.inc"
};

Vtx tol_kamicup_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kamicup_1/tol_kamicup_1_v.inc"
};

Gfx tol_kamicup_1T_model[] ATTRIBUTE_ALIGN(8) = {
