...
u16 int_sum_oonamazu_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/int_sum_oonamazu/int_sum_oonamazu_pal.inc"
};

u8 act_mus_oonamazu_body_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/int_sum_oonamazu/act_mus_oonamazu_body_txt.inc"
};

Vtx act_mus_onamazu_a1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/int_sum_oonamazu/act_mus_onamazu_a1_v.inc"
};

Gfx act_mus_onamazu_sakana_body_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_onamazu_sakana_head_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_sum_oonamazu_pal),
...
cKF_Skeleton_R_c cKF_bs_r_act_mus_onamazu_a1 = 
	{ ARRAY_COUNT(cKF_je_r_act_mus_onamazu_a1_tbl), 2, cKF_je_r_act_mus_onamazu_a1_tbl }
;
