...
#include "assets/forestd/act_f06_bass/act_f06_bass_pal.inc"
};

u8 act_f06_bass_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f06_bass/act_f06_bass_tex.inc"
};

Vtx act_f06_bass_a_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f06_bass/act_f06_bass_a_v.inc"
};

Gfx act_f06_bass_aT_model[] ATTRIBUTE_ALIGN(8) = {
...
Vtx act_f06_bass_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f06_bass/act_f06_bass_b_v.inc"
};

Gfx act_f06_bass_bT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, act_f06_bass_pal),
...
Vtx act_f06_bass_c_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f06_bass/act_f06_bass_c_v.inc"
};

Gfx act_f06_bass_cT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, act_f06_bass_pal),
