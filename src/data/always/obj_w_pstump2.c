...
#include "assets/forestd/obj_w_pstump2/obj_w_palm_young_tex.inc"
};

Vtx obj_w_pstump2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_pstump2/obj_w_pstump2_v.inc"
};

Gfx obj_w_pstump2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_pstump2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
