...
Vtx lat_letter64_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter64/lat_letter64_v.inc"
};

Gfx lat_letter64_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter64_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
