...
#include "assets/forestd/act_mus_kani_body2_005BCDE0/int_ike_kani_pal.inc"
};

static u8 act_mus_kani_body2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_kani_body2_005BCDE0/act_mus_kani_body2.inc"
};

static u8 act_mus_kani_body1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_kani_body2_005BCDE0/act_mus_kani_body1.inc"
};

static Vtx act_m_kani_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_kani_body2_005BCDE0/act_m_kani_v.inc"
};

Gfx act_m_mu_kani1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_kani2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_kani_pal),
