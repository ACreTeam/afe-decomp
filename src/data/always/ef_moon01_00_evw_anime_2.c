...
EVW_ANIME_SCROLL ef_moon01_00_evw_anime_2[] ATTRIBUTE_ALIGN(32) = {
	{ 0, 0, 64, 64 },
	{ 1, -1, 32, 32 }
};

EVW_ANIME_DATA ef_moon01_00_evw_anime[] = {
	{ -1, EVW_ANIME_TYPE_SCROLL2, ef_moon01_00_evw_anime_2 }
};

u8 ef_moon01_0_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_moon01_00_evw_anime_2/ef_moon01_0_int_i4.inc"
};

static u8 ef_moon01_1_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_moon01_00_evw_anime_2/ef_moon01_1_int_i4.inc"
};

Vtx ef_moon01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_moon01_00_evw_anime_2/ef_moon01_00_v.inc"
};

Gfx ef_moon01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
