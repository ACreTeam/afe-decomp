...
Vtx rom_shop1f_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop1f/rom_shop1f_v.inc"
};

Gfx rom_shop1f_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx rom_shop1f_model[] ATTRIBUTE_ALIGN(8) = {
