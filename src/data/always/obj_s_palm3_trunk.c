...
#include "assets/forestd/obj_s_palm3_trunk/obj_s_palm_leaf_tex.inc"
};

static u8 obj_s_palm_young_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_s_palm3_trunk/obj_s_palm_young_tex.inc"
};

Vtx obj_s_palm3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_palm3_trunk/obj_s_palm3_v.inc"
};

Gfx obj_s_palm3_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_palm3_leafT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_palm3_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_palm3_trunkT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
