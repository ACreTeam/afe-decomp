...
#include "assets/forestd/act_balloon/act_balloon_wire_tex_txt.inc"
};

u8 act_balloon_head_tex_rgb_ia8[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_balloon/act_balloon_head_tex_rgb_ia8.inc"
};

Vtx act_balloon_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_balloon/act_balloon_v.inc"
};

Gfx act_balloon_head_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_balloon_wireB_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_balloon_wireA_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 100),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
cKF_Joint_R_c cKF_je_r_act_balloon_tbl[] = {
...
cKF_Skeleton_R_c cKF_bs_r_act_balloon = 
	{ ARRAY_COUNT(cKF_je_r_act_balloon_tbl), 3, cKF_je_r_act_balloon_tbl }
;
