...
#include "assets/forestd/tol_kaza_6/tol_kaza_6_pal.inc"
};

static u8 tol_kaza_6_a_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_6/tol_kaza_6_a_tex_txt.inc"
};

static u8 tol_kaza_6_c_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_6/tol_kaza_6_c_tex_txt.inc"
};

static u8 tol_kaza_6_b_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_6/tol_kaza_6_b_tex_txt.inc"
};

Vtx obj_shop_kaza6_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kaza_6/obj_shop_kaza6_v.inc"
};

Gfx obj_shop_kaza6_model[] ATTRIBUTE_ALIGN(8) = {
