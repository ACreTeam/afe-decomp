...
Vtx obj_s_fenceS_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_fenceS/obj_s_fenceS_v.inc"
};

Gfx obj_s_fenceST_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_fenceST_gfx_model[] ATTRIBUTE_ALIGN(8) = {
