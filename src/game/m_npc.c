...
static void mNpc_ResetAnimalRelation(int idx) {
    Animal_c* animal = Save_Get(animals);
    s8* this_relations = animal[idx].animal_relations;
    int i;
...
extern void mNpc_Mail2AnimalMail(Anmplmail_c* animal_mail, Mail_c* mail) {
    mem_copy(animal_mail->body, mail->content.text.split.body, MAIL_BODY_LEN);
    mem_copy(animal_mail->header, mail->content.text.split.header, MAIL_HEADER_LEN);
    mem_copy(animal_mail->footer, mail->content.text.split.footer, MAIL_FOOTER_LEN);
...
extern void mNpc_AnimalMail2Mail(Mail_c* mail, Anmplmail_c* animal_mail, PersonalID_c* pid, AnmPersonalID_c* anm_id) {
    mem_copy(mail->content.text.split.body, animal_mail->body, MAIL_BODY_LEN);
    mem_copy(mail->content.text.split.header, animal_mail->header, MAIL_HEADER_LEN);
    mem_copy(mail->content.text.split.footer, animal_mail->footer, MAIL_FOOTER_LEN);
