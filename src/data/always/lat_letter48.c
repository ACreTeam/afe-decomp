...
Vtx lat_letter48_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter48/lat_letter48_v.inc"
};

Gfx lat_letter48_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter48_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
