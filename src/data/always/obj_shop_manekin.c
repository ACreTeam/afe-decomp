...
#include "assets/forestd/obj_shop_manekin/obj_shop_manekin_pal.inc"
};

u8 obj_shop_manekin_bottom_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_manekin/obj_shop_manekin_bottom_tex_txt.inc"
};

u8 obj_shop_manekin_foot_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_manekin/obj_shop_manekin_foot_tex_txt.inc"
};

u8 obj_shop_manekin_top_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_manekin/obj_shop_manekin_top_tex_txt.inc"
};

Vtx obj_shop_manekin_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_manekin/obj_shop_manekin_v.inc"
};

Gfx obj_shop_manekin_model[] ATTRIBUTE_ALIGN(8) = {
