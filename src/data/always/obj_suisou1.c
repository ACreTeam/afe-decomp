...
#include "assets/forestd/obj_suisou1/obj_suisou1_pal.inc"
};

u16 obj_suisou1_evw_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_evw_tex_rgb_ci4_pal.inc"
};

u8 obj_suisou1_front_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_front_tex.inc"
};

u8 obj_suisou1_futi_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_futi_tex.inc"
};

u8 obj_suisou1_isi_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_isi_tex.inc"
};

u8 obj_suisou1_mizu_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_mizu_tex.inc"
};

u8 obj_suisou1_evw_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_evw_tex.inc"
};

u8 obj_suisou1_water1_tex_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_water1_tex_rgb_i4.inc"
};

u8 obj_suisou1_water2_tex_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_water2_tex_rgb_i4.inc"
};

Vtx obj_suisou1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_suisou1/obj_suisou1_v.inc"
};

Gfx obj_suisou1_modelT[] ATTRIBUTE_ALIGN(8) = {
...
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx obj_suisou1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx act_mus_fish_set_mode[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
