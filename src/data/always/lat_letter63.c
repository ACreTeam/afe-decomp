...
Vtx lat_letter63_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter63/lat_letter63_v.inc"
};

Gfx lat_letter63_win_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx lat_letter63_senT_model[] ATTRIBUTE_ALIGN(8) = {
