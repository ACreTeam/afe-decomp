...
Vtx lat_letter41_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter41/lat_letter41_v.inc"
};

Gfx lat_letter41_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter41_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
