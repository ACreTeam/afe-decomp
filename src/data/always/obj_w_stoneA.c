...
#include "assets/forestd/obj_w_stoneA/obj_w_stone_pal.inc"
};

u8 obj_w_stone_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_stoneA/obj_w_stone_tex.inc"
};

Vtx obj_w_stoneA_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_stoneA/obj_w_stoneA_v.inc"
};

Gfx obj_w_stoneA_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_stoneA_gfx_model[] ATTRIBUTE_ALIGN(8) = {
