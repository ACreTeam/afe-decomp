...
typedef u16 (*aMKBC_BGM_NO_PROC)(NPC_TOTAKEKE_ACTOR* totakeke);
typedef int (*aMKBC_BIRTHDAY_SECTION_PROC)(int section);
...
struct mikanbox_clip_s {
    ...
    /* 0x014 */ aMKBC_BIRTHDAY_SECTION_PROC birthday_section_proc;
    /* 0x018 */ aMKBC_BGM_NO_PROC bgm_no_proc;
    /* 0x01C */ aMKBC_ROLL_PROC roll_proc;
    /* 0x020 */ aMKBC_HEAD_UP_PROC head_up_proc;
    /* 0x024 */ aMKBC_SET_ITEMSTR_PROC set_itemstr_proc;
    /* 0x028 */ aMKBC_SET_ITEMSTR3_PROC set_itemstr3_proc;
    /* 0x02C */ aMKBC_SEARCH_MERODY_PROC search_merody_proc;
    /* 0x030 */ aMKBC_CHECK_MERODY_PROC check_merody_proc;
};
