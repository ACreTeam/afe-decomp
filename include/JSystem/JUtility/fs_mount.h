...
extern u16 FS_ChkMBR(SDDriveInfo* pDriveInfo, FSMasterBootRecord* pMBR, FSDescriptor* pFDC);
...
extern u16 FS_ReadFATSetFAT(SDDriveInfo* pDriveInfo);
extern u16 FS_ChkFDC(SDDriveInfo* pDriveInfo, FSDescriptor* pFDC, u16 param3);
extern u16 FS_ChkFDCfatal(SDDriveInfo* pDriveInfo, FSDescriptor* pFDC);
