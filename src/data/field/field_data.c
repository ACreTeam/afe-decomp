...
extern mFM_move_actor_data_c reset_house_actable[];
...
mFM_field_data_c data_fdd[SCENE_NUM] = {
    ...
    // SCENE_RESET_HOUSE
    {
        mFI_FIELD_ROOM_RESET_HOUSE,
        1, 1,
        {
            { 0x0170, 0 }, // entry into data_combi_table
        },
        reset_house_actable,
        0x00000000,
        0x00000000,
