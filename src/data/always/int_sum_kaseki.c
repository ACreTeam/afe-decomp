...
u16 int_sum_kaseki_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/int_sum_kaseki/int_sum_kaseki_pal.inc"
};

u8 act_mus_kaseki_body_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/int_sum_kaseki/act_mus_kaseki_body_txt.inc"
};

Vtx act_mus_kaseki_a1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/int_sum_kaseki/act_mus_kaseki_a1_v.inc"
};

Gfx act_mus_kaseki_sakana_leg_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_kaseki_sakana_body_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_kaseki_sakana_head_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, int_sum_kaseki_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, act_mus_kaseki_body_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
...
cKF_Skeleton_R_c cKF_bs_r_act_mus_kaseki_a1 = 
