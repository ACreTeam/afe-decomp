...
#include "assets/forestd/act_m_nokogiri_b_005C1B90/act_m_nokogiri_txt.inc"
};

Vtx act_m_nokogiri_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_nokogiri_b_005C1B90/act_m_nokogiri_b_v.inc"
};

Gfx act_m_nokogiri_b_left_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_CLAMP, 6, G_TX_NOLOD, G_TX_MIRROR | G_TX_WRAP, 4, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 1023, 512),
gsDPPipeSync(),
gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 0, G_TX_RENDERTILE, 0, G_TX_NOMIRROR | G_TX_CLAMP, 6, G_TX_NOLOD, G_TX_MIRROR | G_TX_WRAP, 4, G_TX_NOLOD),
...
Gfx act_m_nokogiri_b_right_model[] ATTRIBUTE_ALIGN(8) = {
gsSPMatrix(anime_6_mdl, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx act_m_nokogiri_b_base_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
cKF_Skeleton_R_c cKF_bs_r_act_m_nokogiri_b = 
	{ ARRAY_COUNT(cKF_je_r_act_m_nokogiri_b_tbl), 3, cKF_je_r_act_m_nokogiri_b_tbl }
;
