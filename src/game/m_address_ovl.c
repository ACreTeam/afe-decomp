...
static Vtx lat_atena_v[48] = {
    // Page 1
    {{{0xFEAC, 0x0000, 0x0000}, 0x0000, {0x0000, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0154, 0x0000, 0x0000}, 0x0000, {0x0800, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFEAC, 0x00AA, 0x0000}, 0x0000, {0x0000, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0154, 0x00AA, 0x0000}, 0x0000, {0x0800, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFEAC, 0x0000, 0x0000}, 0x0000, {0x0000, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFEAC, 0xFF56, 0x0000}, 0x0000, {0x0000, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0154, 0x0000, 0x0000}, 0x0000, {0x0800, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0154, 0xFF56, 0x0000}, 0x0000, {0x0800, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFECA, 0xFFE2, 0x0000}, 0x0000, {0x0000, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0172, 0xFFE2, 0x0000}, 0x0000, {0x0800, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFECA, 0x008C, 0x0000}, 0x0000, {0x0000, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0172, 0x008C, 0x0000}, 0x0000, {0x0800, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFECA, 0xFFE2, 0x0000}, 0x0000, {0x0000, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFECA, 0xFF38, 0x0000}, 0x0000, {0x0000, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0172, 0xFFE2, 0x0000}, 0x0000, {0x0800, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0172, 0xFF38, 0x0000}, 0x0000, {0x0800, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    // Page 2
    {{{0xFEAC, 0x0000, 0x0000}, 0x0000, {0x0000, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0x0154, 0x0000, 0x0000}, 0x0000, {0x0800, 0x0200}, {0xB2, 0xB2, 0xB2, 0xB2}}},
    {{{0xFEAC, 0x00AA, 0x0000}, 0x0000, {0x0000, 0x0000}, {0xB2, 0xB2, 0xB2, 0xB2}}},
...
static u8 l_shop_name_str[ANIMAL_NAME_LEN] = { CHAR_PP_015, CHAR_PP_022, CHAR_PP_006, CHAR_PP_016, CHAR_PP_032, CHAR_PP_032 }; // たぬきち  (Tanukichi, Tom Nook)
static u8 mAD_title_str[] = {
    CHAR_PP_030, CHAR_PP_238, CHAR_PP_025, CHAR_PP_000, CHAR_PP_018, CHAR_PP_020,
    CHAR_PP_194, CHAR_PP_151, CHAR_PP_178, CHAR_PP_018, CHAR_PP_023, CHAR_PP_033
};
static u8 mAD_title_str2[] = {
    CHAR_PP_145, CHAR_PP_220, CHAR_PP_186, CHAR_PP_157, CHAR_PP_016, CHAR_PP_203,
    CHAR_PP_002, CHAR_PP_231, CHAR_PP_150, CHAR_PP_183, CHAR_PP_244, CHAR_PP_012
};
...
static void mAD_address_draw_init(Submenu* submenu) {
    ...
    for (i = 0; i < mAD_PAGE_NUM; i++) {
        ...
        if (count >= 0) {
            ...
            ofs = (int)(count * (900.0f / (mAD_PAGE_MAX_ENTRIES - 1)));
            for (j = 0; j < 2; j++) {
                vtx_p[4 + j * 8].v.ob[1] = vtx_p[0 + j * 8].v.ob[1] - ofs;
                vtx_p[6 + j * 8].v.ob[1] = vtx_p[1 + j * 8].v.ob[1] - ofs;
                vtx_p[5 + j * 8].v.ob[1] = vtx_p[4 + j * 8].v.ob[1] - 170;
                vtx_p[7 + j * 8].v.ob[1] = vtx_p[6 + j * 8].v.ob[1] - 170;
            }
        }
    }
}
...
static void mAD_set_first_tag(Submenu* submenu, GAME* game, GRAPH* graph, f32 pos_x, f32 pos_y) {
    ...
    static f32 offset[][2] = { { -72.0f, 8.0f }, { -72.0f, 8.0f } };
    u8* title_p;
    int len;
    f32* ofs_p;
    int idx;
    ...
    mFont_SetLineStrings(game, title_p, len, 160.0f + (pos_x + offset[idx][0]), 120.0f - (pos_y + offset[idx][1]), 80, 80, 230, 255, FALSE, FALSE, 1.0f, 1.0f, mFont_MODE_POLY);
}
...
static void mAD_set_addressSel_tag_field(GRAPH* graph, f32 pos_x, f32 pos_y, int idx, int col_idx) {
    ...
    Matrix_scale(16.0f, 16.0f, 1.0f, MTX_LOAD);
    Matrix_translate(pos_x, pos_y, 140.0f, MTX_MULT);
    Matrix_scale(0.1f, 0.1f, 1.0f, MTX_MULT);

    OPEN_POLY_OPA_DISP(graph);

    gSPSegment(POLY_OPA_DISP++, ANIME_1_TXT_SEG, &lat_atena_v[idx * 16]);
    gSPMatrix(POLY_OPA_DISP++, _Matrix_to_Mtx_new(graph), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
