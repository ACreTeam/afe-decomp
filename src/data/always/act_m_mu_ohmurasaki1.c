...
#include "assets/forestd/act_m_mu_ohmurasaki1/act_m_ohmurasaki_v.inc"
};

static u16 act_m_ohmurasaki_pal[] = {
#include "assets/forestd/act_m_mu_ohmurasaki1/act_m_ohmurasaki_pal.inc"
};

static u8 act_m_ohmurasaki[] = {
#include "assets/forestd/act_m_mu_ohmurasaki1/act_m_ohmurasaki.inc"
};

Gfx act_m_mu_ohmurasaki1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_ohmurasaki2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
