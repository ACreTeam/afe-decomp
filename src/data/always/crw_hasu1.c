...
#include "assets/forestd/crw_hasu1/crw_hasu1_pal.inc"
};

u8 crw_hasu1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_hasu1/crw_hasu1_tex_txt.inc"
};

Vtx crw_hasu1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_hasu1/crw_hasu1_v.inc"
};

Gfx crw_hasu1_body_model[] ATTRIBUTE_ALIGN(8) = {
