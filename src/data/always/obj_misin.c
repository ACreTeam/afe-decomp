...
#include "assets/forestd/obj_misin/obj_misin_pal.inc"
};

u16 obj_misin_belt_tex_pic_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_belt_tex_pic_ci4_pal.inc"
};

u8 obj_misin_ito1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_ito1_tex_txt.inc"
};

u8 obj_misin_ito2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_ito2_tex_txt.inc"
};

u8 obj_misin_maru_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_maru_tex_txt.inc"
};

u8 obj_misin_jiku_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_jiku_tex_txt.inc"
};

u8 obj_misin_ana_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_ana_tex_txt.inc"
};

u8 obj_misin_hari_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_hari_tex_txt.inc"
};

u8 obj_misin_ito3_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_ito3_tex_txt.inc"
};

u8 obj_misin_belt_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_misin/obj_misin_belt_tex_txt.inc"
};

Vtx obj_misin_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_misin/obj_misin_v.inc"
};

Gfx obj_misin_belt_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_misin_ana_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
Gfx obj_misin_ito2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_misin_pal),
...
Gfx obj_misin_ito1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_misin_pal),
...
Gfx obj_misin_maru_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_misin_pal),
...
Gfx obj_misin_jiku_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_misin_pal),
...
Gfx obj_misin_ito4_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_misin_pal),
...
Gfx obj_misin_ito3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
Gfx obj_misin_hari_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_misin_pal),
...
s16 cKF_kn_obj_misin_tbl[] = {
13,
2,
2
};

s16 cKF_c_obj_misin_tbl[] = {
5950,
6000,
13000,
-900,
...
cKF_Joint_R_c cKF_je_r_obj_misin_tbl[] = {
	{ NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 5950, 6000, 13000 } },
...
cKF_Skeleton_R_c cKF_bs_r_obj_misin = 
	{ ARRAY_COUNT(cKF_je_r_obj_misin_tbl), 9, cKF_je_r_obj_misin_tbl }
;
