...
#include "assets/forestd/pas_win_nimotu/pas_win_nimotu_pal.inc"
};

u16 pas_win_nuno_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_nuno_tex_rgb_ci4_pal.inc"
};

u16 pas_win_ta1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_ta1_tex_rgb_ci4_pal.inc"
};

u16 pas_win_ta2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_ta2_tex_rgb_ci4_pal.inc"
};

u16 pas_win_ta3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_ta3_tex_rgb_ci4_pal.inc"
};

u8 pas_win_wa_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_wa_tex.inc"
};

u8 pas_win_test_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_test_tex.inc"
};

u8 pas_win_icon_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_icon_tex.inc"
};

static u8 fkm_win_w4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/fkm_win_w4_tex.inc"
};

static u8 fkm_win_w3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/fkm_win_w3_tex.inc"
};

static u8 fkm_win_w2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/fkm_win_w2_tex.inc"
};

static u8 fkm_win_w1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/fkm_win_w1_tex.inc"
};

static u8 pwd_win_fuki_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pwd_win_fuki_tex.inc"
};

u8 pas_win_nuno_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_nuno_tex_rgb_ci4.inc"
};

u8 pas_win_ta1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_ta1_tex_rgb_ci4.inc"
};

u8 pas_win_ta2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_ta2_tex_rgb_ci4.inc"
};

u8 pas_win_ta3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/pas_win_nimotu/pas_win_ta3_tex_rgb_ci4.inc"
};

Vtx pas_win_pp_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/pas_win_nimotu/pas_win_pp_v.inc"
};

Gfx pas_win_fuki_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPVertex(pas_win_pp_v, 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_wmura_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(TEXEL0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, TEXEL0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE),
...
gsSPVertex(&pas_win_pp_v[4], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_wname_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE),
gsDPSetPrimColor(0, 255, 255, 255, 215, 180),
gsDPSetRenderMode(G_RM_AA_OPA_SURF, G_RM_AA_OPA_SURF2),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, pas_win_test_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[8], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_waku1_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, PRIMITIVE, 0, TEXEL0, 0, 0, 0, 0, PRIMITIVE, PRIMITIVE, 0, TEXEL0, 0),
gsDPSetRenderMode(G_RM_XLU_SURF, G_RM_XLU_SURF2),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, pas_win_wa_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPVertex(&pas_win_pp_v[12], 24, 0),
...
Gfx pas_win_waku2_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, PRIMITIVE, 0, TEXEL0, 0, 0, 0, 0, PRIMITIVE, PRIMITIVE, 0, TEXEL0, 0),
gsDPSetRenderMode(G_RM_XLU_SURF, G_RM_XLU_SURF2),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, pas_win_wa_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPVertex(&pas_win_pp_v[36], 24, 0),
...
Gfx pas_win_w1T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPVertex(&pas_win_pp_v[60], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w2T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPVertex(&pas_win_pp_v[64], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w3T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[68], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w4T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[72], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, pas_win_ta1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[76], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w6T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[80], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, pas_win_ta2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[84], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, pas_win_ta3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
gsSPVertex(&pas_win_pp_v[88], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w9T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, pas_win_ta2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[92], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_w10T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, pas_win_ta1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, pas_win_ta1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[96], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_ueT_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[100], 24, 0),
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&pas_win_pp_v[124], 12, 0),
...
Gfx pas_win_iconT_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
gsSPVertex(&pas_win_pp_v[136], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx pas_win_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx pas_win_model[] ATTRIBUTE_ALIGN(8) = {
