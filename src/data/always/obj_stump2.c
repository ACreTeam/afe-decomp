...
Vtx obj_s_stump2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_stump2/obj_s_stump2_v.inc"
};

Gfx obj_stump2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_gold_stump2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_s_tree_young_tex),
...
Gfx obj_stump2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
