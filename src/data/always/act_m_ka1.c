...
#include "assets/forestd/act_m_ka1/act_m_ka_pal.inc"
};

static u8 act_m_ka_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_ka1/act_m_ka_tex.inc"
};

static Vtx act_m_ka_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_ka1/act_m_ka_v.inc"
};

Gfx act_m_ka1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_ka2_1T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
...
Gfx act_m_ka2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, ENVIRONMENT, 0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 180),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
