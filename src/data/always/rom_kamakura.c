...
#include "assets/forestd/rom_kamakura/rom_kamakura_carp_pal.inc"
};

u16 rom_kamakura_goza_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_goza_pal.inc"
};

u16 rom_kamakura_yuki_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_yuki_pal.inc"
};

u16 rom_kamakura_rou_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_rou_pal.inc"
};

u16 rom_kamakura_a1_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_a1_pal.inc"
};

u16 rom_kamakura_nabe_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_nabe_pal.inc"
};

u8 rom_kamakura_carp[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_carp.inc"
};

u8 rom_kamakura_goza[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_goza.inc"
};

u8 rom_kamakura_yuki1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_yuki1.inc"
};

u8 rom_kamakura_yuki2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_yuki2.inc"
};

u8 rom_kamakura_yuki3[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_yuki3.inc"
};

u8 rom_kamakura_yuki4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_yuki4.inc"
};

u8 rom_kamakura_rou[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_rou.inc"
};

u8 rom_kamakura_a1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_a1.inc"
};

u8 rom_kamakura_wa[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_wa.inc"
};

u8 rom_kamakura_nabe1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_nabe1.inc"
};

u8 rom_kamakura_etc[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_etc.inc"
};

u8 rom_kamakura_kage_us[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_kage_us.inc"
};

u8 rom_kamakura_a2_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_a2_rgb_ci4.inc"
};

u8 rom_kamakura__takibi1_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura__takibi1_int_i4.inc"
};

u8 rom_kamakura__takibi2_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura__takibi2_int_i4.inc"
};

u8 rom_kamakura_fire1_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_fire1_rgb_i4.inc"
};

u8 rom_kamakura_fire2_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_fire2_rgb_i4.inc"
};

u8 rom_kamakura_fire3_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_fire3_rgb_i4.inc"
};

Vtx rom_kamakura_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_v.inc"
};

Gfx rom_kamakura_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_kamakura_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
#include "assets/forestd/rom_kamakura/rom_kamakura_ring1.inc"
};

Vtx rom_kamakura_ring_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_kamakura/rom_kamakura_ring_v.inc"
};

Gfx rom_kamakura_ring_modelT[] ATTRIBUTE_ALIGN(8) = {
