...
static Vtx act_m_okuwa_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_okuwa1/act_m_okuwa_v.inc"
};

static u16 act_m_okuwa_pal[] = {
#include "assets/forestd/act_m_mu_okuwa1/act_m_okuwa_pal.inc"
};

static u8 act_m_okuwa[] = {
#include "assets/forestd/act_m_mu_okuwa1/act_m_okuwa.inc"
};

Gfx act_m_mu_okuwa1T_model[] ATTRIBUTE_ALIGN(8) = {
