...
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_ent_pal.inc"
};

static u16 rom_shop_kouhaku_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop_kouhaku_pal.inc"
};

static u16 rom_shop3_tana_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_tana_pal.inc"
};

static u16 rom_shop3_leji_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_leji_pal.inc"
};

static u16 rom_shop3_desk_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_desk_pal.inc"
};

static u16 rom_shop3_bini_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_bini_pal.inc"
};

static u16 rom_shop3_mat_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_mat_pal.inc"
};

static u16 rom_shop3_wallC_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_wallC_pal.inc"
};

static u8 rom_shop3_ent[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_ent.inc"
};

static u8 rom_shop_kouhaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop_kouhaku_tex.inc"
};

u8 rom_shop3_tana2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_tana2.inc"
};

static u8 rom_shop3_kago_b[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_kago_b.inc"
};

static u8 rom_shop3_leji_f[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_leji_f.inc"
};

static u8 rom_shop3_leji_k[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_leji_k.inc"
};

static u8 rom_shop3_leji_b[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_leji_b.inc"
};

static u8 rom_shop3_desk_a[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_desk_a.inc"
};

static u8 rom_shop3_desk_b[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_desk_b.inc"
};

static u8 rom_shop3_desk_c[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_desk_c.inc"
};

static u8 rom_shop3_tana_t[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_tana_t.inc"
};

static u8 rom_shop3_bini[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_bini.inc"
};

static u8 rom_shop3_bini_b[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_bini_b.inc"
};

static u8 rom_shop3_car[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_car.inc"
};

static u8 rom_shop3_bini_a[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_bini_a.inc"
};

static u8 rom_shop3_wallC[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_wallC.inc"
};

static u8 rom_shop3_wallD[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_wallD.inc"
};

static u8 rom_shop3_floorE[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_floorE.inc"
};

static u8 rom_shop3_kage1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_kage1.inc"
};

Vtx rom_shop3_fuku_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop_kouhaku_00672080/rom_shop3_fuku_v.inc"
};

Gfx rom_shop3_fuku_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx rom_shop3_fuku_model[] ATTRIBUTE_ALIGN(8) = {
