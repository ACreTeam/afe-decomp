...
Vtx lat_letter53_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter53/lat_letter53_v.inc"
};

Gfx lat_letter53_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter53_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
