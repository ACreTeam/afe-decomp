...
#include "assets/forestd/obj_myhome_step_up/rom_myhome_pal.inc"
};

u8 rom_myhome_step_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_myhome_step_up/rom_myhome_step_tex.inc"
};

Vtx obj_myhome_step_up_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_myhome_step_up/obj_myhome_step_up_v.inc"
};

Gfx obj_myhome_step_up_model[] ATTRIBUTE_ALIGN(8) = {
