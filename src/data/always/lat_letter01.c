...
#include "assets/forestd/lat_letter01/lat_letter01_v.inc"
};

Gfx lat_letter01_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter01_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, lat_letter01_pal),
...
Gfx lat_letter01_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter01_model[] ATTRIBUTE_ALIGN(8) = {
