...
#include "assets/forestd/act_mus_areku_body_0021D740/int_ike_areku_pal.inc"
};

static u8 act_mus_areku_body[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_areku_body_0021D740/act_mus_areku_body.inc"
};

static Vtx act_m_areku_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_areku_body_0021D740/act_m_areku_v.inc"
};

Gfx act_m_areku1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_areku2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_areku_pal),
