...
#include "assets/forestd/crw_bag1/crw_bag1_pal.inc"
};

u8 crw_bag1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_bag1/crw_bag1_tex_txt.inc"
};

u8 crw_bagpikke1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_bag1/crw_bagpikke1_tex_txt.inc"
};

u8 crw_bagpikke2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_bag1/crw_bagpikke2_tex_txt.inc"
};

Vtx crw_bag1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_bag1/crw_bag1_v.inc"
};

Gfx crw_bag1_body_model[] ATTRIBUTE_ALIGN(8) = {
