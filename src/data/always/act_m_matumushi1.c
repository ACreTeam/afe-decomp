...
#include "assets/forestd/act_m_matumushi1/act_m_matumushi_pal.inc"
};

static u8 act_m_matumushi[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_matumushi1/act_m_matumushi.inc"
};

static Vtx act_m_matumushi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_matumushi1/act_m_matumushi_v.inc"
};

Gfx act_m_matumushi1T_model[] ATTRIBUTE_ALIGN(8) = {
