...
static void mBGMPsComp_delete_ps_fieldSchedEv(u16 bgm_num, u16 stop_type);
static void mBGMPsComp_search_cf_set_field(u16 bgm_num, int kategorie);
...
static void mBGMPsComp_make_ps_fieldSchedEv(u16 bgm_num, int update_volume_move_ctr, int update_volume_level,
...
static void mBGMPsComp_volume_change_fieldSchedEv(u16 bgm_num, int update_volume_move_ctr, int update_volume_level);
...
static void _mBGMPsComp_make_ps_fanfare(u16 bgm_num, u16 stop_type) {
    mBGMElem elem;
...
static void _mBGMPsComp_make_ps_demo(u16 bgm_num, u16 stop_type) {
    mBGMElem elem;
...
static void _mBGMPsComp_make_ps_happening(u16 bgm_num, u16 stop_type) {
    mBGMElem elem;
...
static void _mBGMPsComp_make_ps_room(u16 bgm_num, u16 stop_type) {
    mBGMElem elem;
...
static void _mBGMPsComp_make_ps_fieldSuddenEv(u16 bgm_num, u16 stop_type, u8 priority) {
    mBGMElem elem;
...
static void mBGMPsComp_delete_ps(mBGMPsComp* ps_comp, int kategorie, u16 bgm_num, u16 stop_type, int counter_flag) {
...
static void _mBGMPsComp_delete_ps_fanfare(u16 bgm_num, u16 stop_type) {
...
static void _mBGMPsComp_delete_ps_demo(u16 bgm_num, u16 stop_type) {
...
static void _mBGMPsComp_delete_ps_happening(u16 bgm_num, u16 stop_type) {
...
static void _mBGMPsComp_delete_ps_fieldSuddenEv(u16 bgm_num, u16 stop_type) {
