...
extern Gfx tmp_model[] = {
    ...
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_16b, 1, 4, grass_tex_dummy),
    ...
    gsDPPipeSync(),
    gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 2, 0x0000, G_TX_RENDERTILE, 15, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
