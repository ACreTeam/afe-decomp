...
Vtx lat_letter07_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter07/lat_letter07_v.inc"
};

Gfx lat_letter07_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter07_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter07_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter07_model[] ATTRIBUTE_ALIGN(8) = {
