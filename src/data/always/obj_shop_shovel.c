...
#include "assets/forestd/obj_shop_shovel/obj_shop_shovel_pal.inc"
};

u8 obj_shop_shovel_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_shovel/obj_shop_shovel_tex.inc"
};

Vtx obj_shop_shovel_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_shovel/obj_shop_shovel_v.inc"
};

Gfx obj_shovelT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_shovelT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
