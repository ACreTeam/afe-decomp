...
#include "assets/forestd/obj_x_honeycomb/obj_x_honeycomb_pal.inc"
};

u8 obj_x_honeycomb_tex[] = {
#include "assets/forestd/obj_x_honeycomb/obj_x_honeycomb_tex.inc"
};

Vtx obj_x_honeycomb_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_x_honeycomb/obj_x_honeycomb_v.inc"
};

Gfx obj_x_honeycombT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx obj_x_honeycombT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
