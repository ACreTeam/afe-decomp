...
Vtx lat_letter02_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter02/lat_letter02_v.inc"
};

Gfx lat_letter02_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter02_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
