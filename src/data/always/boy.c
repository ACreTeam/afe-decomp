...
u8 boy_1_horn_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_horn_tex_txt.inc"
};

u8 boy_1_skin_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_skin_tex_txt.inc"
};

u8 boy_1_hole_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_hole_tex_txt.inc"
};

u8 boy_1_shoe_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_shoe_tex_txt.inc"
};

u8 boy_1_bottom_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_bottom_tex_txt.inc"
};

u8 boy_1_foot_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_foot_tex_txt.inc"
};

u8 boy_1_pants_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/boy/boy_1_pants_tex_txt.inc"
};

Vtx boy_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/boy/boy_1_v.inc"
};

Gfx head_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Rarm2_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Rarm1_boy_model[] ATTRIBUTE_ALIGN(8) = {
gsSPMatrix(&anime_6_mdl[7], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx Larm2_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Larm1_boy_model[] ATTRIBUTE_ALIGN(8) = {
gsSPMatrix(&anime_6_mdl[7], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx Rfoot3_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Rffot2_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Rfoot1_boy_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_5_txt),
...
Gfx Lfoot3_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Lfoot2_boy_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx Lfoot1_boy_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_5_txt),
...
Gfx base_boy_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_5_txt),
