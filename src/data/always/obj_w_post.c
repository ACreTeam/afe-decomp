...
#include "assets/forestd/obj_w_post/obj_w_post_pal.inc"
};

u8 obj_w_post_flag1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_flag1_tex_txt.inc"
};

u8 obj_w_post_flag2_TA_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_flag2_TA_tex_txt.inc"
};

u8 obj_w_post_flag3_TA_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_flag3_TA_tex_txt.inc"
};

u8 obj_w_post_front1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_front1_tex_txt.inc"
};

u8 obj_w_post_front2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_front2_tex_txt.inc"
};

u8 obj_w_post_side1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_side1_tex_txt.inc"
};

u8 obj_w_post_leg1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_leg1_tex_txt.inc"
};

u8 obj_w_post_inside1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_post/obj_w_post_inside1_tex_txt.inc"
};

Vtx obj_w_post_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_post/obj_w_post_v.inc"
};

Gfx obj_w_post_main_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_post_front_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_w_post_pal),
...
Gfx obj_w_post_flag_saki_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&obj_w_post_v[4], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx obj_w_post_flag_ne_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
cKF_Joint_R_c cKF_je_r_obj_w_post_tbl[] = {
	{ obj_w_post_main_model, 2, cKF_JOINT_FLAG_DISP_OPA, { 550, 0, 65086 } },
...
cKF_Skeleton_R_c cKF_bs_r_obj_w_post = 
	{ ARRAY_COUNT(cKF_je_r_obj_w_post_tbl), 4, cKF_je_r_obj_w_post_tbl }
;
