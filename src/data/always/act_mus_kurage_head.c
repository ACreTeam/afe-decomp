...
#include "assets/forestd/act_mus_kurage_head/act_f37_kurage_pal.inc"
};

u8 act_mus_kurage_head_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_kurage_head/act_mus_kurage_head_tex.inc"
};

u8 act_mus_kurage_foot_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_kurage_head/act_mus_kurage_foot_tex.inc"
};

Vtx act_mus_kurage_a1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_kurage_head/act_mus_kurage_a1_v.inc"
};

Gfx act_mus_kurage_sakana_foot_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_kurage_sakana_body_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, PRIMITIVE, 0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 180),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
