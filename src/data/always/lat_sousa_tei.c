...
static u8 lat_sousa_tei_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/lat_sousa_tei_tex.inc"
};

static u8 lat_sousa_2b1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/lat_sousa_2b1_tex.inc"
};

u8 cal_hyouji_yaji2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/cal_hyouji_yaji2_tex.inc"
};

static u8 std_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/std_tex.inc"
};

u8 cal_hyouji_st1_tex_rgb_ia8[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/cal_hyouji_st1_tex_rgb_ia8.inc"
};

u8 cal_hyouji_st5_tex_rgb_ia8[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/cal_hyouji_st5_tex_rgb_ia8.inc"
};

static u8 lat_tegami_b3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/lat_tegami_b3_tex.inc"
};

u8 cal_hyouji_2b1_tex_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_sousa_tei/cal_hyouji_2b1_tex_rgb_i4.inc"
};

Vtx cal_hyouji_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_sousa_tei/cal_hyouji_v.inc"
};

Gfx cal_hyouji_b2_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx cal_hyouji_3DT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx cal_hyouji_shitaT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx cal_hyouji_amojiT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
...
Gfx cal_hyouji_stT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx cal_hyoji_yaji1T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx cal_hyoji_yajiA_gfx[] ATTRIBUTE_ALIGN(8) = {
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cal_hyoji_yajiB_gfx[] ATTRIBUTE_ALIGN(8) = {
