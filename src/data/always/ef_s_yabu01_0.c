...
#include "assets/forestd/ef_s_yabu01_0/ef_s_yabu01_0.inc"
};

Vtx ef_s_yabu01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_yabu01_0/ef_s_yabu01_00_v.inc"
};

Gfx ef_s_yabu01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
...
#include "assets/forestd/ef_s_yabu01_0/ef_s_tree01_0.inc"
};

Vtx ef_s_tree01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_yabu01_0/ef_s_tree01_00_v.inc"
};

Gfx ef_s_tree01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
...
#include "assets/forestd/ef_s_yabu01_0/grd_bush_pal.inc"
};

u8 ef_w_yabu01_0[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_s_yabu01_0/ef_w_yabu01_0.inc"
};

Vtx ef_w_yabu01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_yabu01_0/ef_w_yabu01_00_v.inc"
};

Gfx ef_w_yabu01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
#include "assets/forestd/ef_s_yabu01_0/ef_f_tree01_0.inc"
};

Vtx ef_f_tree01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_yabu01_0/ef_f_tree01_00_v.inc"
};

Gfx ef_f_tree01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_1_txt),
...
#include "assets/forestd/ef_s_yabu01_0/ef_s_cedar_tex.inc"
};

Vtx ef_s_cedar_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_yabu01_0/ef_s_cedar_v.inc"
};

Gfx ef_s_cedar_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
...
#include "assets/forestd/ef_s_yabu01_0/ef_s_palm_tex.inc"
};

Vtx ef_s_palm_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_yabu01_0/ef_s_palm_v.inc"
};

Gfx ef_s_palm_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_1_txt),
