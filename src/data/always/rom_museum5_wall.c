...
#include "assets/forestd/rom_museum5_wall/rom_museum5_wall_pal.inc"
};

static u8 rom_museum5_wallA_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_museum5_wall/rom_museum5_wallA_tex.inc"
};

Vtx rom_museum5_wall_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_museum5_wall/rom_museum5_wall_v.inc"
};

Gfx rom_museum5_wall_model[] ATTRIBUTE_ALIGN(8) = {
