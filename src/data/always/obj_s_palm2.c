...
#include "assets/forestd/obj_s_palm2/obj_s_palm_young_tex.inc"
};

Vtx obj_s_palm2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_palm2/obj_s_palm2_v.inc"
};

Gfx obj_s_palm2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_palm2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
