...
#include "assets/forestd/crw_zinnia1/crw_zinnia1_pal.inc"
};

u8 crw_zinnia1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_zinnia1/crw_zinnia1_tex_txt.inc"
};

u8 crw_zinnia2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_zinnia1/crw_zinnia2_tex_txt.inc"
};

Vtx crw_zinnia1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_zinnia1/crw_zinnia1_v.inc"
};

Gfx crw_zinnia1_body_model[] ATTRIBUTE_ALIGN(8) = {
