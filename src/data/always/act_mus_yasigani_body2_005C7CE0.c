...
#include "assets/forestd/act_mus_yasigani_body2_005C7CE0/int_ike_yasigani_pal.inc"
};

static u8 act_mus_yasigani_body2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_yasigani_body2_005C7CE0/act_mus_yasigani_body2.inc"
};

static u8 act_mus_yasigani_body1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_yasigani_body2_005C7CE0/act_mus_yasigani_body1.inc"
};

static Vtx act_m_yasigani_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_yasigani_body2_005C7CE0/act_m_yasigani_v.inc"
};

Gfx act_m_mu_yasigani1T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
gsSPNTrianglesInit_5b(13, 0, 1, 2, 0, 3, 1, 4, 3, 3),
gsSPNTriangles_5b(4, 3, 5, 6, 7, 8, 7, 3, 8, 9, 10, 11),
gsSPNTriangles_5b(12, 13, 11, 14, 15, 16, 14, 16, 17, 24, 25, 13),
gsSPNTriangles_5b(24, 13, 26, 25, 11, 13, 0, 0, 0, 0, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
gsSPNTrianglesInit_5b(4, 18, 19, 20, 18, 20, 21, 18, 21, 22),
...
gsSPNTriangles_5b(15, 17, 16, 17, 18, 16, 18, 14, 16, 19, 20, 21),
...
gsSPNTriangles_5b(13, 15, 14, 16, 17, 18, 16, 18, 19, 20, 17, 21),
...
Gfx act_m_mu_yasigani2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_yasigani_pal),
