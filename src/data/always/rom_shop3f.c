...
Vtx rom_shop3f_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop3f/rom_shop3f_v.inc"
};

Gfx rom_shop3f_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx rom_shop3f_model[] ATTRIBUTE_ALIGN(8) = {
