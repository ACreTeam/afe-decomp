...
Vtx lat_letter39_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter39/lat_letter39_v.inc"
};

Gfx lat_letter39_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter39_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
