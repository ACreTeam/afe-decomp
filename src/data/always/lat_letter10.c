...
Vtx lat_letter10_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter10/lat_letter10_v.inc"
};

Gfx lat_letter10_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter10_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
