...
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_a_pal.inc"
};

u16 obj_shop_paint_b_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_b_pal.inc"
};

u16 obj_shop_paint_c_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_c_pal.inc"
};

u16 obj_shop_paint_d_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_d_pal.inc"
};

u16 obj_shop_paint_e_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_e_pal.inc"
};

u16 obj_shop_paint_f_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_f_pal.inc"
};

u16 obj_shop_paint_g_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_g_pal.inc"
};

u16 obj_shop_paint_h_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_h_pal.inc"
};

u16 obj_shop_paint_i_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_i_pal.inc"
};

u16 obj_shop_paint_j_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_j_pal.inc"
};

u16 obj_shop_paint_k_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_k_pal.inc"
};

u16 obj_shop_paint_l_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_l_pal.inc"
};

u8 obj_shop_paint_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_tex.inc"
};

Vtx obj_shop_paint_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_paint_a/obj_shop_paint_v.inc"
};

Gfx obj_shop_paintT_mat_model[] ATTRIBUTE_ALIGN(8) = {
