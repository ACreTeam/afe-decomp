...
static Vtx act_m_kirigirisu_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_kirigirisu1/act_m_kirigirisu_v.inc"
};

static u16 act_m_kirigirisu_pal[] = {
#include "assets/forestd/act_m_mu_kirigirisu1/act_m_kirigirisu_pal.inc"
};

static u8 act_m_kirigirisu[] = {
#include "assets/forestd/act_m_mu_kirigirisu1/act_m_kirigirisu.inc"
};

Gfx act_m_mu_kirigirisu1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_kirigirisu2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
