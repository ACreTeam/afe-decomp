...
extern Gfx ef_w_palm_trunk_modeset[];
extern u8 obj_w_palm_cutL_tex_txt[];

Vtx ef_w_palm4_cutL_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_w_palm4_cutL_leaf/ef_w_palm4_cutL_v.inc"
};

Gfx ef_w_palm4_cutL_leaf_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_w_palm4_cutL_trunk_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_w_palm4_cutL = 
	{ ARRAY_COUNT(cKF_je_r_ef_w_palm4_cutL_tbl), 2, cKF_je_r_ef_w_palm4_cutL_tbl }
;
