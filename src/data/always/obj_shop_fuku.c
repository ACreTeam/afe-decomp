...
#include "assets/forestd/obj_shop_fuku/obj_shop_fuku_pal.inc"
};

u8 obj_shop_fuku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_fuku/obj_shop_fuku_tex.inc"
};

Vtx obj_shop_fuku_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_fuku/obj_shop_fuku_v.inc"
};

Gfx obj_fukuT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_fukuT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
