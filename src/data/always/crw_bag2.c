...
#include "assets/forestd/crw_bag2/crw_bag2_pal.inc"
};

u8 crw_bag21_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_bag2/crw_bag21_tex_txt.inc"
};

Vtx crw_bag2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_bag2/crw_bag2_v.inc"
};

Gfx crw_bag2_body_model[] ATTRIBUTE_ALIGN(8) = {
