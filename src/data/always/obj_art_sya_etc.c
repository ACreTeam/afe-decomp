...
#include "assets/forestd/obj_art_sya_etc/obj_art_sya_etc_pal.inc"
};

u16 obj_art_sya_art_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_sya_etc/obj_art_sya_art_pal.inc"
};

u8 obj_art_sya_gaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_sya_etc/obj_art_sya_gaku_tex.inc"
};

u8 obj_art_sya_art_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_sya_etc/obj_art_sya_art_tex.inc"
};

u8 obj_art_sya_name_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_sya_etc/obj_art_sya_name_tex.inc"
};

Vtx obj_art03_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_art_sya_etc/obj_art03_v.inc"
};

Gfx obj_art03_model[] ATTRIBUTE_ALIGN(8) = {
