...
static Vtx act_m_koorogi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_koorogi1/act_m_koorogi_v.inc"
};

static u16 act_m_koorogi_pal[] = {
#include "assets/forestd/act_m_mu_koorogi1/act_m_koorogi_pal.inc"
};

static u8 act_m_koorogi[] = {
#include "assets/forestd/act_m_mu_koorogi1/act_m_koorogi.inc"
};

Gfx act_m_mu_koorogi1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_koorogi2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
