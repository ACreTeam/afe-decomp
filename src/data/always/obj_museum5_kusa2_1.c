...
#include "assets/forestd/obj_museum5_kusa2_1/obj_museum5_kusa2_pal.inc"
};

u8 obj_museum5_kusa2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_museum5_kusa2_1/obj_museum5_kusa2_tex_txt.inc"
};

Vtx obj_museum5_kusa2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_museum5_kusa2_1/obj_museum5_kusa2_v.inc"
};

Gfx obj_museum5_kusa2_1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_museum5_kusa2_2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
Gfx obj_museum5_kusa2_3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsSPMatrix(&anime_6_mdl[1], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
...
Gfx obj_museum5_kusa2_4_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsSPMatrix(&anime_6_mdl[2], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
...
cKF_Skeleton_R_c cKF_bs_r_obj_museum5_kusa2 = 
	{ ARRAY_COUNT(cKF_je_r_obj_museum5_kusa2_tbl), 4, cKF_je_r_obj_museum5_kusa2_tbl }
;
