...
#include "assets/forestd/obj_museum5_hasu1/obj_museum5_hasu_pal.inc"
};

u8 obj_museum5_hasu1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_museum5_hasu1/obj_museum5_hasu1_tex_txt.inc"
};

Vtx obj_museum5_hasu_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_museum5_hasu1/obj_museum5_hasu_v.inc"
};

Gfx obj_museum5_hasu1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_museum5_hasu3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_museum5_hasu_pal),
...
Gfx obj_museum5_hasu2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_museum5_hasu_pal),
...
cKF_Skeleton_R_c cKF_bs_r_obj_museum5_hasu = 
	{ ARRAY_COUNT(cKF_je_r_obj_museum5_hasu_tbl), 3, cKF_je_r_obj_museum5_hasu_tbl }
;
