...
#include "assets/forestd/ef_sphere_light/ef_sphere_light_tex_4i4_rgb_i4.inc"
};

Vtx ef_sphere_light_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_sphere_light/ef_sphere_light_v.inc"
};

Gfx ef_sphere_light_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(4000, 4000, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, COMBINED, 0, PRIM_LOD_FRAC, 0),
