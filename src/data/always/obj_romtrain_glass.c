...
#include "assets/forestd/obj_romtrain_glass/obj_romtrain_door_pal.inc"
};

u8 obj_romtrain_door_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_romtrain_glass/obj_romtrain_door_tex_txt.inc"
};

u8 obj_romtrain_glass_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_romtrain_glass/obj_romtrain_glass_tex_txt.inc"
};

Vtx obj_romtrain_door_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_romtrain_glass/obj_romtrain_door_v.inc"
};

Gfx obj_romtrain_base_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_romtrain_glass_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_romtrain_door_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_romtrain_door_pal),
...
cKF_Skeleton_R_c cKF_bs_r_obj_romtrain_door = 
	{ ARRAY_COUNT(cKF_je_r_obj_romtrain_door_tbl), 3, cKF_je_r_obj_romtrain_door_tbl }
;
