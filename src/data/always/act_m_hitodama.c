...
u8 act_m_hitodama_h2_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_hitodama/act_m_hitodama_h2_txt.inc"
};

u8 act_m_hitodama_h1_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_hitodama/act_m_hitodama_h1_txt.inc"
};

Vtx act_m_hitodama_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_hitodama/act_m_hitodama_v.inc"
};

Gfx act_m_hitodama_b_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_hitodama_a_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
