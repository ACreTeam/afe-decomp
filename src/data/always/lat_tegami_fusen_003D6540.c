...
#include "assets/forestd/lat_tegami_fusen_003D6540/lat_letter01_pal.inc"
};

static u8 lat_letter01_04_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_tegami_fusen_003D6540/lat_letter01_04_tex.inc"
};

static u8 lat_tegami_fusen_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/lat_tegami_fusen_003D6540/lat_tegami_fusen_tex.inc"
};

Vtx dia_win3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_tegami_fusen_003D6540/dia_win3_v.inc"
};

Gfx dia_win3_wT_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx dia_win3_fusenT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
