...
#include "assets/forestd/ef_daruma01/ef_daruma01_pal.inc"
};

u8 ef_daruma01_00_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_daruma01/ef_daruma01_00_tex.inc"
};

Vtx ef_daruma01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_daruma01/ef_daruma01_00_v.inc"
};

Gfx ef_daruma01_00_model[] ATTRIBUTE_ALIGN(8) = {
...
Vtx ef_daruma01_01_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_daruma01/ef_daruma01_01_v.inc"
};

Gfx ef_daruma01_01_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, ef_daruma01_pal),
...
Vtx ef_daruma01_02_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_daruma01/ef_daruma01_02_v.inc"
};

Gfx ef_daruma01_02_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, ef_daruma01_pal),
