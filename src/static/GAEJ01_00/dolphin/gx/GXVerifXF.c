...
#include "../src/static/GAEJ01_00/dolphin/gx/__gx.h"
...
static void CountTextureTypes(void)
{
    ...
    for (i = 0; i < __gxVerif->xfRegs[0x3F]; i++) {
        ...
        if (texgen_type == 0) {
            ...
            __GX_WARN3F_CHECK(GXWARN_INVALID_TG_TYPE, texgen_type, i);
        }
    }
...
{
    if (!__gxVerif->xfRegsDirty[index - 0x1000]) {
        __GX_WARN3F_CHECK(GXWARN_XF_CTRL_UNINIT, index, name);
    }
}
...
{
    if (__gxVerif->xfRegsDirty[index - 0x1000]) {
        __GX_WARN3F_CHECK(GXWARN_XF_CTRL_INIT, index, name);
    }
}

static void CheckCTGColors(void)
{
    if ((BYTE3(__gxVerif->xfRegs[9]) & 3) > 2u) {
        __GX_WARN3F_CHECK(GXWARN_INV_NUM_COLORS, (u8)(BYTE3(__gxVerif->xfRegs[9]) & 3));
    }
}
...
static void CheckVertexPacket(void)
{
    ...
    if (!__GXVertexPacketHas(GX_VA_POS)) {
        __GX_WARN3_CHECK(GXWARN_VTX_NO_GEOM);
    }
    if ((BYTE3(__gxVerif->xfRegs[8]) & 3) == 0) {
        if (__GXVertexPacketHas(GX_VA_CLR0) || __GXVertexPacketHas(GX_VA_CLR1)) {
            __GX_WARN3_CHECK(GXWARN_CLR_XF0_CP1);
        }
    } else if ((u32)(BYTE3(__gxVerif->xfRegs[8]) & 3) == 1) {
        if (!__GXVertexPacketHas(GX_VA_CLR0)) {
            __GX_WARN3_CHECK(GXWARN_CLR_XF1_CP0);
        }
        if (__GXVertexPacketHas(GX_VA_CLR1)) {
            __GX_WARN3_CHECK(GXWARN_CLR_XF1_CP2);
        }
    } else if ((u32)(BYTE3(__gxVerif->xfRegs[8]) & 3) == 2) {
        if (!__GXVertexPacketHas(GX_VA_CLR0)) {
            __GX_WARN3_CHECK(GXWARN_CLR_XF2_CPN1);
        }
        if (!__GXVertexPacketHas(GX_VA_CLR1)) {
            __GX_WARN3_CHECK(GXWARN_CLR_XF2_CPN2);
        }
    } else {
        __GX_WARN3F_CHECK(GXWARN_INV_IVS_CLR, (u8)(BYTE3(__gxVerif->xfRegs[8]) & 3));
    }
    if (((BYTE3(__gxVerif->xfRegs[8]) >> 2) & 3) == 0) {
        if (__GXVertexPacketHas(GX_VA_NRM)) {
            __GX_WARN3_CHECK(GXWARN_NRM_XF0_CP1);
        }
        if (__GXVertexPacketHas(GX_VA_NBT)) {
            __GX_WARN3_CHECK(GXWARN_NRM_XF0_CP3);
        }
    } else if ((u32)((BYTE3(__gxVerif->xfRegs[8]) >> 2) & 3) == 1) {
        if (!__GXVertexPacketHas(GX_VA_NRM)) {
            __GX_WARN3_CHECK(GXWARN_NRM_XF1_CP0);
        }
        if (__GXVertexPacketHas(GX_VA_NBT)) {
            __GX_WARN3_CHECK(GXWARN_NRM_XF1_CP3);
        }
    } else if ((u32)((BYTE3(__gxVerif->xfRegs[8]) >> 2) & 3) == 2) {
        if (__GXVertexPacketHas(GX_VA_NRM)) {
            __GX_WARN3_CHECK(GXWARN_NRM_XF3_CP1);
        }
        if (!__GXVertexPacketHas(GX_VA_NBT)) {
            __GX_WARN3_CHECK(GXWARN_NRM_XF3_CP0);
        }
    } else {
        __GX_WARN3F_CHECK(GXWARN_INV_IVS_NRM, (u8)((BYTE3(__gxVerif->xfRegs[8]) >> 2) & 3));
    }
    numHostTextures = 0;
    for (i = 0; i <= 7; i++) {
    ...
    if (numHostTextures != (u32)((BYTE3(__gxVerif->xfRegs[8]) >> 4) & 0xF)) {
        __GX_WARN3F_CHECK(GXWARN_TEX_XFN_CPM, (u8)((BYTE3(__gxVerif->xfRegs[8]) >> 4) & 0xF), numHostTextures);
    }
}
...
static void CheckSourceRows(void)
{
    ...
    for (i = 0; i < numRegularTextures; i++) {
        ...
        case 0:
            if (!__GXVertexPacketHas(GX_VA_POS)) {
                __GX_WARN3F_CHECK(GXWARN_TEX_SRC_NPOS, i);
            }
            break;
        case 1:
            if (!__GXVertexPacketHas(GX_VA_NRM) && !__GXVertexPacketHas(GX_VA_NBT)) {
                __GX_WARN3F_CHECK(GXWARN_TEX_SRC_NNRM, i);
            }
            break;
        case 2:
            if (!__GXVertexPacketHas(GX_VA_CLR0)) {
                __GX_WARN3F_CHECK(GXWARN_TEX_SRC_NCLR0, i);
            }
            if (!__GXVertexPacketHas(GX_VA_CLR1)) {
                __GX_WARN3F_CHECK(GXWARN_TEX_SRC_NCLR1, i);
            }
            break;
        case 3:
        case 4:
            if (!__GXVertexPacketHas(GX_VA_NBT)) {
                __GX_WARN3F_CHECK(GXWARN_TEX_SRC_NNBT, i);
            }
            break;
        case 5:
        case 6:
        ...
        case 12:
            if (!__GXVertexPacketHas(TextureEnums[((HIWORD(__gxVerif->xfRegs[i + 64]) >> 7) & 0x1F) - 5])) {
                __GX_WARN3F_CHECK(GXWARN_TEX_SRC_NTEX, i, ((HIWORD(__gxVerif->xfRegs[i + 64]) >> 7) & 0x1F) - 5);
            }
            break;
        default:
            __GX_WARN3F_CHECK(GXWARN_INV_TEX_SRC, i, (u8)((HIWORD(__gxVerif->xfRegs[i + 64]) >> 7) & 0x1F));
            break;
        }
    }
}
    ...
    while (done == 0) {
        if (count == __gxVerif->xfRegs[0x3F]) {
            ...
            if (!((BYTE3(__gxVerif->xfRegs[count + 64]) >> 4) & 7)) {
                __GX_WARN3_CHECK(GXWARN_INV_TG_ORDER);
            }
            done = 1;
        } else {
            count += 1;
...
static void CheckRAM(u8 Normal, u32 StartingAddress, u32 Count, GXWarnID WarnID, char *Str)
{
    ...
    for (i = StartingAddress; i < StartingAddress + Count; i++) {
        ...
        if (dirtyBit == 0 && printedPreamble == FALSE) {
...
static void CheckBumpmapTextures(void)
{
    ...
    if (!__GXVertexPacketHas(GX_VA_PNMTXIDX)) {
        if ((u32)(BYTE3(__gxVerif->xfRegs[24]) & 0x3F) > 30) {
            __GX_WARN3F_CHECK(0x50, (u8)(BYTE3(__gxVerif->xfRegs[24]) & 0x3F));
        }
    ...
    for (i = 0; i < numBumpmapTextures; i++) {
        ...
        if ((BYTE3(__gxVerif->xfRegs[BumpMapSource + 64]) >> 4) & 7) {
            __GX_WARN3F_CHECK(0x51, i + numRegularTextures, BumpMapSource);
        }
        ...
        if (!__gxVerif->xfLightDirty[lightRAMOffset - 0x600 + 0]) {
            __GX_WARN3F_CHECK(0x52, i + numRegularTextures, BumpMapLight, "X");
        }
        if (!__gxVerif->xfLightDirty[lightRAMOffset - 0x600 + 1]) {
            __GX_WARN3F_CHECK(0x52, i + numRegularTextures, BumpMapLight, "Y");
        }
        if (!__gxVerif->xfLightDirty[lightRAMOffset - 0x600 + 2]) {
            __GX_WARN3F_CHECK(0x52, i + numRegularTextures, BumpMapLight, "Z");
        }
        if (!__GXVertexPacketHas(GX_VA_NBT)) {
            __GX_WARN3F_CHECK(0x53, i);
        }
    }
    ...
    for (i = 0; i < numRegularTextures; i++) {
        ...
        case 12:
            if ((BYTE3(__gxVerif->xfRegs[i + 64]) >> 2) & 1) {
                __GX_WARN3F_CHECK(0x55, i, (u8)((HIWORD(__gxVerif->xfRegs[i + 64]) >> 7) & 0x1F));
            }
        }
    }
}
...
static void CheckLight(u32 lightSource)
{
    ...
    for (i = 0; i < 13; i++) {
        if (!__gxVerif->xfLightDirty[lightRAMOffset + i - 0x600]) {
            if (!printedPreamble) {
                __GX_WARN3F_CHECK(0x6C, lightSource);
                printedPreamble = 1;
            }
        }
    }
...
static void CheckColor0(void)
{
    ...
    u32 i;
    u8 lightUsed;
    // regswaps here asm:0x1c64
    if ((BYTE3(__gxVerif->xfRegs[9]) & 3) || numColorTextures != 0) {
        if (!__gxVerif->xfRegsDirty[14]) {
            __GX_WARN3F_CHECK(0x56, 0x100E, "Color 0 control register");
        }
        if (!__gxVerif->xfRegsDirty[16]) {
            __GX_WARN3F_CHECK(0x56, 0x1010, "Alpha 0 control register");
        }
        if (!(BYTE3(__gxVerif->xfRegs[14]) & 1) && !__gxVerif->xfRegsDirty[12]) {
            __GX_WARN3F_CHECK(0x57, 0, 0, 0x100C);
        }
        if (!((BYTE3(__gxVerif->xfRegs[14]) >> 6) & 1) && !__gxVerif->xfRegsDirty[10]) {
            __GX_WARN3F_CHECK(0x58, 0, 0, 0x100A);
        }
        if ((u32)((BYTE3(__gxVerif->xfRegs[14]) >> 1) & 1) == 1 || (u32)((BYTE3(__gxVerif->xfRegs[16]) >> 1) & 1) == 1) {
            ...
            if (haveLight != 0) {
                if (!((BYTE2(__gxVerif->xfRegs[14]) >> 2) & 1) && ((HIWORD(__gxVerif->xfRegs[14]) >> 7) & 3)) {
                    __GX_WARN3F_CHECK(0x59, "COLOR0", "COLOR0");
                }
                if (!((BYTE2(__gxVerif->xfRegs[16]) >> 2) & 1) && ((HIWORD(__gxVerif->xfRegs[16]) >> 7) & 3)) {
                    __GX_WARN3F_CHECK(0x59, "ALPHA0", "ALPHA0");
                }
                if (((HIWORD(__gxVerif->xfRegs[14]) >> 7) & 3)
                 ...
                 || ((u8)((BYTE2(__gxVerif->xfRegs[16]) >> 1) & 1) && ((u32)((BYTE2(__gxVerif->xfRegs[16]) >> 2) & 1) == 1))) {
                    if ((__GXVertexPacketHas(GX_VA_NRM) == 0) && (__GXVertexPacketHas(GX_VA_NBT) == 0)) {
                        __GX_WARN3F_CHECK(0x5A, 0);
                    }
                    if (__GXVertexPacketHas(GX_VA_PNMTXIDX) == 0) {
                        if ((BYTE3(__gxVerif->xfRegs[24]) & 0x3F) > 30u) {
                            __GX_WARN3F_CHECK(0x5B, 0, (BYTE3(__gxVerif->xfRegs[24]) & 0x3F));
                        }
...
static void CheckColor1(void)
{
    ...
    if ((u32)(BYTE3(__gxVerif->xfRegs[9]) & 3) == 2 || usingColor1) {
        if (!__gxVerif->xfRegsDirty[15]) {
            __GX_WARN3F_CHECK(GXWARN_CLR_ADDR_UNINIT, 0x100F, "Color 1 control register");
        }
        if (!__gxVerif->xfRegsDirty[17]) {
            __GX_WARN3F_CHECK(GXWARN_CLR_ADDR_UNINIT, 0x1011, "Alpha 1 control register");
        }
        if (!(BYTE3(__gxVerif->xfRegs[15]) & 1) && !__gxVerif->xfRegsDirty[13]) {
            __GX_WARN3F_CHECK(GXWARN_CLR_MAT_UNINIT, 1, 1, 0x100D);
        }
        if (!((BYTE3(__gxVerif->xfRegs[15]) >> 6) & 1) && !__gxVerif->xfRegsDirty[11]) {
            __GX_WARN3F_CHECK(GXWARN_CLR_AMB_UNINIT, 1, 1, 0x100B);
        }
        if ((u32)((BYTE3(__gxVerif->xfRegs[15]) >> 1) & 1) == 1 || (u32)((BYTE3(__gxVerif->xfRegs[17]) >> 1) & 1) == 1) {
            ...
            if (haveLight != 0) {
                if (!((BYTE2(__gxVerif->xfRegs[15]) >> 2) & 1) && ((HIWORD(__gxVerif->xfRegs[15]) >> 7) & 3)) {
                    __GX_WARN3F_CHECK(0x59, "COLOR1", "COLOR1");
                }
                if (!((BYTE2(__gxVerif->xfRegs[17]) >> 2) & 1) && ((HIWORD(__gxVerif->xfRegs[17]) >> 7) & 3)) {
                    __GX_WARN3F_CHECK(0x59, "ALPHA1", "ALPHA1");
                }
                if (((HIWORD(__gxVerif->xfRegs[15]) >> 7) & 3)
                 ...
                 || ((u8)((BYTE2(__gxVerif->xfRegs[17]) >> 1) & 1) && ((u32)((BYTE2(__gxVerif->xfRegs[17]) >> 2) & 1) == 1))) {
                    if ((__GXVertexPacketHas(GX_VA_NRM) == 0) && (__GXVertexPacketHas(GX_VA_NBT) == 0)) {
                        __GX_WARN3F_CHECK(0x5A, 1);
                    }
                    if (__GXVertexPacketHas(GX_VA_PNMTXIDX) == 0) {
                        if ((u32)(BYTE3(__gxVerif->xfRegs[24]) & 0x3F) > 30) {
                            __GX_WARN3F_CHECK(0x5B, 1, (u8)(BYTE3(__gxVerif->xfRegs[24]) & 0x3F));
                        }
...
static void CheckFloatingPointValue(u8 dirtyBit, u32 value, char *label)
{
    ...
    if (exponent == 0xFF) {
        if (__gxVerif->verifyLevel >= 2) {
            if (mantissa == 0) {
                if (sign != 0) {
                    __GX_WARN3F_CHECK(0x5C, label, "-", *(u32 *)&valuef);
                } else {
                    __GX_WARN3F_CHECK(0x5C, label, "+", *(u32 *)&valuef);
                }
            } else {
                __GX_WARN3F_CHECK(0x5D, label, *(u32 *)&valuef);
            }
        }
    } else if (__gxVerif->verifyLevel >= 3) {
        if (exponent < 0x6BU) {
            __GX_WARN3F_CHECK(0x5E, label, valuef, *(u32 *)&valuef);
        } else if (exponent > 0x96U) {
            __GX_WARN3F_CHECK(0x5F, label, valuef, *(u32 *)&valuef);
        }
    }
}
...
static void CheckMatrixIndices(void)
{
    ...
    if ((!__GXVertexPacketHas(GX_VA_TEX4MTXIDX)
     ...
     && __gxVerif->verifyLevel >= __gxvWarnLev[0x60]) {
        __GX_WARN3F(0x60, numRegularTextures, 0x1019U);
    }
}
...
static void CheckErrors(void)
{
    ...
    if (__gxVerif->verifyLevel >= 1) {
        CheckCTGColors();
        if (__gxVerif->xfRegs[63] > 8) {
            __GX_WARN3F_CHECK(0x64, __gxVerif->xfRegs[63], 8);
        }
        if (numRegularTextures > 8) {
            __GX_WARN3F_CHECK(0x65, numRegularTextures, 8);
        }
        if (numBumpmapTextures > 3) {
            __GX_WARN3F_CHECK(0x66, numBumpmapTextures, 3);
        }
        if (numColorTextures > 2) {
            __GX_WARN3F_CHECK(0x67, numColorTextures, 2);
        }
        if (numColor0Textures > 1) {
            __GX_WARN3F_CHECK(0x69, 0);
        }
        if (numColor1Textures > 1) {
            __GX_WARN3F_CHECK(0x69, 1);
        }
        CheckVertexPacket();
