...
#include "../src/actor/npc/ac_npc_rcn_guide_move.c_inc"
#include "../src/actor/npc/ac_npc_rcn_guide_talk.c_inc"
#include "../src/actor/npc/ac_npc_rcn_guide_schedule.c_inc"
