...
#include "assets/forestd/rom_myhome4_2_wall/rom_myhome_pal.inc"
};

static u8 rom_myhome_window_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome4_2_wall/rom_myhome_window_tex.inc"
};

static u8 rom_myhome_enter2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome4_2_wall/rom_myhome_enter2_tex.inc"
};

Vtx rom_myhome4_2_wall_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_myhome4_2_wall/rom_myhome4_2_wall_v.inc"
};

Gfx rom_myhome4_2_wall_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_myhome4_2_wall_new_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, rom_myhome_pal),
...
Gfx rom_myhome4_2_wall_new2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, rom_myhome_pal),
