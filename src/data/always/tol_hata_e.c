...
#include "assets/forestd/tol_hata_e/tol_hata_e_pal.inc"
};

u8 tol_hata_e_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_hata_e/tol_hata_e_tex.inc"
};

u8 tol_hata_hata_tex_inta_ia8[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_hata_e/tol_hata_hata_tex_inta_ia8.inc"
};

Vtx tol_hata_01_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_hata_e/tol_hata_01_v.inc"
};

Gfx tol_hata_e_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx tol_hata_hataT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
