...
static Vtx act_m_abura_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_abura1_1/act_m_abura_v.inc"
};

static u16 act_m_abura_pal[] = {
#include "assets/forestd/act_m_mu_abura1_1/act_m_abura_pal.inc"
};

static u8 act_m_abura[] = {
#include "assets/forestd/act_m_mu_abura1_1/act_m_abura.inc"
};

Gfx act_m_mu_abura1_1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_abura1_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
