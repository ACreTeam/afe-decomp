...
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_nuno_tex_rgb_ci4_pal.inc"
};

u16 cad_win_ws4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws4_tex_rgb_ci4_pal.inc"
};

u16 cad_win_ws1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws1_tex_rgb_ci4_pal.inc"
};

u16 cad_win_ws2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws2_tex_rgb_ci4_pal.inc"
};

u16 cad_win_ws3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws3_tex_rgb_ci4_pal.inc"
};

u8 cad_win_w1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_w1_tex.inc"
};

u8 cad_win_w2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_w2_tex.inc"
};

u8 cad_win_w3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_w3_tex.inc"
};

u8 cad_win_w4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_w4_tex.inc"
};

u8 inv_carde_waku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/inv_carde_waku_tex.inc"
};

u8 cad_win_nuno_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_nuno_tex_rgb_ci4.inc"
};

u8 cad_win_ws4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws4_tex_rgb_ci4.inc"
};

u8 cad_win_ws1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws1_tex_rgb_ci4.inc"
};

u8 cad_win_ws2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws2_tex_rgb_ci4.inc"
};

u8 cad_win_ws3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_ws3_tex_rgb_ci4.inc"
};

Vtx cad_win_pp_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/cad_win_nuno_tex_rgb_ci4/cad_win_pp_v.inc"
};

Gfx cad_win_w1T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPVertex(&cad_win_pp_v[12], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w2T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[16], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w3T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, cad_win_ws1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, cad_win_ws1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[20], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w4T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[24], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, cad_win_ws1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, cad_win_ws1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[28], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w6T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, cad_win_ws2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, cad_win_ws2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[32], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, cad_win_ws1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, cad_win_ws1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[36], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, cad_win_ws3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, cad_win_ws3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[40], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_w9_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(cad_win_pp_v, 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 0, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_mb_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_1_txt),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, anime_2_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[4], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_f_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[8], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx cad_win_ueT_model[] ATTRIBUTE_ALIGN(8) = {
...
gsSPVertex(&cad_win_pp_v[44], 20, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 0, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&cad_win_pp_v[64], 16, 0),
...
Gfx cad_win_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx cad_win_model[] ATTRIBUTE_ALIGN(8) = {
