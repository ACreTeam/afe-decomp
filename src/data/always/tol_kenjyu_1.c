...
#include "assets/forestd/tol_kenjyu_1/tol_kenjyu_1_pal.inc"
};

u8 tol_kenjyu_1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kenjyu_1/tol_kenjyu_1_tex.inc"
};

Vtx tol_kenjyu_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kenjyu_1/tol_kenjyu_1_v.inc"
};

Gfx tol_kenjyu_1T_model[] ATTRIBUTE_ALIGN(8) = {
