...
u16 act_ball_b_pal[] = {
#include "assets/forestd/act_ball_b/act_ball_b_pal.inc"
};

u8 act_ball_b_1_tex[] = {
#include "assets/forestd/act_ball_b/act_ball_b_1_tex.inc"
};

Vtx act_ball_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_ball_b/act_ball_b_v.inc"
};

Gfx act_ball_b_model[] ATTRIBUTE_ALIGN(8) = {
