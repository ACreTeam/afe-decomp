...
static Vtx act_m_mino_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_mino1_1/act_m_mino_v.inc"
};

static u16 act_m_mino_pal[] = {
#include "assets/forestd/act_m_mu_mino1_1/act_m_mino_pal.inc"
};

static u8 act_m_mino_tex[] = {
#include "assets/forestd/act_m_mu_mino1_1/act_m_mino_tex.inc"
};

Gfx act_m_mu_mino1_1T_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_MIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_MIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 255, 1024),
gsDPPipeSync(),
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 2, 0, G_TX_RENDERTILE, 15, G_TX_MIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_MIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
...
Gfx act_m_mu_mino1_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
...
Gfx act_m_mu_mino2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
