...
u16 obj_w_honeycomb_pal[] = {
#include "assets/forestd/obj_w_honeycomb/obj_w_honeycomb_pal.inc"
};

u8 obj_w_honeycomb_tex[] = {
#include "assets/forestd/obj_w_honeycomb/obj_w_honeycomb_tex.inc"
};

Vtx obj_w_honeycomb_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_honeycomb/obj_w_honeycomb_v.inc"
};

Gfx obj_w_honeycombT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx obj_w_honeycombT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
