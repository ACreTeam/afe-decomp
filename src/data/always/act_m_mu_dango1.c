...
static Vtx act_m_dango_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_dango1/act_m_dango_v.inc"
};

static u16 act_m_dango_pal[] = {
#include "assets/forestd/act_m_mu_dango1/act_m_dango_pal.inc"
};

static u8 act_m_dango_tex[] = {
#include "assets/forestd/act_m_mu_dango1/act_m_dango_tex.inc"
};

Gfx act_m_mu_dango1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_dango2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
