...
Vtx ef_w_tree3_cutR_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_w_tree3_cutR_leaf/ef_w_tree3_cutR_v.inc"
};

Gfx ef_w_tree3_cutR_leaf_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_w_tree3_cutR_trunk_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_w_tree3_cutR = 
	{ ARRAY_COUNT(cKF_je_r_ef_w_tree3_cutR_tbl), 2, cKF_je_r_ef_w_tree3_cutR_tbl }
;
