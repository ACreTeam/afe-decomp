...
EVW_ANIME_SCROLL ef_kaze01_evw_anime_2[] ATTRIBUTE_ALIGN(32) = {
	{ 0, 0, 16, 16 },
	{ 3, -2, 16, 16 }
};

EVW_ANIME_DATA ef_kaze01_evw_anime[] = {
	{ -1, EVW_ANIME_TYPE_SCROLL2, ef_kaze01_evw_anime_2 }
};

u8 ef_kaze01_0_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_kaze01/ef_kaze01_0_int_i4.inc"
};

u8 ef_kaze01_1_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_kaze01/ef_kaze01_1_int_i4.inc"
};

Vtx ef_kaze01_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_kaze01/ef_kaze01_v.inc"
};

Vtx ef_kaze01_v2[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_kaze01/ef_kaze01_v2.inc"
};

Gfx ef_kaze01_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_kaze01_modelT2[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, TEXEL1, 0, TEXEL0, 0, PRIMITIVE, ENVIRONMENT, COMBINED, ENVIRONMENT, COMBINED, 0, PRIMITIVE, 0),
gsDPSetEnvColor(0, 255, 255, 255),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_CLD_SURF2),
...
u8 ef_kaze01_2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_kaze01/ef_kaze01_2.inc"
};

Vtx ef_kaze01_happa_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_kaze01/ef_kaze01_happa_v.inc"
};

Gfx ef_kaze01_happa_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
