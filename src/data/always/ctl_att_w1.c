...
#include "assets/forestd/ctl_att_w1/ctl_att_w1_tex.inc"
};

u8 ctl_att_w2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_att_w1/ctl_att_w2_tex.inc"
};

u8 ctl_att_w3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_att_w1/ctl_att_w3_tex.inc"
};

u8 ctl_att_w4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_att_w1/ctl_att_w4_tex.inc"
};

u8 ctl_att_w5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_att_w1/ctl_att_w5_tex.inc"
};

u8 ctl_att_w6_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ctl_att_w1/ctl_att_w6_tex.inc"
};

Vtx dia_att_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ctl_att_w1/dia_att_v.inc"
};

Gfx dia_att_cursor_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx dia_att_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPLoadGeometryMode(G_SHADE | G_CULL_BACK | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
gsDPSetOtherMode(G_AD_NOTPATTERN | G_CD_MAGICSQ | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_2CYCLE | G_PM_NPRIMITIVE, G_AC_THRESHOLD | G_ZS_PIXEL | G_RM_PASS | G_RM_XLU_SURF2),
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
