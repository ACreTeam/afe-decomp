...
Vtx lat_letter43_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter43/lat_letter43_v.inc"
};

Gfx lat_letter43_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter43_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
