...
u8 cKF_ckcb_r_furniture_stop_tbl[] = {
0
};

s16 cKF_c_furniture_stop_tbl[] = {
0,
0,
0,
0,
...
cKF_Skeleton_R_c cKF_bs_r_furniture_stop = 
	{ ARRAY_COUNT(cKF_je_r_furniture_stop_tbl), 0, cKF_je_r_furniture_stop_tbl }
;
