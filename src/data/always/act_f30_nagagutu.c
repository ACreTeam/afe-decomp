...
#include "assets/forestd/act_f30_nagagutu/act_f30_nagagutu_pal.inc"
};

u8 act_f30_nagagutu_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f30_nagagutu/act_f30_nagagutu_tex.inc"
};

Vtx act_f30_nagagutu_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f30_nagagutu/act_f30_nagagutu_v.inc"
};

Gfx act_f30_nagagutuT_model[] ATTRIBUTE_ALIGN(8) = {
