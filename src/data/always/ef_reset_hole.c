...
#include "assets/forestd/ef_reset_hole/ef_reset_hole_pal.inc"
};

u8 ef_reset_hole_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_reset_hole/ef_reset_hole_tex.inc"
};

Vtx ef_reset_hole_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_reset_hole/ef_reset_hole_v.inc"
};

Gfx ef_reset_hole_modelT[] ATTRIBUTE_ALIGN(8) = {
