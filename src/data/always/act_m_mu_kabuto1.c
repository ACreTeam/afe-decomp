...
static Vtx act_m_kabuto_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_kabuto1/act_m_kabuto_v.inc"
};

static u16 act_m_kabuto_pal[] = {
#include "assets/forestd/act_m_mu_kabuto1/act_m_kabuto_pal.inc"
};

static u8 act_m_kabuto[] = {
#include "assets/forestd/act_m_mu_kabuto1/act_m_kabuto.inc"
};

Gfx act_m_mu_kabuto1T_model[] ATTRIBUTE_ALIGN(8) = {
