...
Vtx ef_f_tree5_shake_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_f_tree5_shake_00558568/ef_f_tree5_shake_v.inc"
};

Gfx ef_f_tree5_shake_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Joint_R_c cKF_je_r_ef_f_tree5_shake_tbl[] = {
	{ NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 7000, 0 } },
	{ ef_f_tree5_shake_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_ef_f_tree5_shake = 
	{ ARRAY_COUNT(cKF_je_r_ef_f_tree5_shake_tbl), 1, cKF_je_r_ef_f_tree5_shake_tbl }
;
