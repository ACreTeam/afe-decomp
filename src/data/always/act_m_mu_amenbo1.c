...
#include "assets/forestd/act_m_mu_amenbo1/act_m_amenbo_v.inc"
};

static u16 act_m_amenbo_pal[] = {
#include "assets/forestd/act_m_mu_amenbo1/act_m_amenbo_pal.inc"
};

static u8 act_m_amenbo_tex[] = {
#include "assets/forestd/act_m_mu_amenbo1/act_m_amenbo_tex.inc"
};

Gfx act_m_mu_amenbo1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_amenbo2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
