...
#include "assets/forestd/ef_hirameki01/ef_hirameki01_0.inc"
};

Vtx ef_hirameki01_den_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_hirameki01/ef_hirameki01_den_v.inc"
};

Gfx ef_hirameki01_den_modelT[] ATTRIBUTE_ALIGN(8) = {
...
#include "assets/forestd/ef_hirameki01/ef_hirameki01_1.inc"
};

Vtx ef_hirameki01_hikari_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_hirameki01/ef_hirameki01_hikari_v.inc"
};

Gfx ef_hirameki01_hikari_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
