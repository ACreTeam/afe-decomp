...
Vtx lat_letter13_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter13_win/lat_letter13_v.inc"
};

Gfx lat_letter13_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter13_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter13_model[] ATTRIBUTE_ALIGN(8) = {
