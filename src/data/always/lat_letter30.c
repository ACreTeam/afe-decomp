...
Vtx lat_letter30_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter30/lat_letter30_v.inc"
};

Gfx lat_letter30_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter30_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter30_wak_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter30_model[] ATTRIBUTE_ALIGN(8) = {
