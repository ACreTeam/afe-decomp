...
static Vtx act_m_matumushi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_matumushi1/act_m_matumushi_v.inc"
};

static u16 act_m_matumushi_pal[] = {
#include "assets/forestd/act_m_mu_matumushi1/act_m_matumushi_pal.inc"
};

static u8 act_m_matumushi[] = {
#include "assets/forestd/act_m_mu_matumushi1/act_m_matumushi.inc"
};

Gfx act_m_mu_matumushi1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_matumushi2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
