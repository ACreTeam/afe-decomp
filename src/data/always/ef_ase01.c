...
#include "assets/forestd/ef_ase01/ef_ase01_0.inc"
};

Vtx ef_ase01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_ase01/ef_ase01_00_v.inc"
};

Gfx ef_ase01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
