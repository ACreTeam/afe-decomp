...
Vtx obj_s_cstump5_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_cstump5/obj_s_cstump5_v.inc"
};

Gfx obj_s_cstump5T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_cstump5T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
