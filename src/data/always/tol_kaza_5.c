...
#include "assets/forestd/tol_kaza_5/tol_kaza_5_pal.inc"
};

static u8 tol_kaza_5_a_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_5/tol_kaza_5_a_tex_txt.inc"
};

static u8 tol_kaza_5_c_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_5/tol_kaza_5_c_tex_txt.inc"
};

static u8 tol_kaza_5_b_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_5/tol_kaza_5_b_tex_txt.inc"
};

Vtx obj_shop_kaza5_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kaza_5/obj_shop_kaza5_v.inc"
};

Gfx obj_shop_kaza5_model[] ATTRIBUTE_ALIGN(8) = {
