...
#include "assets/forestd/obj_shop_seed/obj_shop_seed_pal.inc"
};

u8 obj_shop_seed_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_seed/obj_shop_seed_tex.inc"
};

Vtx obj_shop_seed_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_seed/obj_shop_seed_v.inc"
};

Gfx obj_seed_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_seed_gfx_model[] ATTRIBUTE_ALIGN(8) = {
