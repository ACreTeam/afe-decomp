...
#include "assets/forestd/act_darumaB/act_daruma_pal.inc"
};

u8 act_darumaB_tex[] = {
#include "assets/forestd/act_darumaB/act_darumaB_tex.inc"
};

Vtx act_darumaB_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_darumaB/act_darumaB_v.inc"
};

Gfx act_darumaB_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_MIRROR | G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 255, 1024),
gsDPPipeSync(),
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 2, 0, G_TX_RENDERTILE, 15, G_TX_MIRROR | G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
