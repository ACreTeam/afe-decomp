...
#include "assets/forestd/obj_shop_net/obj_shop_net_pal.inc"
};

u8 obj_shop_net_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_net/obj_shop_net_tex.inc"
};

Vtx obj_shop_net_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_net/obj_shop_net_v.inc"
};

Gfx obj_netT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_netT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
