...
#include "assets/forestd/obj_shop_paper/obj_shop_paper_pal.inc"
};

u8 obj_shop_paper_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_paper/obj_shop_paper_tex.inc"
};

Vtx obj_shop_paper_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_paper/obj_shop_paper_v.inc"
};

Gfx obj_paper_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_paper_gfx_model[] ATTRIBUTE_ALIGN(8) = {
