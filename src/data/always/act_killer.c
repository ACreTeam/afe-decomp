...
#include "assets/forestd/act_killer/act_killer_pal.inc"
};

u8 act_killer_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_killer/act_killer_tex_txt.inc"
};

Vtx act_killer_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_killer/act_killer_v.inc"
};

Gfx act_killer_model[] ATTRIBUTE_ALIGN(8) = {
