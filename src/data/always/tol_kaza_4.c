...
#include "assets/forestd/tol_kaza_4/tol_kaza_4_pal.inc"
};

static u8 tol_kaza_4_a_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_4/tol_kaza_4_a_tex_txt.inc"
};

static u8 tol_kaza_4_c_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_4/tol_kaza_4_c_tex_txt.inc"
};

static u8 tol_kaza_4_b_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_4/tol_kaza_4_b_tex_txt.inc"
};

Vtx obj_shop_kaza4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kaza_4/obj_shop_kaza4_v.inc"
};

Gfx obj_shop_kaza4_model[] ATTRIBUTE_ALIGN(8) = {
