...
#include "assets/forestd/ef_axe/ef_axe_pal.inc"
};

u8 ef_axe_tuka1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_axe/ef_axe_tuka1_tex_txt.inc"
};

u8 ef_axe_edge1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_axe/ef_axe_edge1_tex_txt.inc"
};

Vtx ef_axe1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_axe/ef_axe1_v.inc"
};

Gfx ef_axe1_model[] ATTRIBUTE_ALIGN(8) = {
...
#include "assets/forestd/ef_axe/ef_axe_tuka2_tex_txt.inc"
};

u8 ef_axe_edge2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_axe/ef_axe_edge2_tex_txt.inc"
};

Vtx ef_axe2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_axe/ef_axe2_v.inc"
};

Gfx ef_axe2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_CLD_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, ef_axe_pal),
...
#include "assets/forestd/ef_axe/ef_axe_edge3_tex_txt.inc"
};

Vtx ef_axe3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_axe/ef_axe3_v.inc"
};

Gfx ef_axe3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_CLD_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, ef_axe_pal),
