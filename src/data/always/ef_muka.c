...
#include "assets/forestd/ef_muka/ef_muka.inc"
};

Vtx ef_muka01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_muka/ef_muka01_00_v.inc"
};

Gfx ef_muka01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
