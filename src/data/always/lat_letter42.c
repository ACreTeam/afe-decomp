...
Vtx lat_letter42_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter42/lat_letter42_v.inc"
};

Gfx lat_letter42_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter42_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
