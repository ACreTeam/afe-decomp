...
u8 act_mus_kaeru_a1_body_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_kaeru_a1_body/act_mus_kaeru_a1_body_tex_txt.inc"
};

u8 act_mus_kaeru_a1_foot_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_kaeru_a1_body/act_mus_kaeru_a1_foot_tex_txt.inc"
};

Vtx act_mus_kaeru_a1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_kaeru_a1_body/act_mus_kaeru_a1_v.inc"
};

Gfx act_mus_kaeru_a1_anime_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_kaeru_a1_foot2_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_kaeru_a1_body_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetTextureImage_Dolphin(G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, act_mus_kaeru_a1_body_tex_txt),
...
Gfx act_mus_kaeru_a1_foot1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetTextureImage_Dolphin(G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, act_mus_kaeru_a1_foot_tex_txt),
...
cKF_Skeleton_R_c cKF_bs_r_act_mus_kaeru_a1 = 
	{ ARRAY_COUNT(cKF_je_r_act_mus_kaeru_a1_tbl), 4, cKF_je_r_act_mus_kaeru_a1_tbl }
;
