...
static Vtx act_m_suzumushi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_suzumushi1/act_m_suzumushi_v.inc"
};

static u16 act_m_suzumushi_pal[] = {
#include "assets/forestd/act_m_mu_suzumushi1/act_m_suzumushi_pal.inc"
};

static u8 act_m_suzumushi[] = {
#include "assets/forestd/act_m_mu_suzumushi1/act_m_suzumushi.inc"
};

Gfx act_m_mu_suzumushi1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_suzumushi2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
