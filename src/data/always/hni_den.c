...
#include "assets/forestd/hni_den/lat_fusen_TXT.inc"
};

u8 hni_den_2dl_tex[] = {
#include "assets/forestd/hni_den/hni_den_2dl_tex.inc"
};

u8 hni_den_2dml_tex[] = {
#include "assets/forestd/hni_den/hni_den_2dml_tex.inc"
};

u8 hni_den_2dmr_tex[] = {
#include "assets/forestd/hni_den/hni_den_2dmr_tex.inc"
};

u8 hni_den_2dm_tex[] = {
#include "assets/forestd/hni_den/hni_den_2dm_tex.inc"
};

u8 hni_den_2dr_tex[] = {
#include "assets/forestd/hni_den/hni_den_2dr_tex.inc"
};

u8 hni_den_2ml_tex[] = {
#include "assets/forestd/hni_den/hni_den_2ml_tex.inc"
};

u8 hni_den_2mr_tex[] = {
#include "assets/forestd/hni_den/hni_den_2mr_tex.inc"
};

u8 hni_den_2ul_tex[] = {
#include "assets/forestd/hni_den/hni_den_2ul_tex.inc"
};

u8 hni_den_2uml_tex[] = {
#include "assets/forestd/hni_den/hni_den_2uml_tex.inc"
};

u8 hni_den_2umr_tex[] = {
#include "assets/forestd/hni_den/hni_den_2umr_tex.inc"
};

u8 hni_den_2um_tex[] = {
#include "assets/forestd/hni_den/hni_den_2um_tex.inc"
};

u8 hni_den_2m_tex[] = {
#include "assets/forestd/hni_den/hni_den_2m_tex.inc"
};

static u8 inv_mwin_3Dma_tex[] = {
#include "assets/forestd/hni_den/inv_mwin_3Dma_tex.inc"
};

u8 hni_den_2ur_tex[] = {
#include "assets/forestd/hni_den/hni_den_2ur_tex.inc"
};

Vtx hni_den_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/hni_den/hni_den_v.inc"
};

Gfx hni_den_senT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx hni_den_win2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx hni_den_3DmT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0),
...
Gfx hni_den_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx hni_den_model[] ATTRIBUTE_ALIGN(8) = {
