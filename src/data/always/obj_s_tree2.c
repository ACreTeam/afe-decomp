...
#include "assets/forestd/obj_s_tree2/obj_s_tree_young_tex.inc"
};

Vtx obj_s_tree2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_tree2/obj_s_tree2_v.inc"
};

Gfx obj_s_gold_tree2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_tree2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
