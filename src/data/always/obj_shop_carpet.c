...
#include "assets/forestd/obj_shop_carpet/obj_shop_carpet_pal.inc"
};

u8 obj_shop_carpet_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_carpet/obj_shop_carpet_tex.inc"
};

Vtx obj_shop_carpet_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_carpet/obj_shop_carpet_v.inc"
};

Gfx obj_carpetT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_carpetT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
