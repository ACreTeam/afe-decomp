...
struct ac_npc_clip_s {
    ...
    /* 0x104 */ void* _104[(0x110 - 0x104) / sizeof(void*)];
    /* 0x110 */ aNPC_SET_REQUEST_ACT_PROC set_request_act_proc;
    /* 0x114 */ aNPC_SET_HEAD_REQUEST_PROC set_head_request_act_proc;
    /* 0x118 */ aNPC_TALK_DEMO_PROC talk_demo_proc;
    /* 0x11C */ aNPC_ANIMATION_INIT_PROC animation_init_proc;
    /* 0x120 */ aNPC_CHG_SCHEDULE_PROC chg_schedule_proc;
    /* 0x124 */ aNPC_SET_DST_POS_PROC set_dst_pos_proc;
    /* 0x128 */ aNPC_CLIP_THINK_PROC think_proc;
    /* 0x12C */ aNPC_FORCE_CALL_REQ_PROC force_call_req_proc;
    /* 0x130 */ aNPC_SET_START_POS_PROC set_start_pos_proc;
