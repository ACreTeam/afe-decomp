...
Vtx lat_letter56_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter56/lat_letter56_v.inc"
};

Gfx lat_letter56_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter56_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
