...
#include "assets/forestd/crw_zinnia2/crw_zinnia2_pal.inc"
};

u8 crw_zinnia21_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_zinnia2/crw_zinnia21_tex_txt.inc"
};

u8 crw_zinnia22_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_zinnia2/crw_zinnia22_tex_txt.inc"
};

Vtx crw_zinnia2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_zinnia2/crw_zinnia2_v.inc"
};

Gfx crw_zinnia2_body_model[] ATTRIBUTE_ALIGN(8) = {
