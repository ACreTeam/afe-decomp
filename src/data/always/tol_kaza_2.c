...
#include "assets/forestd/tol_kaza_2/tol_kaza_2_pal.inc"
};

static u8 tol_kaza_2_a_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_2/tol_kaza_2_a_tex_txt.inc"
};

static u8 tol_kaza_2_c_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_2/tol_kaza_2_c_tex_txt.inc"
};

static u8 tol_kaza_2_b_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_2/tol_kaza_2_b_tex_txt.inc"
};

Vtx obj_shop_kaza2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kaza_2/obj_shop_kaza2_v.inc"
};

Gfx obj_shop_kaza2_model[] ATTRIBUTE_ALIGN(8) = {
