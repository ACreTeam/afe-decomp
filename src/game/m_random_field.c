...
extern void mRF_MakeRandomField(mFM_combination_c* combi_table, mFM_combo_info_c* combo_info, int combo_count,
                                GAME* game) {
...
static int mRF_GateType2GateCount(int gate_type) {
    static u8 gate_count_table[mRF_GATE_TYPE_NUM] = { 0, 1, 1, 2, 2, 3 };
...
static u8 l_river_next_direct[mRF_RIVER_NUM] = { mRF_DIRECT_SOUTH, mRF_DIRECT_EAST, mRF_DIRECT_WEST, mRF_DIRECT_EAST,
                                                 mRF_DIRECT_SOUTH, mRF_DIRECT_WEST, mRF_DIRECT_SOUTH };
...
extern int mRF_BlockType2RiverNextDirect(u8 type) {
    ...
    u32 river_kinds[mRF_RIVER_NUM] = { mRF_BLOCKKIND_RIVER0, mRF_BLOCKKIND_RIVER1, mRF_BLOCKKIND_RIVER2,
                                       mRF_BLOCKKIND_RIVER3, mRF_BLOCKKIND_RIVER4, mRF_BLOCKKIND_RIVER5,
