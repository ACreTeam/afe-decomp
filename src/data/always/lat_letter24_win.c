...
Vtx lat_letter24_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter24_win/lat_letter24_v.inc"
};

Gfx lat_letter24_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter24_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter24_model[] ATTRIBUTE_ALIGN(8) = {
