...
#include "assets/forestd/act_mus_hera_body2_005B9D60/int_ike_hera_pal.inc"
};

static u8 act_mus_hera_body2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_hera_body2_005B9D60/act_mus_hera_body2.inc"
};

static u8 act_mus_hera_body1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_hera_body2_005B9D60/act_mus_hera_body1.inc"
};

static u8 act_mus_hera_body3[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_hera_body2_005B9D60/act_mus_hera_body3.inc"
};

static Vtx act_m_hera_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_hera_body2_005B9D60/act_m_hera_v.inc"
};

Gfx act_m_mu_hera1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_hera2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_hera_pal),
