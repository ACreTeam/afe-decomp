...
#include "assets/forestd/obj_s_tree4_trunk/obj_s_tree4_trunk_tex.inc"
};

Vtx obj_s_tree4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_tree4_trunk/obj_s_tree4_v.inc"
};

Gfx obj_s_gold_tree4_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_tree4_leafT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_gold_tree4_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_s_tree4_trunkT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
