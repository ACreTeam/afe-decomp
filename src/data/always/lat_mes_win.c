...
#include "assets/forestd/lat_mes_win/lat_mes_win_tex.inc"
};

Vtx lat_mes_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_mes_win/lat_mes_v.inc"
};

Gfx lat_mes_winT_model[] ATTRIBUTE_ALIGN(8) = {
