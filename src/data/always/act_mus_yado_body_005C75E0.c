...
#include "assets/forestd/act_mus_yado_body_005C75E0/int_ike_yado_pal.inc"
};

static u8 act_mus_yado_body[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_yado_body_005C75E0/act_mus_yado_body.inc"
};

static u8 act_mus_yado_body2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_yado_body_005C75E0/act_mus_yado_body2.inc"
};

static u8 act_mus_yado_body3[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_yado_body_005C75E0/act_mus_yado_body3.inc"
};

static Vtx act_m_yado_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_yado_body_005C75E0/act_m_yado_v.inc"
};

Gfx act_m_mu_yado1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_yado2_1T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_yado_pal),
...
Gfx act_m_mu_yado2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_yado_pal),
