...
Vtx ef_w_cedar3_shake_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_w_cedar3_shake_005651A0/ef_w_cedar3_shake_v.inc"
};

Gfx ef_w_cedar3_shake_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_w_cedar3_shake = 
	{ ARRAY_COUNT(cKF_je_r_ef_w_cedar3_shake_tbl), 1, cKF_je_r_ef_w_cedar3_shake_tbl }
;
