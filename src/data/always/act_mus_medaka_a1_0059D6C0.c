...
#include "assets/forestd/act_mus_medaka_a1_0059D6C0/int_nog_medaka_pal.inc"
};

u8 act_mus_medaka_body_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_medaka_a1_0059D6C0/act_mus_medaka_body_txt.inc"
};

Vtx act_mus_medaka_a1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_medaka_a1_0059D6C0/act_mus_medaka_a1_v.inc"
};

Gfx act_mus_medaka_sakana_body_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_medaka_sakana_head_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, int_nog_medaka_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 16, act_mus_medaka_body_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
...
cKF_Skeleton_R_c cKF_bs_r_act_mus_medaka_a1 = 
	{ ARRAY_COUNT(cKF_je_r_act_mus_medaka_a1_tbl), 2, cKF_je_r_act_mus_medaka_a1_tbl }
;
