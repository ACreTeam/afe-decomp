...
#include "assets/forestd/obj_koban_shine/obj_koban_shine_1.inc"
};

u8 obj_koban_shine_2[] = {
#include "assets/forestd/obj_koban_shine/obj_koban_shine_2.inc"
};

Vtx obj_koban_shine_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_koban_shine/obj_koban_shine_v.inc"
};

Gfx obj_koban_shine_modelT[] ATTRIBUTE_ALIGN(8) = {
