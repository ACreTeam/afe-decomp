...
static Vtx act_m_hachi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_hachi1_1/act_m_hachi_v.inc"
};

static u16 act_m_hachi_pal[] = {
#include "assets/forestd/act_m_mu_hachi1_1/act_m_hachi_pal.inc"
};

static u8 act_m_hachi[] = {
#include "assets/forestd/act_m_mu_hachi1_1/act_m_hachi.inc"
};

Gfx act_m_mu_hachi1_1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_hachi1_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
...
Gfx act_m_mu_hachi2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, PRIMITIVE, 0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
