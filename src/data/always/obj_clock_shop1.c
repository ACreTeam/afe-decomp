...
#include "assets/forestd/obj_clock_shop1/obj_shop1_clock_pal.inc"
};

u8 obj_clock_shop1_tex_txt[] = {
#include "assets/forestd/obj_clock_shop1/obj_clock_shop1_tex_txt.inc"
};

Vtx obj_clock_shop1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_clock_shop1/obj_clock_shop1_v.inc"
};

Gfx obj_clock_shop1_base_model[] ATTRIBUTE_ALIGN(8) = {
...
gsDPPipeSync(),
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 4, 0, G_TX_RENDERTILE, 15, G_TX_NOMIRROR | G_TX_CLAMP, 6, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_CLAMP, 6, G_TX_NOLOD),
...
Gfx obj_clock_shop1_long_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
Gfx obj_clock_shop1_short_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
Gfx obj_clock_shop1_pend_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
u8 cKF_ckcb_r_obj_clock_shop1_tbl[] = {
0,
0,
0,
1,
...
s16 cKF_kn_obj_clock_shop1_tbl[] = {
5
};

s16 cKF_c_obj_clock_shop1_tbl[] = {
0,
0,
1375,
0,
...
s16 cKF_ds_obj_clock_shop1_tbl[] = {
1,
-300,
59,
4,
...
cKF_Animation_R_c cKF_ba_r_obj_clock_shop1 = 
	{ cKF_ckcb_r_obj_clock_shop1_tbl, cKF_ds_obj_clock_shop1_tbl, cKF_kn_obj_clock_shop1_tbl, cKF_c_obj_clock_shop1_tbl, -1, 61 }
;
...
cKF_Skeleton_R_c cKF_bs_r_obj_clock_shop1 = 
	{ ARRAY_COUNT(cKF_je_r_obj_clock_shop1_tbl), 4, cKF_je_r_obj_clock_shop1_tbl }
;
