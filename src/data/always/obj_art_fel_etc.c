...
#include "assets/forestd/obj_art_fel_etc/obj_art_fel_etc_pal.inc"
};

u16 obj_art_fel_art_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_fel_etc/obj_art_fel_art_pal.inc"
};

u8 obj_art_fel_gaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_fel_etc/obj_art_fel_gaku_tex.inc"
};

u8 obj_art_fel_name_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_fel_etc/obj_art_fel_name_tex.inc"
};

u8 obj_art_fel_art_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_fel_etc/obj_art_fel_art_tex.inc"
};

Vtx obj_art07_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_art_fel_etc/obj_art07_v.inc"
};

Gfx obj_art07_model[] ATTRIBUTE_ALIGN(8) = {
