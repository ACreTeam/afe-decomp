...
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_ent_pal.inc"
};

static u16 rom_conveni_cooler_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_cooler_pal.inc"
};

static u16 rom_shop_kouhaku_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_shop_kouhaku_pal.inc"
};

static u16 rom_conveni_tana_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_tana_pal.inc"
};

static u16 rom_conveni_floor_E_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_floor_E_pal.inc"
};

static u16 rom_conveni_leji_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_leji_pal.inc"
};

static u16 rom_conveni_mirror_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_mirror_rgb_ci4_pal.inc"
};

static u8 rom_conveni_ent[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_ent.inc"
};

static u8 rom_conveni_maruwaku[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_maruwaku.inc"
};

static u8 rom_shop_kouhaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_shop_kouhaku_tex.inc"
};

static u8 rom_conveni_counter[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_counter.inc"
};

static u8 rom_conveni_bou[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_bou.inc"
};

static u8 rom_conveni_tana_bf2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_tana_bf2.inc"
};

static u8 rom_conveni_floor_E[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_floor_E.inc"
};

static u8 rom_conveni_tana_f[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_tana_f.inc"
};

static u8 rom_convevi_kage1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_convevi_kage1.inc"
};

static u8 rom_conveni_leji_e[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_leji_e.inc"
};

static u8 rom_conveni_leji_k[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_leji_k.inc"
};

static u8 rom_conveni_leji_s[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_leji_s.inc"
};

static u8 rom_conveni_leji_t[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_leji_t.inc"
};

static u8 rom_conveni_wall_C[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_wall_C.inc"
};

static u8 rom_conveni_door[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_door.inc"
};

static u8 rom_conveni_tana_bf[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_tana_bf.inc"
};

static u8 rom_conveni_mirror_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_conveni_mirror_rgb_ci4.inc"
};

Vtx rom_shop2_fuku_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_conveni_mirror_rgb_ci4_00657BA0/rom_shop2_fuku_v.inc"
};

Gfx rom_shop2_fuku_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_shop2_fuku_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
