...
u8 ef_shadow_in_0[] = {
#include "assets/forestd/ef_shadow_in/ef_shadow_in_0.inc"
};

static Vtx ef_shadow_in_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_shadow_in/ef_shadow_in_v.inc"
};

Gfx ef_shadow_in_modelT[] ATTRIBUTE_ALIGN(8) = {
