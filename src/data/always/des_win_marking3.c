...
#include "assets/forestd/des_win_marking3/des_win_marking3_tex.inc"
};

u8 des_win_marking_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_marking3/des_win_marking_tex.inc"
};

Vtx des_marking_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/des_win_marking3/des_marking_v.inc"
};

Gfx des_win_marking_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_win_marking2T_model[] ATTRIBUTE_ALIGN(8) = {
