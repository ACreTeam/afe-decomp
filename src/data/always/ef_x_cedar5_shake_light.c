...
Vtx ef_x_cedar5_shake_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_x_cedar5_shake_light/ef_x_cedar5_shake_v.inc"
};

Gfx ef_x_cedar5_shake_light_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_x_cedar5_shake_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_x_cedar5_shake = 
	{ ARRAY_COUNT(cKF_je_r_ef_x_cedar5_shake_tbl), 2, cKF_je_r_ef_x_cedar5_shake_tbl }
;
