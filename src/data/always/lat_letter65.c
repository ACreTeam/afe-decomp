...
Vtx lat_letter65_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter65/lat_letter65_v.inc"
};

Gfx lat_letter29_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter29_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
