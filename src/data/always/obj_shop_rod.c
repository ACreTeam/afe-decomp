...
#include "assets/forestd/obj_shop_rod/obj_shop_rod_pal.inc"
};

u8 obj_shop_rod_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_rod/obj_shop_rod_tex.inc"
};

Vtx obj_shop_rod_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_rod/obj_shop_rod_v.inc"
};

Gfx obj_rodT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_rodT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_rod_lineT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_shop_rod_pal),
...
Gfx obj_rod_lineT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
