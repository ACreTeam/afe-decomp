...
#include "assets/forestd/obj_shop_tire/obj_shop_tire_pal.inc"
};

u8 obj_shop_tire_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_tire/obj_shop_tire_tex.inc"
};

Vtx obj_shop_tire_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_tire/obj_shop_tire_v.inc"
};

Gfx obj_g1T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_g1T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
