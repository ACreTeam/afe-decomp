...
#include "assets/forestd/tol_kaza_1/tol_kaza_1_pal.inc"
};

static u8 tol_kaza_1_b_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_1/tol_kaza_1_b_tex_txt.inc"
};

static u8 tol_kaza_1_a_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_1/tol_kaza_1_a_tex_txt.inc"
};

static u8 tol_kaza_1_c_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_1/tol_kaza_1_c_tex_txt.inc"
};

Vtx obj_shop_kaza1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kaza_1/obj_shop_kaza1_v.inc"
};

Gfx obj_shop_kaza1_model[] ATTRIBUTE_ALIGN(8) = {
