...
#include "assets/forestd/obj_s_pstump3/obj_s_palm_young_tex.inc"
};

Vtx obj_s_pstump3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_pstump3/obj_s_pstump3_v.inc"
};

Gfx obj_s_pstump3T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_pstump3T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
