...
#include "assets/forestd/ef_think_l/ef_think_l.inc"
};

Vtx ef_think_l_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_think_l/ef_think_l_v.inc"
};

Gfx ef_think_l_modelT[] ATTRIBUTE_ALIGN(8) = {
