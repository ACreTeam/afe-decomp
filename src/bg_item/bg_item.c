...
/* sizeof(BG_ITEM_ACTOR) == 0x13FA8 */
struct bg_item_actor_s {
    /* 0x00000 */ ACTOR actor_class;
    /* 0x00174 */ bg_item_common_c common;
    /* 0x13B78 */ bg_item_idx_info_c item_idx_info[mFM_VISIBLE_BLOCK_NUM];
};
...
#include "../src/bg_item/bg_item_data.c_inc"
