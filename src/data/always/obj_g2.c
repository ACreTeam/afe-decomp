...
#include "assets/forestd/obj_g2/obj_shop_akican_pal.inc"
};

u8 obj_shop_akican_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_g2/obj_shop_akican_tex.inc"
};

Vtx obj_shop_akican_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_g2/obj_shop_akican_v.inc"
};

Gfx obj_g2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_g2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
