...
Vtx lat_letter33_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter33/lat_letter33_v.inc"
};

Gfx lat_letter33_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter33_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
