...
#include "assets/forestd/att_win/att_win_waku1_tex.inc"
};

u8 att_win_waku2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/att_win/att_win_waku2_tex.inc"
};

u8 att_win_waku3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/att_win/att_win_waku3_tex.inc"
};

u8 att_win_waku4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/att_win/att_win_waku4_tex.inc"
};

u8 att_win_waku5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/att_win/att_win_waku5_tex.inc"
};

u8 att_win_waku6_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/att_win/att_win_waku6_tex.inc"
};

Vtx att_win_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/att_win/att_win_v.inc"
};

Gfx att_win_cursor_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx att_win_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx att_win_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsSPLoadGeometryMode(G_SHADE | G_CULL_BACK | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
gsDPSetOtherMode(G_AD_NOTPATTERN | G_CD_MAGICSQ | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_1CYCLE | G_PM_NPRIMITIVE, G_AC_THRESHOLD | G_ZS_PIXEL | G_RM_PASS | G_RM_AA_TEX_EDGE2),
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsSPEndDisplayList(),
};

Gfx att_win_model[] ATTRIBUTE_ALIGN(8) = {
