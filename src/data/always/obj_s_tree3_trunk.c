...
#include "assets/forestd/obj_s_tree3_trunk/obj_s_tree3_leaf_tex.inc"
};

Vtx obj_s_tree3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_tree3_trunk/obj_s_tree3_v.inc"
};

Gfx obj_s_gold_tree3_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_tree3_leafT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_tree3_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_s_gold_tree3_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_s_tree_young_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 8, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPEndDisplayList(),
...
Gfx obj_s_tree3_trunkT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
