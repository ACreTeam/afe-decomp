...
extern Gfx rom_yubin_pp_model[] = {
    ...
    gsDPLoadTextureBlock_4b_Dolphin(yubin_pp_tex, G_IM_FMT_CI, 48, 32, 15, GX_CLAMP, GX_CLAMP, 0, 0),
    ...
    gsSPVertex(&rom_yubin_pp_v[0], 6, 0),
    gsSPNTrianglesInit_5b(
        4, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
