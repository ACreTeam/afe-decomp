...
Vtx ef_x_cedar5_cutL_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_x_cedar5_cutL_light/ef_x_cedar5_cutL_v.inc"
};

Gfx ef_x_cedar5_cutL_light_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_x_cedar5_cutL_leaf_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_x_cedar5_cutL_trunk_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_x_cedar5_cutL = 
	{ ARRAY_COUNT(cKF_je_r_ef_x_cedar5_cutL_tbl), 3, cKF_je_r_ef_x_cedar5_cutL_tbl }
;
