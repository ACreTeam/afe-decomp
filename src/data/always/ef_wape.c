...
#include "assets/forestd/ef_wape/ef_wape_tex.inc"
};

Vtx ef_wipe1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_wape/ef_wipe1_v.inc"
};

Gfx ef_wipe1_modelT[] ATTRIBUTE_ALIGN(8) = {
