...
#include "assets/forestd/act_m_ari/act_m_ari_pal.inc"
};

static u8 act_m_ari_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_ari/act_m_ari_tex.inc"
};

static Vtx act_m_ari_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_ari/act_m_ari_v.inc"
};

Gfx act_m_ariT_model[] ATTRIBUTE_ALIGN(8) = {
