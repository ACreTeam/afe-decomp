...
#include "assets/forestd/tol_rope_1/tol_rope_1_pal.inc"
};

u8 tol_rope_1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_rope_1/tol_rope_1_tex.inc"
};

Vtx tol_rope_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_rope_1/tol_rope_1_v.inc"
};

Gfx tol_rope_1T_model[] ATTRIBUTE_ALIGN(8) = {
