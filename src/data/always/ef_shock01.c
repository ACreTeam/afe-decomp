...
#include "assets/forestd/ef_shock01/ef_shock01_0.inc"
};

Vtx ef_shock01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_shock01/ef_shock01_00_v.inc"
};

Gfx ef_shock01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
