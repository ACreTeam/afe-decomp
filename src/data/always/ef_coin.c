...
#include "assets/forestd/ef_coin/ef_coin_tex_txt.inc"
};

Vtx ef_coin_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_coin/ef_coin_v.inc"
};

Gfx ef_coin_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_coin_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(4000, 4000, 0, G_TX_RENDERTILE, G_ON),
