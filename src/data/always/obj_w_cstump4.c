...
#include "assets/forestd/obj_w_cstump4/obj_w_cedar_stump_tex.inc"
};

Vtx obj_w_cstump4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_cstump4/obj_w_cstump4_v.inc"
};

Gfx obj_w_cstump4T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_cstump4T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
