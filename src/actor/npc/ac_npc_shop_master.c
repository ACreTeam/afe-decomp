...
// TODO: are these declared in every file? DnM+ says they're static yet they seemingly must be defined after their
// usage...
...
void aNSM_actor_ct(ACTOR* actorx, GAME* game) {
    static aNPC_ct_data_c ct_data = {
        &aNSM_actor_move, &aNSM_actor_draw, aNPC_CT_SCHED_TYPE_NONE, NULL, NULL, NULL, 1,
    };
    ...
    if (mSP_force_opend()) {
        shop_master->npc_class.movement.speed_percent = 0.4f;
    }
