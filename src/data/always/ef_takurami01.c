...
#include "assets/forestd/ef_takurami01/ef_takurami01_0us.inc"
};

Vtx ef_takurami01_yoko_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_takurami01/ef_takurami01_yoko_v.inc"
};

Vtx ef_takurami01_yoko_v2[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_takurami01/ef_takurami01_yoko_v2.inc"
};

Gfx ef_takurami01_yoko_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_takurami01_yoko_modelT2[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetEnvColor(0, 0, 200, 255),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
...
Vtx ef_takurami01_kira_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_takurami01/ef_takurami01_kira_v.inc"
};

Gfx ef_takurami01_kira_modelT[] ATTRIBUTE_ALIGN(8) = {
...
u8 ef_takurami01_1[] = {
#include "assets/forestd/ef_takurami01/ef_takurami01_1.inc"
};

Gfx ef_takurami01_normal_render_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_CLD_SURF2),
gsSPEndDisplayList(),
};

Gfx ef_takurami01_menu_render_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsSPEndDisplayList(),
};
