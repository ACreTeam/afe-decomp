...
#include "assets/forestd/crw_biscus3/crw_biscus3_pal.inc"
};

u8 crw_biscus32_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_biscus3/crw_biscus32_tex_txt.inc"
};

u8 crw_biscus34_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_biscus3/crw_biscus34_tex_txt.inc"
};

u8 crw_biscus33_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_biscus3/crw_biscus33_tex_txt.inc"
};

u8 crw_biscus31_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_biscus3/crw_biscus31_tex_txt.inc"
};

Vtx crw_biscus3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_biscus3/crw_biscus3_v.inc"
};

Gfx crw_biscus3_body_model[] ATTRIBUTE_ALIGN(8) = {
