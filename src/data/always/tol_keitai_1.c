...
#include "assets/forestd/tol_keitai_1/tol_keitai_1_pal.inc"
};

u8 tol_keitai_1_ueura1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_keitai_1/tol_keitai_1_ueura1_tex_txt.inc"
};

u8 tol_keitai_1_ueomote1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_keitai_1/tol_keitai_1_ueomote1_tex_txt.inc"
};

u8 tol_keitai_1_shitaura1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_keitai_1/tol_keitai_1_shitaura1_tex_txt.inc"
};

u8 tol_keitai_1_shitaomote1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_keitai_1/tol_keitai_1_shitaomote1_tex_txt.inc"
};

Vtx tol_keitai_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_keitai_1/tol_keitai_1_v.inc"
};

Gfx main1_keitai1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx main2_keitai1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, tol_keitai_1_pal),
...
cKF_Joint_R_c cKF_je_r_tol_keitai_1_tbl[] = {
	{ NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
	{ main1_keitai1_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
	{ main2_keitai1_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 800, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_tol_keitai_1 = 
	{ ARRAY_COUNT(cKF_je_r_tol_keitai_1_tbl), 2, cKF_je_r_tol_keitai_1_tbl }
;
