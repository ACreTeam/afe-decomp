...
Vtx obj_s_cstump2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_cstump2/obj_s_cstump2_v.inc"
};

Gfx obj_s_cstump2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_cstump2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
