...
static Vtx act_m_maimai_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_maimai/act_m_maimai_v.inc"
};

static u16 act_m_maimai_pal[] = {
#include "assets/forestd/act_m_mu_maimai/act_m_maimai_pal.inc"
};

static u8 act_m_maimai_tex[] = {
#include "assets/forestd/act_m_mu_maimai/act_m_maimai_tex.inc"
};

Gfx act_m_mu_maimaiT_model[] ATTRIBUTE_ALIGN(8) = {
