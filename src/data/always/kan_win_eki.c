...
#include "assets/forestd/kan_win_eki/kan_win_eki_tex.inc"
};

Vtx kan_eki_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/kan_win_eki/kan_eki_v.inc"
};

Gfx kan_win_ekiT_model[] ATTRIBUTE_ALIGN(8) = {
