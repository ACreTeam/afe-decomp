...
#include "assets/forestd/obj_w_tree1/obj_w_tree_baby_tex.inc"
};

Vtx obj_w_tree1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_tree1/obj_w_tree1_v.inc"
};

Gfx obj_w_tree1T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_gold_tree1T_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 24, obj_w_tree_baby_tex),
...
Gfx obj_w_tree1T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
