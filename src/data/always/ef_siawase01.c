...
EVW_ANIME_SCROLL ef_siawase01_00_evw_anime_2[] ATTRIBUTE_ALIGN(32) = {
	{ 1, -4, 16, 16 },
	{ 0, 0, 16, 16 }
};

EVW_ANIME_DATA ef_siawase01_00_evw_anime[] = {
	{ -1, EVW_ANIME_TYPE_SCROLL2, ef_siawase01_00_evw_anime_2 }
};

u8 ef_siawase01_1[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_siawase01/ef_siawase01_1.inc"
};

u8 ef_siawase01_2_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_siawase01/ef_siawase01_2_int_i4.inc"
};

Vtx ef_siawase01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_siawase01/ef_siawase01_00_v.inc"
};

Gfx ef_siawase01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
...
#include "assets/forestd/ef_siawase01/ef_siawase01_0.inc"
};

Vtx ef_siawase01_01_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_siawase01/ef_siawase01_01_v.inc"
};

Gfx ef_siawase01_01_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
