...
Vtx rom_shop2f_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop2f/rom_shop2f_v.inc"
};

Gfx rom_shop2f_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx rom_shop2f_model[] ATTRIBUTE_ALIGN(8) = {
