...
#include "assets/forestd/act_mus_fun_body_0021E380/int_ike_fun_pal.inc"
};

static u8 act_mus_fun_body[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_fun_body_0021E380/act_mus_fun_body.inc"
};

static u8 act_mus_fun_body2[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_fun_body_0021E380/act_mus_fun_body2.inc"
};

static u8 act_mus_fun_body3[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_fun_body_0021E380/act_mus_fun_body3.inc"
};

static Vtx act_m_fun_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_fun_body_0021E380/act_m_fun_v.inc"
};

Gfx act_m_fun1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_fun2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_fun_pal),
...
Gfx act_m_fun3T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_fun_pal),
