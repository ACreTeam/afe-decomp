...
#include "assets/forestd/tol_kaza_3/tol_kaza_3_pal.inc"
};

static u8 tol_kaza_3_a_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_3/tol_kaza_3_a_tex_txt.inc"
};

static u8 tol_kaza_3_c_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_3/tol_kaza_3_c_tex_txt.inc"
};

static u8 tol_kaza_3_b_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_kaza_3/tol_kaza_3_b_tex_txt.inc"
};

Vtx obj_shop_kaza3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_kaza_3/obj_shop_kaza3_v.inc"
};

Gfx obj_shop_kaza3_model[] ATTRIBUTE_ALIGN(8) = {
