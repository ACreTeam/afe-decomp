...
#include "assets/forestd/act_f31_taiya/act_f31_taiya_pal.inc"
};

u8 act_f31_taiya_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f31_taiya/act_f31_taiya_tex.inc"
};

Vtx act_f31_taiya_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f31_taiya/act_f31_taiya_v.inc"
};

Gfx act_f29_petT_model[] ATTRIBUTE_ALIGN(8) = {
