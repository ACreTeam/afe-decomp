...
#include "assets/forestd/obj_s_tree_stump/obj_s_tree_stump_tex.inc"
};

Vtx obj_s_stump4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_tree_stump/obj_s_stump4_v.inc"
};

Gfx obj_stump4T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_gold_stump4T_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, obj_s_tree_stump_tex),
...
Gfx obj_stump4T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
