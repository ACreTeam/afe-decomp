...
static Vtx act_m_minmin_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_minmin1_1/act_m_minmin_v.inc"
};

static u16 act_m_minmin_pal[] = {
#include "assets/forestd/act_m_mu_minmin1_1/act_m_minmin_pal.inc"
};

static u8 act_m_minmin[] = {
#include "assets/forestd/act_m_mu_minmin1_1/act_m_minmin.inc"
};

Gfx act_m_mu_minmin1_1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_minmin1_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
