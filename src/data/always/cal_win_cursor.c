...
#include "assets/forestd/cal_win_cursor/cal_win_cursor_tex.inc"
};

Vtx cal_icon1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/cal_win_cursor/cal_icon1_v.inc"
};

Gfx cal_icon_cursor_model[] ATTRIBUTE_ALIGN(8) = {
