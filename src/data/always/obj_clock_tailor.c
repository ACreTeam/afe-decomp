...
#include "assets/forestd/obj_clock_tailor/obj_clock_tailor_1_tex_txt.inc"
};

u8 obj_clock_tailor_2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_clock_tailor/obj_clock_tailor_2_tex_txt.inc"
};

Vtx obj_clock_tailor_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_clock_tailor/obj_clock_tailor_v.inc"
};

Gfx obj_clock_tailor_base_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_clock_tailor_long_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetTextureImage_Dolphin(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 64, obj_clock_tailor_1_tex_txt),
...
Gfx obj_clock_tailor_short_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetTextureImage_Dolphin(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 64, obj_clock_tailor_1_tex_txt),
...
Gfx obj_clock_tailor_furi_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
u8 cKF_ckcb_r_obj_clock_tailor_tbl[] = {
0,
0,
0,
1,
...
s16 cKF_kn_obj_clock_tailor_tbl[] = {
5
};

s16 cKF_c_obj_clock_tailor_tbl[] = {
20000,
10000,
5000,
0,
...
s16 cKF_ds_obj_clock_tailor_tbl[] = {
1,
-1100,
39,
5,
...
cKF_Animation_R_c cKF_ba_r_obj_clock_tailor = 
	{ cKF_ckcb_r_obj_clock_tailor_tbl, cKF_ds_obj_clock_tailor_tbl, cKF_kn_obj_clock_tailor_tbl, cKF_c_obj_clock_tailor_tbl, -1, 61 }
;
...
cKF_Skeleton_R_c cKF_bs_r_obj_clock_tailor = 
	{ ARRAY_COUNT(cKF_je_r_obj_clock_tailor_tbl), 4, cKF_je_r_obj_clock_tailor_tbl }
;
