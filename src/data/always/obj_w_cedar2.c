...
Vtx obj_w_cedar2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_cedar2/obj_w_cedar2_v.inc"
};

Gfx obj_w_cedar2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_cedar2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
