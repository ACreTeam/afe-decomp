...
u16 grd_s_cliff_pal[] = {
#include "assets/forestd/grd_s_cliff/grd_s_cliff_pal.inc"
};

u16 grd_s_earth_pal[] = {
#include "assets/forestd/grd_s_cliff/grd_s_earth_pal.inc"
};

static u8 grd_s_cliff_tex[] = {
#include "assets/forestd/grd_s_cliff/grd_s_cliff_tex.inc"
};

static u8 grd_s_earth_tex[] = {
#include "assets/forestd/grd_s_cliff/grd_s_earth_tex.inc"
};

static u8 grd_s_grass_tex[] = {
#include "assets/forestd/grd_s_cliff/grd_s_grass_tex.inc"
};

Vtx tmp2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/grd_s_cliff/tmp2_v.inc"
};

Gfx tmp2_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx tmp2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetTextureLUT(G_TT_RGBA16),
gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, grd_s_earth_pal),
gsDPTileSync(),
...
gsDPPipeSync(),
gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, grd_s_grass_tex),
...
gsDPLoadTLUTCmd(G_TX_LOADTILE, 15),
gsDPPipeSync(),
gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, grd_s_earth_tex),
...
gsDPPipeSync(),
gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, grd_s_cliff_pal),
gsDPTileSync(),
gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_4b, 0, 496, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadTLUTCmd(G_TX_LOADTILE, 15),
gsDPPipeSync(),
gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, grd_s_cliff_tex),
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_MIRROR | G_TX_CLAMP, 6, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 6, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 1023, 512),
gsDPPipeSync(),
