...
#include "assets/forestd/ef_museum5_awa1/ef_museum5_awa1.inc"
};

Vtx ef_museum5_awa1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_museum5_awa1/ef_museum5_awa1_v.inc"
};

Gfx ef_museum5_awa1_model[] ATTRIBUTE_ALIGN(8) = {
