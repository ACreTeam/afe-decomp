...
#include "assets/forestd/obj_shop_sakuragai/obj_shop_sakuragai_pal.inc"
};

u8 obj_shop_sakuragai_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_sakuragai/obj_shop_sakuragai_tex.inc"
};

Vtx obj_shop_sakuragai_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_sakuragai/obj_shop_sakuragai_v.inc"
};

Gfx obj_sakuragaiT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_sakuragaiT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
