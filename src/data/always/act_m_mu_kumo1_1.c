...
static Vtx act_m_kumo_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_kumo1_1/act_m_kumo_v.inc"
};

static u16 act_m_kumo_pal[] = {
#include "assets/forestd/act_m_mu_kumo1_1/act_m_kumo_pal.inc"
};

static u8 act_m_kumo_tex[] = {
#include "assets/forestd/act_m_mu_kumo1_1/act_m_kumo_tex.inc"
};

Gfx act_m_mu_kumo1_1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_kumo1_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
...
Gfx act_m_mu_kumo2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
