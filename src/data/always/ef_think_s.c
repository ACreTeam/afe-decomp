...
#include "assets/forestd/ef_think_s/ef_think_s.inc"
};

Vtx ef_think_s_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_think_s/ef_think_s_v.inc"
};

Gfx ef_think_s_modelT[] ATTRIBUTE_ALIGN(8) = {
