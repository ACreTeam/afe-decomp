...
#include "assets/forestd/rom_myhome2B_floor/rom_myhome2B_floor_v.inc"
};

Gfx rom_myhome2B_floor_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_myhome2B_floor_new_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_myhome2B_floor_new2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(49152, 49152, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, anime_5_txt),
