...
#include "assets/forestd/lat_tegami_sw3/lat_tegami_sw3_tex.inc"
};

Vtx lat_sentaku2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_tegami_sw3/lat_sentaku2_v.inc"
};

Gfx lat_sentaku2_c_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_sentaku2_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
