...
#include "assets/forestd/obj_shop_horagai/obj_shop_horagai_pal.inc"
};

u8 obj_shop_horagai_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_horagai/obj_shop_horagai_tex.inc"
};

Vtx obj_shop_horagai_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_horagai/obj_shop_horagai_v.inc"
};

Gfx obj_horagaiT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_horagaiT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
