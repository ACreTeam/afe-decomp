...
#include "assets/forestd/kan_win_yane/kan_win_yane_tex.inc"
};

u8 kan_win_yashiro_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kan_win_yane/kan_win_yashiro_tex.inc"
};

u8 kan_win_yubin_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kan_win_yane/kan_win_yubin_tex.inc"
};

u8 kan_win_kouban_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kan_win_yane/kan_win_kouban_tex.inc"
};

u8 kan_win_omise_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kan_win_yane/kan_win_omise_tex.inc"
};

u8 kan_win_play_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kan_win_yane/kan_win_play_tex.inc"
};

u8 kan_win_ply_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kan_win_yane/kan_win_ply_tex.inc"
};

Vtx kan_hyouji2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/kan_win_yane/kan_hyouji2_v.inc"
};

Gfx kan_win_genzaiT_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kan_win_npc2T_base_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0),
...
Gfx kan_win_npc2T_1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kan_win_npc2T_2_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kan_win_npc2T_3_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kan_win_npcT_base_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0),
gsDPSetTextureImage_Dolphin(G_IM_FMT_IA, G_IM_SIZ_8b, 16, 16, kan_win_yane_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 0, GX_MIRROR, GX_MIRROR, 0, 0),
...
Gfx kan_win_npcT_1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kan_win_npcT_2_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetPrimColor(0, 255, 145, 70, 205, 255),
gsDPSetEnvColor(225, 225, 225, 255),
gsSPDisplayList(kan_win_npcT_base_model),
gsSPEndDisplayList(),
...
Gfx kan_win_npcT_3_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetPrimColor(0, 255, 170, 115, 20, 255),
gsDPSetEnvColor(225, 225, 225, 255),
gsSPDisplayList(kan_win_npcT_base_model),
gsSPEndDisplayList(),
...
Gfx kan_win_koubanT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx kan_win_yashiroT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0),
...
Gfx kan_win_omiseT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0),
gsDPSetPrimColor(0, 255, 195, 80, 45, 255),
...
Gfx kan_win_yuuT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0),
gsDPSetPrimColor(0, 255, 190, 70, 60, 255),
...
Gfx kan_win_playerT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0),
