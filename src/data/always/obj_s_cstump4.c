...
#include "assets/forestd/obj_s_cstump4/obj_s_cedar_stump_tex.inc"
};

Vtx obj_s_cstump4_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_cstump4/obj_s_cstump4_v.inc"
};

Gfx obj_s_cstump4T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_cstump4T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
