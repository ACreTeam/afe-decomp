...
static Vtx act_m_miyama_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_miyama1/act_m_miyama_v.inc"
};

static u16 act_m_miyama_pal[] = {
#include "assets/forestd/act_m_mu_miyama1/act_m_miyama_pal.inc"
};

static u8 act_m_miyama[] = {
#include "assets/forestd/act_m_mu_miyama1/act_m_miyama.inc"
};

Gfx act_m_mu_miyama1T_model[] ATTRIBUTE_ALIGN(8) = {
