...
#include "assets/forestd/tol_npcsao/tol_npcsao_1_pal.inc"
};

u8 tol_npcsao_1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_npcsao/tol_npcsao_1_tex.inc"
};

Vtx tol_npcsao_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_npcsao/tol_npcsao_1_v.inc"
};

Gfx tol_npcsao_1_sao_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx tol_npcsao_1_uki_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, tol_npcsao_1_pal),
