...
Vtx lat_letter58_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter58/lat_letter58_v.inc"
};

Gfx lat_letter58_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter58_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
