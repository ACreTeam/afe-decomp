...
#include "assets/forestd/obj_shop_cnaegi/obj_shop_cnaegi_pal.inc"
};

u8 obj_shop_cnaegi_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_cnaegi/obj_shop_cnaegi_tex.inc"
};

Vtx obj_shop_cnaegi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_cnaegi/obj_shop_cnaegi_v.inc"
};

Gfx obj_shop_cnaegiT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_shop_cnaegiT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
