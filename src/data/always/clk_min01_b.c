...
Vtx clk_min01_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/clk_min01_b/clk_min01_b_v.inc"
};

Gfx clk_min01_b_model[] ATTRIBUTE_ALIGN(8) = {
