...
#include "assets/forestd/rom_myhome2_wall/rom_myhome_pal.inc"
};

static u8 rom_myhome_window_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome2_wall/rom_myhome_window_tex.inc"
};

u8 rom_myhome_enter_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome2_wall/rom_myhome_enter_tex.inc"
};

Vtx rom_myhome2_wall_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_myhome2_wall/rom_myhome2_wall_v.inc"
};

Gfx rom_myhome2_wall_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx rom_myhome2_wall_model[] ATTRIBUTE_ALIGN(8) = {
