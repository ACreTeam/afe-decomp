...
Vtx obj_item_fish_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/fish/obj_item_fish_v.inc"
};

static u16 obj_item_fish_pal[] = {
#include "assets/forestd/fish/obj_item_fish_pal.inc"
};

static u8 obj_item_fish_tex[] = {
#include "assets/forestd/fish/obj_item_fish_tex.inc"
};

Gfx fish_DL_mode[] ATTRIBUTE_ALIGN(8) = {
...
Gfx fish_DL_vtx[] ATTRIBUTE_ALIGN(8) = {
