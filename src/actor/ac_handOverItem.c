...
extern Gfx obj_item_liveT_mat_model[];
extern Gfx obj_item_cracker_1T_mat_model[];
extern Gfx obj_box2T_mat_model[];
extern Gfx obj_medicinT_mat_model[];
...
static Gfx* mode_DL_table[mNT_ITEM_TYPE_NUM] = {
    ...
    obj_item_liveT_mat_model,
    obj_item_cracker_1T_mat_model,
    obj_box2T_mat_model,
    obj_medicinT_mat_model,
};
...
extern Gfx obj_item_liveT_gfx_model[];
extern Gfx obj_item_cracker_1T_gfx_model[];
extern Gfx obj_box2T_gfx_model[];
extern Gfx obj_medicinT_gfx_model[];
...
static Gfx* vtx_DL_table[mNT_ITEM_TYPE_NUM] = {
    ...
    obj_item_liveT_gfx_model,
    obj_item_cracker_1T_gfx_model,
    obj_box2T_gfx_model,
    obj_medicinT_gfx_model,
};
