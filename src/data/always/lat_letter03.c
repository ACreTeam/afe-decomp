...
Vtx lat_letter03_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter03/lat_letter03_v.inc"
};

Gfx lat_letter03_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter03_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPLoadTLUT_Dolphin(15, 16, 1, lat_letter03_pal),
...
Gfx lat_letter03_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter03_model[] ATTRIBUTE_ALIGN(8) = {
