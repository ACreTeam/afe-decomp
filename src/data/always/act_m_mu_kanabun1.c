...
static Vtx act_m_kanabun_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_kanabun1/act_m_kanabun_v.inc"
};

static u16 act_m_kanabun_pal[] = {
#include "assets/forestd/act_m_mu_kanabun1/act_m_kanabun_pal.inc"
};

static u8 act_m_kanabun[] = {
#include "assets/forestd/act_m_mu_kanabun1/act_m_kanabun.inc"
};

Gfx act_m_mu_kanabun1T_model[] ATTRIBUTE_ALIGN(8) = {
