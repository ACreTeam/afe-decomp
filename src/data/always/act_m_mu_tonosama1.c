...
static Vtx act_m_tonosama_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_tonosama1/act_m_tonosama_v.inc"
};

static u16 act_m_tonosama_pal[] = {
#include "assets/forestd/act_m_mu_tonosama1/act_m_tonosama_pal.inc"
};

static u8 act_m_tonosama[] = {
#include "assets/forestd/act_m_mu_tonosama1/act_m_tonosama.inc"
};

Gfx act_m_mu_tonosama1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_tonosama2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
