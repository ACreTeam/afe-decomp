...
#include "assets/forestd/obj_art12/obj_art12_pal.inc"
};

u8 obj_art12_gaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art12/obj_art12_gaku_tex.inc"
};

u8 obj_art12_art_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art12/obj_art12_art_tex.inc"
};

u8 obj_art12_name_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art12/obj_art12_name_tex.inc"
};

Vtx obj_art12_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_art12/obj_art12_v.inc"
};

Gfx obj_art12_model[] ATTRIBUTE_ALIGN(8) = {
