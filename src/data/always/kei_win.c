...
#include "assets/forestd/kei_win/kei_win_pin_pal.inc"
};

u8 kei_win_pin_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_pin_tex.inc"
};

u8 kei_win_w1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_w1_tex.inc"
};

u8 kei_win_w2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_w2_tex.inc"
};

u8 kei_win_w3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_w3_tex.inc"
};

u8 kei_win_kage2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_kage2_tex.inc"
};

u8 kei_win_kage3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_kage3_tex.inc"
};

u8 kei_win_kage4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_kage4_tex.inc"
};

u8 kei_win_slash_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/kei_win/kei_win_slash_tex.inc"
};

Vtx kei_win_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/kei_win/kei_win_v.inc"
};

Gfx kei_win_kamiT_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kei_win_pinT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
...
Gfx kei_win_wakuT_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx kei_win_slashT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0),
gsDPSetPrimColor(0, 255, 0, 0, 255, 255),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, kei_win_slash_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&kei_win_v[51], 8, 0),
gsSPNTrianglesInit_5b(4, 0, 1, 2, 1, 3, 2, 4, 5, 6),
gsSPNTriangles_5b(7, 4, 6, 0, 0, 0, 0, 0, 0, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx kei_win_mode[] ATTRIBUTE_ALIGN(8) = {
