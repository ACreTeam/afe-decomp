...
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w6_tex_rgb_ci4_pal.inc"
};

u16 sav_win_w1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w1_tex_rgb_ci4_pal.inc"
};

u16 sav_win_w2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w2_tex_rgb_ci4_pal.inc"
};

u16 sav_win_w3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w3_tex_rgb_ci4_pal.inc"
};

u16 sav_win_w4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w4_tex_rgb_ci4_pal.inc"
};

u16 sav_win_w5_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w5_tex_rgb_ci4_pal.inc"
};

static u8 inv_original_futa2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/inv_original_futa2_tex.inc"
};

u8 sav_win1_aw1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_aw1_tex.inc"
};

u8 sav_win1_aw6_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_aw6_tex.inc"
};

static u8 sav_win_waku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_waku_tex.inc"
};

u8 sav_win1_aw2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_aw2_tex.inc"
};

u8 sav_win1_aw3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_aw3_tex.inc"
};

u8 sav_win1_aw4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_aw4_tex.inc"
};

u8 sav_win1_aw5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_aw5_tex.inc"
};

static u8 ctl_win_tagu2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/ctl_win_tagu2_tex.inc"
};

static u8 ctl_win_waku1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/ctl_win_waku1_tex.inc"
};

static u8 ctl_win_waku2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/ctl_win_waku2_tex.inc"
};

u8 sav_win_1_kage1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_1_kage1_tex.inc"
};

u8 sav_win_1_kage2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_1_kage2_tex.inc"
};

u8 sav_win1_nuno_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_nuno_tex_rgb_ci4.inc"
};

u8 sav_win_w6_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w6_tex_rgb_ci4.inc"
};

u8 sav_win_w1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w1_tex_rgb_ci4.inc"
};

u8 sav_win_w2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w2_tex_rgb_ci4.inc"
};

u8 sav_win_w3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w3_tex_rgb_ci4.inc"
};

u8 sav_win_w4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w4_tex_rgb_ci4.inc"
};

u8 sav_win_w5_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win_w5_tex_rgb_ci4.inc"
};

Vtx sav_win1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/sav_win_w6_tex_rgb_ci4/sav_win1_v.inc"
};

Gfx sav_win1_w9_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_kage_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_waku_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx sav_win1_f_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx sav_win1_w1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_w2T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_w3T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_w4T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_w5T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, sav_win_w3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, sav_win_w3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx sav_win1_w6T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, sav_win_w2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, sav_win_w2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx sav_win1_w7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, sav_win_w1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, sav_win_w1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx sav_win1_w8T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx sav_win1_taguT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx sav_win1_ueT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx sav_win1_nameT_model2[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx save_win1_w_before_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx save_win1_w_all_model[] ATTRIBUTE_ALIGN(8) = {
gsSPDisplayList(sav_win1_w1T_model),
gsSPDisplayList(sav_win1_w2T_model),
gsSPDisplayList(sav_win1_w3T_model),
gsSPDisplayList(sav_win1_w4T_model),
gsSPDisplayList(sav_win1_w5T_model),
gsSPDisplayList(sav_win1_w6T_model),
gsSPDisplayList(sav_win1_w7T_model),
gsSPDisplayList(sav_win1_w8T_model),
gsSPDisplayList(sav_win1_w9_model),
gsSPEndDisplayList(),
};
