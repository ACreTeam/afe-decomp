...
#include "assets/forestd/rom_shop4/rom_shop4_1_floor_tex_pal.inc"
};

u16 rom_shop4_2_stair_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_stair_tex_pal.inc"
};

static u16 rom_shop4_1_table_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_1_table_tex_pal.inc"
};

u16 rom_shop4_2_wall_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_wall_tex_pal.inc"
};

u16 rom_shop4_2_sign01_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_sign01_tex_pal.inc"
};

static u16 rom_shop4_2_sign01_us_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_sign01_us_tex_pal.inc"
};

u16 rom_shop4_2_space_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_space_tex_pal.inc"
};

u8 rom_shop4_2_floor01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_floor01_tex.inc"
};

u8 rom_shop4_2_stair01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_stair01_tex.inc"
};

u8 rom_shop4_2_table01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_table01_tex.inc"
};

u8 rom_shop4_2_table02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_table02_tex.inc"
};

u8 rom_shop4_2_wall01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_wall01_tex.inc"
};

u8 rom_shop4_2_sign05_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_sign05_tex.inc"
};

static u8 rom_shop4_2_us_sign01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_us_sign01_tex.inc"
};

u8 rom_shop4_2_space_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_space_tex.inc"
};

u8 rom_shop4_2_wall02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_wall02_tex.inc"
};

u8 rom_shop4_2_floor02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_floor02_tex.inc"
};

u8 rom_shop4_2_floor03_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_floor03_tex.inc"
};

u8 rom_shop4_2_floor04_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_floor04_tex.inc"
};

u8 rom_shop4_2_shadow02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4/rom_shop4_2_shadow02_tex.inc"
};

Vtx rom_shop4_2w_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop4/rom_shop4_2w_v.inc"
};

Gfx rom_shop4_2w_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_shop4_2w_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
