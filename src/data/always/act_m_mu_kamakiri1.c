...
static Vtx act_m_kamakiri_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_kamakiri1/act_m_kamakiri_v.inc"
};

static u16 act_m_kamakiri_pal[] = {
#include "assets/forestd/act_m_mu_kamakiri1/act_m_kamakiri_pal.inc"
};

static u8 act_m_kamakiri[] = {
#include "assets/forestd/act_m_mu_kamakiri1/act_m_kamakiri.inc"
};

Gfx act_m_mu_kamakiri1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_kamakiri2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
