...
enum {
    ...
    aNRG2_NORM_TALK_AGAIN_PLUS,
    aNRG2_NORM_TALK_ALL_JOB_END_PLUS,
...
enum {
    ...
    aNRG2_FORCE_TALK_SAY_HELLO_PLUS,
    aNRG2_FORCE_TALK_SAY_HELLO_PLUS2,
...
enum {
    ...
    aNRG2_THINK_SAY_HELLO_PLUS,
    aNRG2_THINK_SAY_HELLO_PLUS2,
    aNRG2_THINK_SEND_AWAY,
    aNRG2_THINK_TALK_START_WAIT,
    aNRG2_THINK_TALK_START_WAIT_PLUS,
...
enum {
    ...
    aNRG2_TALK_SAY_HELLO_PLUS,
    aNRG2_TALK_SAY_HELLO_PLUS2,
    ...
    aNRG2_TALK_ALL_JOB_END_PLUS,
    aNRG2_TALK_MATAKAI_PLUS,
