...
static Vtx act_m_hirata_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_hirata1/act_m_hirata_v.inc"
};

static u16 act_m_hirata_pal[] = {
#include "assets/forestd/act_m_mu_hirata1/act_m_hirata_pal.inc"
};

static u8 act_m_hirata[] = {
#include "assets/forestd/act_m_mu_hirata1/act_m_hirata.inc"
};

Gfx act_m_mu_hirata1T_model[] ATTRIBUTE_ALIGN(8) = {
