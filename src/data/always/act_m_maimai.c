...
#include "assets/forestd/act_m_maimai/act_m_maimai_pal.inc"
};

static u8 act_m_maimai_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_maimai/act_m_maimai_tex.inc"
};

static Vtx act_m_maimai_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_maimai/act_m_maimai_v.inc"
};

Gfx act_m_maimaiT_model[] ATTRIBUTE_ALIGN(8) = {
