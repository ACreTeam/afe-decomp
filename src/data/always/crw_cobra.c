...
#include "assets/forestd/crw_cobra/crw_cobra_pal.inc"
};

u8 crw_cobra_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_cobra/crw_cobra_tex_txt.inc"
};

Vtx crw_cobra_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_cobra/crw_cobra_v.inc"
};

Gfx crw_cobra_model[] ATTRIBUTE_ALIGN(8) = {
