...
Vtx lat_letter06_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter06/lat_letter06_v.inc"
};

Gfx lat_letter06_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter06_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
