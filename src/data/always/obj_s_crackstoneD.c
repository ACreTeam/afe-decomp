...
Vtx obj_s_crackstoneD_v[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_s_crackstoneD/obj_s_crackstoneD_v.inc"
};

Gfx obj_s_crackstoneD_gfx_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(obj_s_crackstoneD_v, 15, 0),
