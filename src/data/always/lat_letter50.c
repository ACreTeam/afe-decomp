...
Vtx lat_letter50_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter50/lat_letter50_v.inc"
};

Gfx lat_letter50_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter50_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
