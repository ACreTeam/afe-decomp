...
extern Gfx rom_museum5_pp_model[] = {
    ...
    gsSPVertex(&rom_museum5_pp_v[0], 12, 0),
    gsSPNTrianglesInit_5b(
        10, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
