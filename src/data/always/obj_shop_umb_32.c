...
#include "assets/forestd/obj_shop_umb_32/obj_shop_umb_32_pal.inc"
};

static u8 obj_shop_umb_32_kasa1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_umb_32/obj_shop_umb_32_kasa1_tex_txt.inc"
};

static u8 obj_shop_umb_32_tuka1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_umb_32/obj_shop_umb_32_tuka1_tex_txt.inc"
};

Vtx tol_umb_32_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_umb_32/tol_umb_32_v.inc"
};

Gfx kasa_umb32_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx e_umb32_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, obj_shop_umb_32_pal),
