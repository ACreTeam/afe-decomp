...
#include "assets/forestd/obj_w_cedar3_trunk/obj_w_cedar_leaf_tex.inc"
};

u8 obj_w_cedar_young_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_w_cedar3_trunk/obj_w_cedar_young_tex.inc"
};

Vtx obj_w_cedar3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_cedar3_trunk/obj_w_cedar3_v.inc"
};

Gfx obj_w_cedar3_leafT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_cedar3_leafT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_cedar3_trunkT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx obj_w_cedar3_trunkT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
