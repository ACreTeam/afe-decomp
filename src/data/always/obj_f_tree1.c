...
#include "assets/forestd/obj_f_tree1/obj_f_tree_baby_tex.inc"
};

Vtx obj_f_tree1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_f_tree1/obj_f_tree1_v.inc"
};

Gfx obj_f_tree1T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_f_gold_tree1T_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 24, obj_f_tree_baby_tex),
...
Gfx obj_f_tree1T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
