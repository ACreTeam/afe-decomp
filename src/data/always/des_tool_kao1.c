...
#include "assets/forestd/des_tool_kao1/des_tool_kao1_tex.inc"
};

u8 des_tool_kao2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_tool_kao1/des_tool_kao2_tex.inc"
};

u8 des_tool_kao3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_tool_kao1/des_tool_kao3_tex.inc"
};

u8 des_tool_kao4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_tool_kao1/des_tool_kao4_tex.inc"
};

u8 des_tool_kao5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_tool_kao1/des_tool_kao5_tex.inc"
};

Vtx des_tool2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/des_tool_kao1/des_tool2_v.inc"
};

Gfx des_tool_kao1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_tool_kao2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_PASS, G_RM_AA_XLU_SURF2),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 70, 80, 50, 255),
...
Gfx des_tool_kao3T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_PASS, G_RM_AA_XLU_SURF2),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 70, 80, 50, 255),
...
Gfx des_tool_kao4T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_PASS, G_RM_AA_XLU_SURF2),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 70, 80, 50, 255),
...
Gfx des_tool_kao5T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_PASS, G_RM_AA_XLU_SURF2),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 70, 80, 50, 255),
...
Gfx des_tool_kao_all_model[] ATTRIBUTE_ALIGN(8) = {
