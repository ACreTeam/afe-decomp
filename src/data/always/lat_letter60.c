...
Vtx lat_letter60_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter60/lat_letter60_v.inc"
};

Gfx lat_letter60_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter60_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter60_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter60_model[] ATTRIBUTE_ALIGN(8) = {
