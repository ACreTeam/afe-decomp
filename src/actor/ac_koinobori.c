...
u8 aKOI_shadow_vtx_fix_flg_table[8] = { 1, 0, 0, 1, 1, 0, 0, 1 };

bIT_ShadowData_c aKOI_shadow_data = {
    8, aKOI_shadow_vtx_fix_flg_table, 60.0f, obj_e_koinobori_shadow_v, obj_e_koinobori_shadowT_model,
};
...
static void aKOI_actor_ct(ACTOR* actor, GAME* game) {
    ...
    cKF_SkeletonInfo_R_ct(&koinobori->structure_class.keyframe, &cKF_bs_r_obj_e_koinobori, NULL,
                          koinobori->structure_class.work_area, koinobori->structure_class.morph_area);
