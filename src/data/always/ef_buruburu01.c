...
#include "assets/forestd/ef_buruburu01/ef_buruburu01_0_int_i4.inc"
};

u8 ef_buruburu01_1_int_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/ef_buruburu01/ef_buruburu01_1_int_i4.inc"
};

Vtx ef_buruburu01_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_buruburu01/ef_buruburu01_00_v.inc"
};

Gfx ef_buruburu01_00_modelT[] ATTRIBUTE_ALIGN(8) = {
