...
#include "assets/forestd/ef_ase01_0/ef_ase01_0.inc"
};

Vtx ef_ase02_00_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_ase01_0/ef_ase02_00_v.inc"
};

Gfx ef_ase02_00_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Vtx ef_ase02_01_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_ase01_0/ef_ase02_01_v.inc"
};

Gfx ef_ase02_01_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Vtx ef_ase02_02_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_ase01_0/ef_ase02_02_v.inc"
};

Gfx ef_ase02_02_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
gsDPSetEnvColor(0, 0, 255, 255),
...
Vtx ef_ase02_03_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_ase01_0/ef_ase02_03_v.inc"
};

Gfx ef_ase02_03_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
gsDPSetEnvColor(0, 0, 255, 255),
