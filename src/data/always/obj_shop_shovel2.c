...
#include "assets/forestd/obj_shop_shovel2/obj_shop_shovel2_pal.inc"
};

u8 obj_shop_shovel2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_shovel2/obj_shop_shovel2_tex.inc"
};

Vtx obj_shop_shovel2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_shovel2/obj_shop_shovel2_v.inc"
};

Gfx obj_shovel2T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_shovel2T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
