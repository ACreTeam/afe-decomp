...
Vtx lat_letter45_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter45/lat_letter45_v.inc"
};

Gfx lat_letter45_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter45_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
