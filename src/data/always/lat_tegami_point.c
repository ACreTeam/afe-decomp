...
#include "assets/forestd/lat_tegami_point/lat_tegami_point_tex.inc"
};

Vtx lat_point_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_tegami_point/lat_point_v.inc"
};

Gfx lat_point_mT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
