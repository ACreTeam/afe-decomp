...
static void mSM_draw_item(GRAPH* graph, f32 pos_x, f32 pos_y, f32 scale, mActor_name_t item, int present_flag,
    ...
    static mSM_inventory_icon_info_c fish_tex_table[] = {
        { inv_mwin_01funa_pal, inv_mwin_01funa_tex }, // 0
        { inv_mwin_02masu_pal, inv_mwin_02masu_tex }, // 1
        { inv_mwin_03koi_pal, inv_mwin_03koi_tex }, // 2
        { inv_mwin_04nishiki_pal, inv_mwin_04nishiki_tex }, // 3
        { inv_mwin_07namazu_pal, inv_mwin_07namazu_tex }, // 4
        { inv_mwin_13bass_pal, inv_mwin_13bass_tex }, // 5
        { inv_mwin_14bassm_pal, inv_mwin_14bassm_tex }, // 6
        { inv_mwin_15bassl_pal, inv_mwin_15bassl_tex }, // 7
        { inv_mwin_12gill_pal, inv_mwin_12gill_tex }, // 8
        { inv_mwin_08oonamazu_pal, inv_mwin_08oonamazu_tex }, // 9
        { inv_mwin_16raigyo_pal, inv_mwin_16raigyo_tex }, // 10
        { inv_mwin_05nigoi_pal, inv_mwin_05nigoi_tex }, // 11
        { inv_mwin_06ugui_pal, inv_mwin_06ugui_tex }, // 12
        { inv_mwin_09oikawa_pal, inv_mwin_09oikawa_tex }, // 13
        { inv_mwin_10tanago_pal, inv_mwin_10tanago_tex }, // 14
        { inv_mwin_11dojyou_pal, inv_mwin_11dojyou_tex }, // 15
        { inv_mwin_19wakasagi_pal, inv_mwin_19wakasagi_tex }, // 16
        { inv_mwin_20ayu_pal, inv_mwin_20ayu_tex }, // 17
        { inv_mwin_21yamame_pal, inv_mwin_21yamame_tex }, // 18
        { inv_mwin_23iwana_pal, inv_mwin_23iwana_tex }, // 19
        { inv_mwin_22niji_pal, inv_mwin_22niji_tex }, // 20
        { inv_mwin_24itou_pal, inv_mwin_24itou_tex }, // 21
        { inv_mwin_25sake_pal, inv_mwin_25sake_tex }, // 22
        { inv_mwin_26kingyo_pal, inv_mwin_26kingyo_tex }, // 23
        { inv_mwin_30pirania_pal, inv_mwin_30pirania_tex }, // 24
        { inv_mwin_31aroana_pal, inv_mwin_31aroana_tex }, // 25
        { inv_mwin_17unagi_pal, inv_mwin_17unagi_tex }, // 26
        { inv_mwin_18donko_pal, inv_mwin_18donko_tex }, // 27
        { inv_mwin_29angel_pal, inv_mwin_29angel_tex }, // 28
        { inv_mwin_28gupi_pal, inv_mwin_28gupi_tex }, // 29
        { inv_mwin_27demekin_pal, inv_mwin_27demekin_tex }, // 30
        { inv_mwin_32kaseki_pal, inv_mwin_32kaseki_tex }, // 31
        { inv_mwin_33zarigani_pal, inv_mwin_33zarigani_tex }, // 32
        { inv_mwin_34kaeru_pal, inv_mwin_34kaeru_tex }, // 33
        { inv_mwin_35medaka_pal, inv_mwin_35medaka_tex }, // 34
        { inv_mwin_36kurage_pal, inv_mwin_36kurage_tex }, // 35
        { inv_mwin_37suzuki_pal, inv_mwin_37suzuki_tex }, // 36
    ...
    static mSM_inventory_icon_info_c insect_tex_table[] = {
        { inv_mwin_01monshiro_pal, inv_mwin_01monshiro_tex }, // 0
        { inv_mwin_02monki_pal, inv_mwin_02monki_tex }, // 1
        { inv_mwin_03kiageha_pal, inv_mwin_03kiageha_tex }, // 2
        { inv_mwin_04ohmurasaki_pal, inv_mwin_04ohmurasaki_tex }, // 3
        { inv_mwin_06minmin_pal, inv_mwin_06minmin_tex }, // 4
        { inv_mwin_07tukutuku_pal, inv_mwin_07tukutuku_tex }, // 5
        { inv_mwin_08higurashi_pal, inv_mwin_08higurashi_tex }, // 6
        { inv_mwin_05abura_pal, inv_mwin_05abura_tex }, // 7
        { inv_mwin_23hati_pal, inv_mwin_23hati_tex }, // 8
        { inv_mwin_10shiokara_pal, inv_mwin_10shiokara_tex }, // 9
        { inv_mwin_09akiakane_pal, inv_mwin_09akiakane_tex }, // 10
        { inv_mwin_11ginyanma_pal, inv_mwin_11ginyanma_tex }, // 11
        { inv_mwin_12oniyanma_pal, inv_mwin_12oniyanma_tex }, // 12
        { inv_mwin_20syouryou_pal, inv_mwin_20syouryou_tex }, // 13
        { inv_mwin_21tonosama_pal, inv_mwin_21tonosama_tex }, // 14
        { inv_mwin_13koorogi_pal, inv_mwin_13koorogi_tex }, // 15
        { inv_mwin_14kirigirisu_pal, inv_mwin_14kirigirisu_tex }, // 16
        { inv_mwin_16suzumushi_pal, inv_mwin_16suzumushi_tex }, // 17
        { inv_mwin_15matumushi_pal, inv_mwin_15matumushi_tex }, // 18
        { inv_mwin_25kanabun_pal, inv_mwin_25kanabun_tex }, // 19
        { inv_mwin_28kabuto_pal, inv_mwin_28kabuto_tex }, // 20
        { inv_mwin_29hirata_pal, inv_mwin_29hirata_tex }, // 21
        { inv_mwin_27tamamushi_pal, inv_mwin_27tamamushi_tex }, // 22
        { inv_mwin_26gomadara_pal, inv_mwin_26gomadara_tex }, // 23
        { inv_mwin_17tentou_pal, inv_mwin_17tentou_tex }, // 24
        { inv_mwin_18nanahoshi_pal, inv_mwin_18nanahoshi_tex }, // 25
        { inv_mwin_19kamakiri_pal, inv_mwin_19kamakiri_tex }, // 26
        { inv_mwin_24genji_pal, inv_mwin_24genji_tex }, // 27
        { inv_mwin_22danna_pal, inv_mwin_22danna_tex }, // 28
        { inv_mwin_30nokogiri_pal, inv_mwin_30nokogiri_tex }, // 29
        { inv_mwin_31miyama_pal, inv_mwin_31miyama_tex }, // 30
        { inv_mwin_32okuwa_pal, inv_mwin_32okuwa_tex }, // 31
        { inv_mwin_33maimai_pal, inv_mwin_33maimai_tex }, // 32
        { inv_mwin_34kera_pal, inv_mwin_34kera_tex }, // 33
        { inv_mwin_35amenbo_pal, inv_mwin_35amenbo_tex }, // 34
        { inv_mwin_36mino_pal, inv_mwin_36mino_tex }, // 35
        { inv_mwin_37dango_pal, inv_mwin_37dango_tex }, // 36
        ...
        { inv_mwin_hitodama_pal, inv_mwin_hitodama4_tex }, // 43
        { inv_mwin_hitodama_pal, inv_mwin_hitodama5_tex }, // 44
    };
    // clang-format on
