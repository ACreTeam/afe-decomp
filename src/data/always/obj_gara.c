...
u16 obj_gara_pal[] = {
#include "assets/forestd/obj_gara/obj_gara_pal.inc"
};

u8 obj_gara_tex_txt[] = {
#include "assets/forestd/obj_gara/obj_gara_tex_txt.inc"
};

Vtx obj_gara_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_gara/obj_gara_v.inc"
};

Gfx obj_gara_base_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_gara_hex_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
u8 cKF_ckcb_r_obj_gara_tbl[] = {
0,
0,
1
};

s16 cKF_kn_obj_gara_tbl[] = {
10
};

s16 cKF_c_obj_gara_tbl[] = {
0,
0,
0,
0,
...
#include "assets/forestd/obj_gara/act_fukuball_pal.inc"
};

u8 act_fukutama1_tex[] = {
#include "assets/forestd/obj_gara/act_fukutama1_tex.inc"
};

u8 act_fukutama2_tex[] = {
#include "assets/forestd/obj_gara/act_fukutama2_tex.inc"
};

u8 act_fukutama3_tex[] = {
#include "assets/forestd/obj_gara/act_fukutama3_tex.inc"
};

u8 act_fukutama4_tex[] = {
#include "assets/forestd/obj_gara/act_fukutama4_tex.inc"
};

Vtx act_fukutama_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_gara/act_fukutama_v.inc"
};

Gfx act_fukutama_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
