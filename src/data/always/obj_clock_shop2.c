...
#include "assets/forestd/obj_clock_shop2/obj_clock_shop2_pal.inc"
};

u8 obj_clock_shop2_body_tex_txt[] = {
#include "assets/forestd/obj_clock_shop2/obj_clock_shop2_body_tex_txt.inc"
};

Vtx obj_clock_shop2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_clock_shop2/obj_clock_shop2_v.inc"
};

Gfx obj_clock_shop2_body_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_clock_shop2_long_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
Gfx obj_clock_shop2_short_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
u8 cKF_ckcb_r_obj_clock_shop2_tbl[] = {
0,
0,
0,
0,
...
cKF_Animation_R_c cKF_ba_r_obj_clock_shop2 = 
	{ cKF_ckcb_r_obj_clock_shop2_tbl, NULL, NULL, cKF_c_obj_clock_shop2_tbl, -1, 100 }
;
...
cKF_Skeleton_R_c cKF_bs_r_obj_clock_shop2 = 
	{ ARRAY_COUNT(cKF_je_r_obj_clock_shop2_tbl), 3, cKF_je_r_obj_clock_shop2_tbl }
;
