...
Vtx lat_letter38_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter38/lat_letter38_v.inc"
};

Gfx lat_letter38_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter38_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
