...
u8 act_m_hirata_txt[] = {
#include "assets/forestd/act_m_hirata_b_005BB088/act_m_hirata_txt.inc"
};

Vtx act_m_hirata_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_hirata_b_005BB088/act_m_hirata_b_v.inc"
};

Gfx act_m_hirata_b_left_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_hirata_b_right_model[] ATTRIBUTE_ALIGN(8) = {
gsSPMatrix(anime_6_mdl, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
Gfx act_m_hirata_b_base_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
cKF_Skeleton_R_c cKF_bs_r_act_m_hirata_b = 
	{ ARRAY_COUNT(cKF_je_r_act_m_hirata_b_tbl), 3, cKF_je_r_act_m_hirata_b_tbl }
;
