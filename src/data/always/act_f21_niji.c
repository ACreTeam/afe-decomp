...
#include "assets/forestd/act_f21_niji/act_f21_niji_pal.inc"
};

u8 act_f21_niji_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f21_niji/act_f21_niji_tex.inc"
};

Vtx act_f21_niji_a_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f21_niji/act_f21_niji_a_v.inc"
};

Gfx act_f21_niji_aT_model[] ATTRIBUTE_ALIGN(8) = {
...
Vtx act_f21_niji_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f21_niji/act_f21_niji_b_v.inc"
};

Gfx act_f21_niji_bT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, act_f21_niji_pal),
...
Vtx act_f21_niji_c_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f21_niji/act_f21_niji_c_v.inc"
};

Gfx act_f21_niji_cT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, act_f21_niji_pal),
