...
Vtx lat_letter35_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter35/lat_letter35_v.inc"
};

Gfx lat_letter35_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter35_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
