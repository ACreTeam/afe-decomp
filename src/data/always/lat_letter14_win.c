...
Vtx lat_letter14_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter14_win/lat_letter14_v.inc"
};

Gfx lat_letter14_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter14_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter14_model[] ATTRIBUTE_ALIGN(8) = {
