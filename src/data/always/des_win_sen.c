...
#include "assets/forestd/des_win_sen/des_win_sen_tex.inc"
};

u8 des_win_kirikae_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_kirikae_tex.inc"
};

u8 des_win_cwaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_cwaku_tex.inc"
};

u8 des_win_aw1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw1_tex.inc"
};

u8 des_win_aw2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw2_tex.inc"
};

u8 des_win_aw3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw3_tex.inc"
};

u8 des_win_aw4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw4_tex.inc"
};

u8 des_win_aw5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw5_tex.inc"
};

u8 des_win_aw6_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw6_tex.inc"
};

u8 des_win_aw7_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw7_tex.inc"
};

u8 des_win_aw8_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_aw8_tex.inc"
};

u8 des_win_color_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_color_tex.inc"
};

u8 des_win_start_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/des_win_start_tex.inc"
};

static u8 lat_sousa_yame_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_win_sen/lat_sousa_yame_tex.inc"
};

Vtx des_win_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/des_win_sen/des_win_v.inc"
};

u8 des_win_before[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/des_win_sen/des_win_before.inc"
};

Gfx des_win_area1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_win_area2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&des_win_v[4], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx des_win_area3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&des_win_v[8], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx des_win_area4_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&des_win_v[12], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx des_win_waku_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_win_toubai_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx des_win_main_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx des_win_grid_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx des_win_color_before_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_win_color_model[] ATTRIBUTE_ALIGN(8) = {
gsSPVertex(&des_win_v[36], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 1, 3, 2, 0, 0, 0),
gsSPEndDisplayList(),
};

Gfx des_win_waku2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 60, 60, 255),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx des_win_shikiri_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_PASS, G_RM_AA_XLU_SURF2),
...
Gfx des_win_grid2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, PRIMITIVE, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx des_win_shitaT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx des_win_kirikaeT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx des_win_startT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx des_win_owariT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx des_win_before_model[] ATTRIBUTE_ALIGN(8) = {
gsSPDisplayList(des_win_before),
gsSPDisplayList(des_win_shitaT_model),
gsSPEndDisplayList(),
};

Gfx des_win_before_model_2[] ATTRIBUTE_ALIGN(8) = {
