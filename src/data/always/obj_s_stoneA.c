...
#include "assets/forestd/obj_s_stoneA/obj_s_stoneA_pal.inc"
};

u8 obj_s_stoneA_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_s_stoneA/obj_s_stoneA_tex.inc"
};

Vtx obj_s_stoneA_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_stoneA/obj_s_stoneA_v.inc"
};

Gfx obj_s_stoneA_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_stoneA_gfx_model[] ATTRIBUTE_ALIGN(8) = {
