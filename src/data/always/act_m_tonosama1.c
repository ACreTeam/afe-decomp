...
#include "assets/forestd/act_m_tonosama1/act_m_tonosama_pal.inc"
};

static u8 act_m_tonosama[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_tonosama1/act_m_tonosama.inc"
};

static Vtx act_m_tonosama_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_tonosama1/act_m_tonosama_v.inc"
};

Gfx act_m_tonosama1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_tonosama2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
