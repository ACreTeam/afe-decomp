...
#include "assets/forestd/crw_hat1/crw_hat1_pal.inc"
};

u8 crw_hat1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_hat1/crw_hat1_tex_txt.inc"
};

u8 crw_hat2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_hat1/crw_hat2_tex_txt.inc"
};

u8 crw_hat3_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_hat1/crw_hat3_tex_txt.inc"
};

Vtx crw_hat1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_hat1/crw_hat1_v.inc"
};

Gfx crw_hat1_body_model[] ATTRIBUTE_ALIGN(8) = {
