...
#include "assets/forestd/crw_anrium1/crw_anrium1_pal.inc"
};

u8 crw_anrium1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_anrium1/crw_anrium1_tex_txt.inc"
};

u8 crw_anrium2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_anrium1/crw_anrium2_tex_txt.inc"
};

Vtx crw_anrium1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_anrium1/crw_anrium1_v.inc"
};

Gfx crw_anrium1_body_model[] ATTRIBUTE_ALIGN(8) = {
