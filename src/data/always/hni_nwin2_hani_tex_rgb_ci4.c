...
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_nwin2_hani_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita7_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita7_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita1_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita1_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita2_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita2_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita3_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita3_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita4_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita4_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita5_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita5_tex_rgb_ci4_pal.inc"
};

u16 hni_win_shita6_tex_rgb_ci4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita6_tex_rgb_ci4_pal.inc"
};

static u8 inv_mwin_nwaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/inv_mwin_nwaku_tex.inc"
};

static u8 hni_nwin2_w_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_nwin2_w_tex.inc"
};

u8 hni_win_ue1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue1_tex.inc"
};

u8 hni_win_ue2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue2_tex.inc"
};

u8 hni_win_ue3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue3_tex.inc"
};

u8 hni_win_ue4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue4_tex.inc"
};

u8 hni_win_ue5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue5_tex.inc"
};

u8 hni_win_ue6_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue6_tex.inc"
};

u8 hni_win_ue7_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_ue7_tex.inc"
};

static u8 inv_mwin_3Dma_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/inv_mwin_3Dma_tex.inc"
};

u8 hni_nwin2_hani_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_nwin2_hani_tex_rgb_ci4.inc"
};

u8 hni_win_shita7_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita7_tex_rgb_ci4.inc"
};

u8 hni_win_shita1_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita1_tex_rgb_ci4.inc"
};

u8 hni_win_shita2_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita2_tex_rgb_ci4.inc"
};

u8 hni_win_shita3_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita3_tex_rgb_ci4.inc"
};

u8 hni_win_shita4_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita4_tex_rgb_ci4.inc"
};

u8 hni_win_shita5_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita5_tex_rgb_ci4.inc"
};

u8 hni_win_shita6_tex_rgb_ci4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_shita6_tex_rgb_ci4.inc"
};

Vtx hni_win_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/hni_nwin2_hani_tex_rgb_ci4/hni_win_v.inc"
};

Gfx hni_win_w13_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_nwin2_winT_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_nwin2_win2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0),
...
Gfx hni_nwin_3DmT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx hni_nwin2_wakuT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0),
...
Gfx hni_win_w1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_win_w2T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_win_w3T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_win_w4T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_win_w5T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_win_w6T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx hni_win_w7T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, hni_win_shita1_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, hni_win_shita1_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx hni_win_w8T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, hni_win_shita2_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, hni_win_shita2_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx hni_win_w9T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, hni_win_shita3_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, hni_win_shita3_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx hni_win_w10T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, hni_win_shita5_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, hni_win_shita5_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx hni_win_w11T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, hni_win_shita6_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, hni_win_shita6_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx hni_win_w12T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPLoadTLUT_Dolphin(15, 16, 1, hni_win_shita4_tex_rgb_ci4_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, hni_win_shita4_tex_rgb_ci4),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 1, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
...
Gfx hni_win_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
gsDPSetOtherMode(G_AD_NOTPATTERN | G_CD_MAGICSQ | G_CK_NONE | G_TC_FILT | G_TF_BILERP | G_TT_RGBA16 | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_2CYCLE | G_PM_NPRIMITIVE, G_AC_NONE | G_ZS_PIXEL | AA_EN | Z_UPD | IM_RD | CLR_ON_CVG | CVG_DST_WRAP | ZMODE_OPA | FORCE_BL | G_RM_PASS | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA)),
gsDPSetRenderMode(AA_EN | Z_UPD | IM_RD | CLR_ON_CVG | CVG_DST_WRAP | ZMODE_OPA | FORCE_BL | G_RM_PASS, AA_EN | Z_UPD | IM_RD | CLR_ON_CVG | CVG_DST_WRAP | ZMODE_OPA | FORCE_BL | GBL_c2(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_1MA)),
...
Gfx hni_win_modelT[] ATTRIBUTE_ALIGN(8) = {
