...
#include "assets/forestd/act_f28_akikan/act_f28_akikan_pal.inc"
};

u8 act_f28_akikan_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f28_akikan/act_f28_akikan_tex.inc"
};

Vtx act_f28_akikan_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f28_akikan/act_f28_akikan_v.inc"
};

Gfx act_f28_akikanT_model[] ATTRIBUTE_ALIGN(8) = {
