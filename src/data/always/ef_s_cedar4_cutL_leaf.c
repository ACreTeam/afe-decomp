...
Vtx ef_s_cedar4_cutL_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_s_cedar4_cutL_leaf/ef_s_cedar4_cutL_v.inc"
};

Gfx ef_s_cedar4_cutL_leaf_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_s_cedar4_cutL_trunk_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_s_cedar4_cutL = 
	{ ARRAY_COUNT(cKF_je_r_ef_s_cedar4_cutL_tbl), 2, cKF_je_r_ef_s_cedar4_cutL_tbl }
;
