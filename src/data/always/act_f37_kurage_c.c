...
#include "assets/forestd/act_f37_kurage_c/act_f37_kurage_pal.inc"
};

u8 act_f37_kurage_head_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f37_kurage_c/act_f37_kurage_head_tex.inc"
};

u8 act_f37_kurage_foot_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_f37_kurage_c/act_f37_kurage_foot_tex.inc"
};

Vtx act_f37_kurage_a_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f37_kurage_c/act_f37_kurage_a_v.inc"
};

Gfx act_f37_kurage_aT_model[] ATTRIBUTE_ALIGN(8) = {
...
Vtx act_f37_kurage_b_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f37_kurage_c/act_f37_kurage_b_v.inc"
};

Gfx act_f37_kurage_bT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Vtx act_f37_kurage_c_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_f37_kurage_c/act_f37_kurage_c_v.inc"
};

Gfx act_f37_kurage_cT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, act_f37_kurage_pal),
