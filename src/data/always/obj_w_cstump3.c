...
Vtx obj_w_cstump3_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_w_cstump3/obj_w_cstump3_v.inc"
};

Gfx obj_w_cstump3T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_w_cstump3T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
