...
#include "assets/forestd/act_ant/act_ant_tex.inc"
};

Vtx act_ant_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_ant/act_ant_v.inc"
};

Gfx act_antT_model[] ATTRIBUTE_ALIGN(8) = {
