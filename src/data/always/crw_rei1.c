...
#include "assets/forestd/crw_rei1/crw_rei1_pal.inc"
};

u8 crw_rei1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/crw_rei1/crw_rei1_tex_txt.inc"
};

Vtx crw_rei1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/crw_rei1/crw_rei1_v.inc"
};

Gfx crw_rei1_body_model[] ATTRIBUTE_ALIGN(8) = {
