...
Vtx lat_letter61_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter61/lat_letter61_v.inc"
};

Gfx lat_letter61_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter61_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
