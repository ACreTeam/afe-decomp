...
#include "assets/forestd/obj_f_honeycomb/obj_f_honeycomb_pal.inc"
};

u8 obj_f_honeycomb_tex[] = {
#include "assets/forestd/obj_f_honeycomb/obj_f_honeycomb_tex.inc"
};

Vtx obj_f_honeycomb_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_f_honeycomb/obj_f_honeycomb_v.inc"
};

Gfx obj_f_honeycombT_mat_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx obj_f_honeycombT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
