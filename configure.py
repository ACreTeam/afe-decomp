...
config.libs = [
    JSystemLib(
        ...
        [
            ...
            Object(NonMatching, "JSystem/JUtility/fs_vara.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            ...
            Object(NonMatching, "JSystem/JUtility/fs_drv.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/time.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            ...
            Object(NonMatching, "JSystem/JUtility/fs_open.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_read.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_close.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_seek.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_dele.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            ...
            Object(NonMatching, "JSystem/JUtility/fs_cldr.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_mkdr.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_renm.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_write.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_chdr.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_getps.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
            Object(NonMatching, "JSystem/JUtility/fs_cardrst.c", mw_version="GC/1.2.5n", cflags=[*cflags_base, "-inline all"]),
