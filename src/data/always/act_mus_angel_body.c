...
#include "assets/forestd/act_mus_angel_body/act_mus_angel_body_txt.inc"
};

Vtx act_mus_angel_a1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_angel_body/act_mus_angel_a1_v.inc"
};

Gfx act_mus_angel_sakana_body_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_mus_angel_sakana_head_model[] ATTRIBUTE_ALIGN(8) = {
gsDPSetTextureImage_Dolphin(G_IM_FMT_RGBA, G_IM_SIZ_16b, 48, 32, act_mus_angel_body_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 0, GX_CLAMP, GX_CLAMP, 0, 0),
...
cKF_Skeleton_R_c cKF_bs_r_act_mus_angel_a1 = 
	{ ARRAY_COUNT(cKF_je_r_act_mus_angel_a1_tbl), 2, cKF_je_r_act_mus_angel_a1_tbl }
;
