...
#include "assets/forestd/act_m_koorogi1/act_m_koorogi_pal.inc"
};

static u8 act_m_koorogi[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_koorogi1/act_m_koorogi.inc"
};

static Vtx act_m_koorogi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_koorogi1/act_m_koorogi_v.inc"
};

Gfx act_m_koorogi1T_model[] ATTRIBUTE_ALIGN(8) = {
