...
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_pal.inc"
};

u16 rom_shop1_w_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_w_pal.inc"
};

u16 rom_shop1_f_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_f_pal.inc"
};

static u16 rom_shop_kouhaku_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop_kouhaku_pal.inc"
};

static u8 rom_shop1_table_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_table_tex.inc"
};

static u8 rom_shop1_window_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_window_tex.inc"
};

static u8 rom_shop1_shadow_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_shadow_tex.inc"
};

u8 rom_shop1_w1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_w1_tex.inc"
};

u8 rom_shop1_w2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_w2_tex.inc"
};

u8 rom_shop1_f1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_f1_tex.inc"
};

u8 rom_shop1_f2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_f2_tex.inc"
};

u8 rom_shop1_f3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_f3_tex.inc"
};

u8 rom_shop1_f4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_f4_tex.inc"
};

static u8 rom_shop_kouhaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop_kouhaku_tex.inc"
};

Vtx rom_shop1_fuku_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop_kouhaku_0067A4A0/rom_shop1_fuku_v.inc"
};

Gfx rom_shop1_fuku_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_shop1_fuku_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
