...
Vtx lat_letter08_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter08/lat_letter08_v.inc"
};

Gfx lat_letter08_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter08_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter08_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0),
...
Gfx lat_letter08_model[] ATTRIBUTE_ALIGN(8) = {
