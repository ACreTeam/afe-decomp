...
#include "assets/forestd/act_mus_nomi_body_005C26E0/int_ike_nomi_pal.inc"
};

static u8 act_mus_nomi_body[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_mus_nomi_body_005C26E0/act_mus_nomi_body.inc"
};

static Vtx act_m_nomi_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_mus_nomi_body_005C26E0/act_m_nomi_v.inc"
};

Gfx act_m_mu_nomi1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_nomi2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_ZB_XLU_SURF2),
gsDPLoadTLUT_Dolphin(15, 16, 1, int_ike_nomi_pal),
