...
#include "assets/forestd/obj_myhome_step_down/obj_myhome_step_pal.inc"
};

u8 obj_myhome_step_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_myhome_step_down/obj_myhome_step_tex.inc"
};

Vtx obj_myhome_step_down_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_myhome_step_down/obj_myhome_step_down_v.inc"
};

Gfx obj_myhome_step_down_model[] ATTRIBUTE_ALIGN(8) = {
