...
#include "assets/forestd/ef_shadow_out/ef_shadow_out_0_int_i4.inc"
};

u8 ef_shadow_out_1_int_i4[] = {
#include "assets/forestd/ef_shadow_out/ef_shadow_out_1_int_i4.inc"
};

Vtx ef_shadow_out_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_shadow_out/ef_shadow_out_v.inc"
};

Gfx ef_shadow_out_modelT[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_16b, 0, 32, G_TX_LOADTILE, 0, G_TX_MIRROR | G_TX_WRAP, 4, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_CLAMP, 5, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 127, 1024),
gsDPPipeSync(),
gsDPSetTile(G_IM_FMT_I, G_IM_SIZ_4b, 2, 32, 1, 15, G_TX_MIRROR | G_TX_WRAP, 4, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_CLAMP, 5, G_TX_NOLOD),
