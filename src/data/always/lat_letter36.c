...
Vtx lat_letter36_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter36/lat_letter36_v.inc"
};

Gfx lat_letter36_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter36_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
