...
#include "assets/forestd/des_cursor_kao1/des_cursor_kao1_tex.inc"
};

u8 des_cursor_kao2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor_kao1/des_cursor_kao2_tex.inc"
};

u8 des_cursor_kao3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor_kao1/des_cursor_kao3_tex.inc"
};

u8 des_cursor_kao4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor_kao1/des_cursor_kao4_tex.inc"
};

u8 des_cursor_kao5_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor_kao1/des_cursor_kao5_tex.inc"
};

Vtx des_cursor2_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/des_cursor_kao1/des_cursor2_v.inc"
};

Gfx des_cursor_kao4_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_cursor_kao5_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx des_cursor_kao1T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx des_cursor_kao2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetEnvColor(235, 235, 225, 255),
...
Gfx des_cursor_kao3T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetEnvColor(235, 235, 225, 255),
