...
Vtx rom_shop4_2f_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop4_2f/rom_shop4_2f_v.inc"
};

Gfx rom_shop4_2f_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPEndDisplayList(),
};

Gfx rom_shop4_2f_model[] ATTRIBUTE_ALIGN(8) = {
