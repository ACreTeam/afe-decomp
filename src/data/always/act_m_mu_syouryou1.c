...
static Vtx act_m_syouryou_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_syouryou1/act_m_syouryou_v.inc"
};

static u16 act_m_syouryou_pal[] = {
#include "assets/forestd/act_m_mu_syouryou1/act_m_syouryou_pal.inc"
};

static u8 act_m_syouryou[] = {
#include "assets/forestd/act_m_mu_syouryou1/act_m_syouryou.inc"
};

Gfx act_m_mu_syouryou1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_mu_syouryou2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
gsDPPipeSync(),
