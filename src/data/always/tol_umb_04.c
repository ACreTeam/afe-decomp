...
#include "assets/forestd/tol_umb_04/tol_umb_04_pal.inc"
};

u8 tol_umb_04_kasa1_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_umb_04/tol_umb_04_kasa1_tex_txt.inc"
};

u8 tol_umb_04_kasa2_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_umb_04/tol_umb_04_kasa2_tex_txt.inc"
};

u8 tol_umb_04_tuka_tex_txt[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_umb_04/tol_umb_04_tuka_tex_txt.inc"
};

Vtx tol_umb_04_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_umb_04/tol_umb_04_v.inc"
};

Gfx kasa_umb04_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx e_umb04_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTLUT_Dolphin(15, 16, 1, tol_umb_04_pal),
