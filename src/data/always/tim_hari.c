...
u16 tim_hari_h1_pal[] = {
#include "assets/forestd/tim_hari/tim_hari_h1_pal.inc"
};

u16 tim_hari_h2_pal[] = {
#include "assets/forestd/tim_hari/tim_hari_h2_pal.inc"
};

u16 tim_hari_maru_pal[] = {
#include "assets/forestd/tim_hari/tim_hari_maru_pal.inc"
};

u8 tim_hari_h1_tex[] = {
#include "assets/forestd/tim_hari/tim_hari_h1_tex.inc"
};

u8 tim_hari_h2_tex[] = {
#include "assets/forestd/tim_hari/tim_hari_h2_tex.inc"
};

u8 tim_hari_maru_tex[] = {
#include "assets/forestd/tim_hari/tim_hari_maru_tex.inc"
};

Vtx tim_hari_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tim_hari/tim_hari_v.inc"
};

Gfx tim_hari_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx tim_hari_b1T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_MIRROR | G_TX_WRAP, 6, G_TX_NOLOD, G_TX_MIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
gsDPLoadSync(),
gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 511, 1024),
gsDPPipeSync(),
gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 2, 0, G_TX_RENDERTILE, 15, G_TX_MIRROR | G_TX_WRAP, 6, G_TX_NOLOD, G_TX_MIRROR | G_TX_WRAP, 5, G_TX_NOLOD),
...
Gfx tim_hari_b2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx tim_hari_b3T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
