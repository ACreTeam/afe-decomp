...
#include "assets/forestd/obj_s_spstump5/obj_s_palm_stump_tex.inc"
};

Vtx obj_s_pstump5_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_s_spstump5/obj_s_pstump5_v.inc"
};

Gfx obj_s_spstump5T_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_s_spstump5T_gfx_model[] ATTRIBUTE_ALIGN(8) = {
