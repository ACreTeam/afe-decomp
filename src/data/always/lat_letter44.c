...
Vtx lat_letter44_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter44/lat_letter44_v.inc"
};

Gfx lat_letter44_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter44_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
