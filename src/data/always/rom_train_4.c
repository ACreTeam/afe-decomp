...
#include "assets/forestd/rom_train_4/rom_train_4_pal.inc"
};

static u16 rom_train_3_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_3_pal.inc"
};

u8 rom_train_bgtree_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_bgtree_tex.inc"
};

u8 rom_train_bgsky_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_bgsky_tex.inc"
};

u8 rom_train_tunnel_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_tunnel_tex.inc"
};

u8 rom_train_bgcloud_tex_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_bgcloud_tex_rgb_i4.inc"
};

u8 rom_train_glass_tex_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_glass_tex_rgb_i4.inc"
};

u8 rom_train_shine_tex_rgb_i4[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_train_4/rom_train_shine_tex_rgb_i4.inc"
};

Vtx rom_train_out_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_train_4/rom_train_out_v.inc"
};

Gfx rom_train_out_bgcloud_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, 0, PRIM_LOD_FRAC, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
...
Gfx rom_train_out_bgtree_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, 0, PRIM_LOD_FRAC, ENVIRONMENT, 0, 0, 0, TEXEL0, TEXEL1, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
Gfx rom_train_out_shineglass_modelT[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx rom_train_out_tunnel_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, 0, PRIM_LOD_FRAC, ENVIRONMENT, 0, 0, 0, TEXEL0, TEXEL1, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
Gfx rom_train_out_bgsky_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
