...
Vtx lat_letter18_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter18/lat_letter18_v.inc"
};

Gfx lat_letter18_win_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter18_winT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter18_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter18_model[] ATTRIBUTE_ALIGN(8) = {
