...
#include "assets/forestd/tol_rope_1_shadow/tol_rope_1_shadow_tex.inc"
};

Vtx tol_rope_1_shadow_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_rope_1_shadow/tol_rope_1_shadow_v.inc"
};

Gfx tol_rope_1_shadowT_model[] ATTRIBUTE_ALIGN(8) = {
