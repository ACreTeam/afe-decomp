...
Vtx clk_min10_a_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/clk_min10_a/clk_min10_a_v.inc"
};

Gfx clk_min10_aT_model[] ATTRIBUTE_ALIGN(8) = {
