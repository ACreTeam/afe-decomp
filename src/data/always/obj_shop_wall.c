...
#include "assets/forestd/obj_shop_wall/obj_shop_wall_pal.inc"
};

u8 obj_shop_wall_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_wall/obj_shop_wall_tex.inc"
};

Vtx obj_shop_wall_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_wall/obj_shop_wall_v.inc"
};

Gfx obj_wallT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_wallT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
