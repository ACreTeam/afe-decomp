...
#include "assets/forestd/obj_shop_honegai/obj_shop_honegai_pal.inc"
};

u8 obj_shop_honegai_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_honegai/obj_shop_honegai_tex.inc"
};

Vtx obj_shop_honegai_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_honegai/obj_shop_honegai_v.inc"
};

Gfx obj_honegaiT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_honegaiT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
