...
u16 act_ball_s_pal[] = {
#include "assets/forestd/act_ball_s/act_ball_s_pal.inc"
};

u8 act_ball_s_5_tex[] = {
#include "assets/forestd/act_ball_s/act_ball_s_5_tex.inc"
};

Vtx act_ball_s_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_ball_s/act_ball_s_v.inc"
};

Gfx act_ball_s_model[] ATTRIBUTE_ALIGN(8) = {
