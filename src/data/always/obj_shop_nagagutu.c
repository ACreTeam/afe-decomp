...
#include "assets/forestd/obj_shop_nagagutu/obj_shop_akican_pal.inc"
};

u8 obj_shop_nagagutu_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_shop_nagagutu/obj_shop_nagagutu_tex.inc"
};

Vtx obj_shop_nagagutu_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_shop_nagagutu/obj_shop_nagagutu_v.inc"
};

Gfx obj_nagagutuT_mat_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx obj_nagagutuT_gfx_model[] ATTRIBUTE_ALIGN(8) = {
