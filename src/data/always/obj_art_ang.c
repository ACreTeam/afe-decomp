...
#include "assets/forestd/obj_art_ang/obj_art_ang_pal.inc"
};

u8 obj_art_ang_gaku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_ang/obj_art_ang_gaku_tex.inc"
};

u8 obj_art_ang_art_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_ang/obj_art_ang_art_tex.inc"
};

u8 obj_art_ang_name_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/obj_art_ang/obj_art_ang_name_tex.inc"
};

Vtx obj_art02_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/obj_art_ang/obj_art02_v.inc"
};

Gfx obj_art02_model[] ATTRIBUTE_ALIGN(8) = {
