...
#include "assets/forestd/rom_shop1_tubo/rom_shop1_pal.inc"
};

u16 rom_shop1_tubo_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop1_tubo/rom_shop1_tubo_pal.inc"
};

static u8 rom_shop1_table_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop1_tubo/rom_shop1_table_tex.inc"
};

static u8 rom_shop1_window_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop1_tubo/rom_shop1_window_tex.inc"
};

static u8 rom_shop1_shadow_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop1_tubo/rom_shop1_shadow_tex.inc"
};

u8 rom_shop1_tubo_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop1_tubo/rom_shop1_tubo_tex.inc"
};

Vtx rom_shop1w_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop1_tubo/rom_shop1w_v.inc"
};

Gfx rom_shop1w_modelT[] ATTRIBUTE_ALIGN(8) = {
...
Gfx rom_shop1w_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
