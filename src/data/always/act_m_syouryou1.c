...
#include "assets/forestd/act_m_syouryou1/act_m_syouryou_pal.inc"
};

static u8 act_m_syouryou[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_syouryou1/act_m_syouryou.inc"
};

static Vtx act_m_syouryou_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_syouryou1/act_m_syouryou_v.inc"
};

Gfx act_m_syouryou1T_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx act_m_syouryou2_2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
