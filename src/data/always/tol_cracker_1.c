...
#include "assets/forestd/tol_cracker_1/tol_cracker_1_pal.inc"
};

static u8 tol_cracker_1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/tol_cracker_1/tol_cracker_1_tex.inc"
};

static Vtx tol_cracker_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/tol_cracker_1/tol_cracker_1_v.inc"
};

Gfx tol_cracker_1T_model[] ATTRIBUTE_ALIGN(8) = {
