...
#include "assets/forestd/san_itemw_waku/san_itemw_waku_tex.inc"
};

u8 sen_itemw_kage_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/san_itemw_waku/sen_itemw_kage_tex.inc"
};

static u8 sen_itemw_yaji_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/san_itemw_waku/sen_itemw_yaji_tex.inc"
};

static u8 sen_itemw_yaji2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/san_itemw_waku/sen_itemw_yaji2_tex.inc"
};

Vtx sen_itemw_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/san_itemw_waku/sen_itemw_v.inc"
};

Gfx sen_item2_DL_mode[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx sen_itemw_kage_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx sen_itemw_yajirushi_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx sen_itemw_wakuT_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx sen_itemw_yajirushi2T_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0),
