...
#include "assets/forestd/des_cursor/des_cursor_undo_tex.inc"
};

u8 des_cursor_sp_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_sp_tex.inc"
};

u8 des_cursor_sen_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_sen_tex.inc"
};

u8 des_cursor_pen_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_pen_tex.inc"
};

u8 des_cursor_nuri_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_nuri_tex.inc"
};

u8 des_cursor_mark1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_mark1_tex.inc"
};

u8 des_cursor_mark2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_mark2_tex.inc"
};

u8 des_cursor_mark3_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_mark3_tex.inc"
};

u8 des_cursor_mark4_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_mark4_tex.inc"
};

u8 des_cursor_waku_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/des_cursor/des_cursor_waku_tex.inc"
};

Vtx des_cursor_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/des_cursor/des_cursor_v.inc"
};

Gfx des_cursor_mark1_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx des_cursor_mark2_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx des_cursor_mark3_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx des_cursor_mark4_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx des_cursor_undo_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(0, 0, 0, PRIMITIVE, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetRenderMode(G_RM_PASS, G_RM_XLU_SURF2),
...
Gfx des_cursor_penT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
Gfx des_cursor_nuriT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetEnvColor(235, 235, 225, 255),
...
Gfx des_cursor_waku1T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetEnvColor(235, 235, 225, 255),
...
Gfx des_cursor_waku2T_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetEnvColor(235, 235, 225, 255),
...
Gfx des_cursor_spT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
gsDPSetEnvColor(235, 235, 225, 255),
...
Gfx des_cursor_wakuT_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
gsDPSetPrimColor(0, 255, 60, 70, 60, 255),
