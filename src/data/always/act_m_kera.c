...
#include "assets/forestd/act_m_kera/act_m_kera_pal.inc"
};

static u8 act_m_kera_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/act_m_kera/act_m_kera_tex.inc"
};

static Vtx act_m_kera_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_kera/act_m_kera_v.inc"
};

Gfx act_m_keraT_model[] ATTRIBUTE_ALIGN(8) = {
