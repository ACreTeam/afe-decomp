...
Vtx lat_letter22_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/lat_letter22/lat_letter22_v.inc"
};

Gfx lat_letter22_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
...
Gfx lat_letter22_sen_model[] ATTRIBUTE_ALIGN(8) = {
gsDPPipeSync(),
