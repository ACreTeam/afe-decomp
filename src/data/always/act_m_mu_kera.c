...
static Vtx act_m_kera_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/act_m_mu_kera/act_m_kera_v.inc"
};

static u16 act_m_kera_pal[] = {
#include "assets/forestd/act_m_mu_kera/act_m_kera_pal.inc"
};

static u8 act_m_kera_tex[] = {
#include "assets/forestd/act_m_mu_kera/act_m_kera_tex.inc"
};

Gfx act_m_mu_keraT_model[] ATTRIBUTE_ALIGN(8) = {
