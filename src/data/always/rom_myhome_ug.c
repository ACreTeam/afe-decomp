...
#include "assets/forestd/rom_myhome_ug/rom_myhome_ug_pal.inc"
};

static u16 rom_myhome_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome_ug/rom_myhome_pal.inc"
};

u8 rom_myhome_ugf1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome_ug/rom_myhome_ugf1_tex.inc"
};

static u8 rom_myhome_enter2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome_ug/rom_myhome_enter2_tex.inc"
};

u8 rom_myhome_ugw1_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome_ug/rom_myhome_ugw1_tex.inc"
};

u8 rom_myhome_ugw2_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_myhome_ug/rom_myhome_ugw2_tex.inc"
};

Vtx rom_myhome_ug_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_myhome_ug/rom_myhome_ug_v.inc"
};

Gfx rom_myhome_ug_model[] ATTRIBUTE_ALIGN(8) = {
