...
extern Gfx ef_w_cedar_leaf_modeset[];
extern Gfx ef_w_cedar_light_modeset[];
extern Gfx ef_w_cedar_trunk_modeset[];
extern u8 obj_w_cedar_cutL_tex_txt[];

Vtx ef_x_cedar5_cutR_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/ef_x_cedar5_cutR_light/ef_x_cedar5_cutR_v.inc"
};

Gfx ef_x_cedar5_cutR_light_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_x_cedar5_cutR_leaf_model[] ATTRIBUTE_ALIGN(8) = {
...
Gfx ef_x_cedar5_cutR_trunk_model[] ATTRIBUTE_ALIGN(8) = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_x_cedar5_cutR = 
	{ ARRAY_COUNT(cKF_je_r_ef_x_cedar5_cutR_tbl), 3, cKF_je_r_ef_x_cedar5_cutR_tbl }
;
