...
#include "assets/forestd/rom_shop4_1/rom_shop4_1_floor_tex_pal.inc"
};

u16 rom_shop4_1_lamp_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_lamp_tex_pal.inc"
};

static u16 rom_shop4_1_base_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_base_tex_pal.inc"
};

static u16 rom_shop4_1_stair_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_stair_tex_pal.inc"
};

static u16 rom_shop4_1_table_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_table_tex_pal.inc"
};

static u16 rom_shop4_1_wall_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_wall_tex_pal.inc"
};

static u16 rom_shop4_1_sign01_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_sign01_tex_pal.inc"
};

static u16 rom_shop4_1_kaunta_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_kaunta_tex_pal.inc"
};

u16 rom_shop4_1_us_sign01_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_us_sign01_tex_pal.inc"
};

static u16 rom_shop4_1_us_sign02_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_us_sign02_tex_pal.inc"
};

u16 rom_shop4_1_us_sign03_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_us_sign03_tex_pal.inc"
};

static u16 rom_shop4_1_sign03_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_sign03_tex_pal.inc"
};

static u16 rom_shop4_1_reji_tex_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_reji_tex_pal.inc"
};

static u8 rom_shop4_1_floor01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_floor01_tex.inc"
};

u8 rom_shop4_1_lamp_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_lamp_tex.inc"
};

static u8 rom_shop4_1_base_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_base_tex.inc"
};

static u8 rom_shop4_1_stair01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_stair01_tex.inc"
};

static u8 rom_shop4_1_table01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_table01_tex.inc"
};

static u8 rom_shop4_1_table02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_table02_tex.inc"
};

static u8 rom_shop4_1_wall01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_wall01_tex.inc"
};

static u8 rom_shop4_1_wall02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_wall02_tex.inc"
};

static u8 rom_shop4_1_sign05_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_sign05_tex.inc"
};

static u8 rom_shop4_1_kaunta01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_kaunta01_tex.inc"
};

static u8 rom_shop4_1_kaunta02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_kaunta02_tex.inc"
};

u8 rom_shop4_1_us_sign01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_us_sign01_tex.inc"
};

static u8 rom_shop4_1_us_sign02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_us_sign02_tex.inc"
};

u8 rom_shop4_1_us_sign03_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_us_sign03_tex.inc"
};

static u8 rom_shop4_1_sign04_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_sign04_tex.inc"
};

static u8 rom_shop4_1_reji01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_reji01_tex.inc"
};

static u8 rom_shop4_1_reji02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_reji02_tex.inc"
};

static u8 rom_shop4_1_reji03_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_reji03_tex.inc"
};

static u8 rom_shop4_1_floor02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_floor02_tex.inc"
};

static u8 rom_shop4_1_floor03_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_floor03_tex.inc"
};

static u8 rom_shop4_1_floor04_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_floor04_tex.inc"
};

u8 rom_shop4_1_shadow01_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_shadow01_tex.inc"
};

static u8 rom_shop4_1_shadow02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_shadow02_tex.inc"
};

u8 rom_shop4_1_lamp02_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_lamp02_tex.inc"
};

u8 rom_shop4_1_shadow03_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_shadow03_tex.inc"
};

Vtx rom_shop4_1_v[] ATTRIBUTE_ALIGN(8) = {
#include "assets/forestd/rom_shop4_1/rom_shop4_1_v.inc"
};

Gfx rom_shop4_1_modelT[] ATTRIBUTE_ALIGN(8) = {
...
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 32, rom_shop4_1_shadow01_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
gsSPVertex(&rom_shop4_1_v[346], 4, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0),
gsDPSetPrimColor(0, 140, 255, 255, 130, 255),
gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 32, rom_shop4_1_shadow03_tex),
...
Gfx rom_shop4_1_model[] ATTRIBUTE_ALIGN(8) = {
gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
gsDPLoadTLUT_Dolphin(15, 16, 1, rom_shop4_1_lamp_tex_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 16, 16, rom_shop4_1_lamp02_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
...
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 64, rom_shop4_1_us_sign01_tex),
...
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 48, 64, rom_shop4_1_us_sign03_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
...
gsDPLoadTLUT_Dolphin(15, 16, 1, rom_shop4_1_lamp_tex_pal),
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 16, 16, rom_shop4_1_lamp_tex),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_CLAMP, 0, 0),
...
gsSPNTriangles_5b(1, 5, 2, 6, 7, 8, 6, 8, 9, 10, 0, 3),
gsSPNTriangles_5b(10, 3, 11, 12, 13, 14, 12, 14, 15, 0, 0, 0),
gsDPLoadTLUT_Dolphin(15, 16, 1, rom_shop4_1_reji_tex_pal),
